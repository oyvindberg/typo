...
case class Generated(language: Language, folder: Path, files: Map[RelPath, sc.Code]) {
...
object Generated {
  def apply(language: Language, folder: Path, files: Iterator[sc.File]): Generated = {
    ...
    new Generated(language, folder, asRelativePaths)
  }
}
