...
object PgStatisticFieldValue {
  case class starelid(override val value: /* oid */ Long) extends PgStatisticFieldValue("starelid", value)
  ...
  case class staop1(override val value: /* oid */ Long) extends PgStatisticFieldValue("staop1", value)
  case class staop2(override val value: /* oid */ Long) extends PgStatisticFieldValue("staop2", value)
  case class staop3(override val value: /* oid */ Long) extends PgStatisticFieldValue("staop3", value)
  case class staop4(override val value: /* oid */ Long) extends PgStatisticFieldValue("staop4", value)
  case class staop5(override val value: /* oid */ Long) extends PgStatisticFieldValue("staop5", value)
  case class stacoll1(override val value: /* oid */ Long) extends PgStatisticFieldValue("stacoll1", value)
  case class stacoll2(override val value: /* oid */ Long) extends PgStatisticFieldValue("stacoll2", value)
  case class stacoll3(override val value: /* oid */ Long) extends PgStatisticFieldValue("stacoll3", value)
  case class stacoll4(override val value: /* oid */ Long) extends PgStatisticFieldValue("stacoll4", value)
  case class stacoll5(override val value: /* oid */ Long) extends PgStatisticFieldValue("stacoll5", value)
  ...
  case class stavalues1(override val value: Option[/* anyarray */ PGobject]) extends PgStatisticFieldValue("stavalues1", value)
  case class stavalues2(override val value: Option[/* anyarray */ PGobject]) extends PgStatisticFieldValue("stavalues2", value)
  case class stavalues3(override val value: Option[/* anyarray */ PGobject]) extends PgStatisticFieldValue("stavalues3", value)
  case class stavalues4(override val value: Option[/* anyarray */ PGobject]) extends PgStatisticFieldValue("stavalues4", value)
  case class stavalues5(override val value: Option[/* anyarray */ PGobject]) extends PgStatisticFieldValue("stavalues5", value)
}
