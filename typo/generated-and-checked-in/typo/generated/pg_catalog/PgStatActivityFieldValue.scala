...
object PgStatActivityFieldValue {
  case class datid(override val value: Option[Long]) extends PgStatActivityFieldValue("datid", value)
  ...
  case class usesysid(override val value: Option[Long]) extends PgStatActivityFieldValue("usesysid", value)
  ...
  case class clientAddr(override val value: Option[PGobject]) extends PgStatActivityFieldValue("client_addr", value)
  ...
  case class backendXid(override val value: Option[PGobject]) extends PgStatActivityFieldValue("backend_xid", value)
  case class backendXmin(override val value: Option[PGobject]) extends PgStatActivityFieldValue("backend_xmin", value)
