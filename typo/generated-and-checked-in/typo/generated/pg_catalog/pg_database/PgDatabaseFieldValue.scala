...
object PgDatabaseFieldValue {
  ...
  case class datdba(override val value: /* oid */ Long) extends PgDatabaseFieldValue("datdba", value)
  ...
  case class datlastsysoid(override val value: /* oid */ Long) extends PgDatabaseFieldValue("datlastsysoid", value)
  case class datfrozenxid(override val value: /* xid */ PGobject) extends PgDatabaseFieldValue("datfrozenxid", value)
  case class datminmxid(override val value: /* xid */ PGobject) extends PgDatabaseFieldValue("datminmxid", value)
  case class dattablespace(override val value: /* oid */ Long) extends PgDatabaseFieldValue("dattablespace", value)
  case class datacl(override val value: Option[Array[/* aclitem */ PGobject]]) extends PgDatabaseFieldValue("datacl", value)
}
