...
sealed abstract class PgCollationFieldOrIdValue[T](val name: String, val value: T)
sealed abstract class PgCollationFieldValue[T](name: String, value: T) extends PgCollationFieldOrIdValue(name, value)

object PgCollationFieldValue {
  case class oid(override val value: PgCollationId) extends PgCollationFieldOrIdValue("oid", value)
  case class collname(override val value: String) extends PgCollationFieldValue("collname", value)
  case class collnamespace(override val value: /* oid */ Long) extends PgCollationFieldValue("collnamespace", value)
  case class collowner(override val value: /* oid */ Long) extends PgCollationFieldValue("collowner", value)
