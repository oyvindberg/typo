...
object PgDescriptionFieldValue {
  case class objoid(override val value: /* oid */ Long) extends PgDescriptionFieldValue("objoid", value)
  case class classoid(override val value: /* oid */ Long) extends PgDescriptionFieldValue("classoid", value)
