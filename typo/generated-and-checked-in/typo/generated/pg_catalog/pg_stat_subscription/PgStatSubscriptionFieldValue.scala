...
object PgStatSubscriptionFieldValue {
  case class subid(override val value: Option[/* oid */ Long]) extends PgStatSubscriptionFieldValue("subid", value)
  ...
  case class relid(override val value: Option[/* oid */ Long]) extends PgStatSubscriptionFieldValue("relid", value)
  case class receivedLsn(override val value: Option[/* pg_lsn */ Long]) extends PgStatSubscriptionFieldValue("received_lsn", value)
  ...
  case class latestEndLsn(override val value: Option[/* pg_lsn */ Long]) extends PgStatSubscriptionFieldValue("latest_end_lsn", value)
