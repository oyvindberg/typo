...
object PgStatProgressVacuumFieldValue {
  ...
  case class datid(override val value: Option[/* oid */ Long]) extends PgStatProgressVacuumFieldValue("datid", value)
  case class datname(override val value: Option[String]) extends PgStatProgressVacuumFieldValue("datname", value)
  case class relid(override val value: Option[/* oid */ Long]) extends PgStatProgressVacuumFieldValue("relid", value)
