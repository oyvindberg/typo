...
object PgClassFieldValue {
  ...
  case class relfrozenxid(override val value: PGobject) extends PgClassFieldValue("relfrozenxid", value)
  case class relminmxid(override val value: PGobject) extends PgClassFieldValue("relminmxid", value)
