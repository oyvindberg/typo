...
object PgStatsFieldValue {
  ...
  case class mostCommonVals(override val value: /* unknown nullability */ Option[/* anyarray */ PGobject]) extends PgStatsFieldValue("most_common_vals", value)
  ...
  case class histogramBounds(override val value: /* unknown nullability */ Option[/* anyarray */ PGobject]) extends PgStatsFieldValue("histogram_bounds", value)
  case class correlation(override val value: /* unknown nullability */ Option[Float]) extends PgStatsFieldValue("correlation", value)
  case class mostCommonElems(override val value: /* unknown nullability */ Option[/* anyarray */ PGobject]) extends PgStatsFieldValue("most_common_elems", value)
