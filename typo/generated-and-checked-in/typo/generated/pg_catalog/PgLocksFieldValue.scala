...
object PgLocksFieldValue {
  ...
  case class tuple(override val value: /* unknown nullability */ Option[Int]) extends PgLocksFieldValue("tuple", value)
  ...
  case class objsubid(override val value: /* unknown nullability */ Option[Int]) extends PgLocksFieldValue("objsubid", value)
