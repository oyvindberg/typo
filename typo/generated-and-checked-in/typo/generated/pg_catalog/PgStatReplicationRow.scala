  ...
  def rowParser(prefix: String): RowParser[PgStatReplicationRow] = { row =>
    Success(
      PgStatReplicationRow(
        ...
        sentLsn = row[Option[/* pg_lsn */ Long]](prefix + "sent_lsn"),
        writeLsn = row[Option[/* pg_lsn */ Long]](prefix + "write_lsn"),
        flushLsn = row[Option[/* pg_lsn */ Long]](prefix + "flush_lsn"),
        replayLsn = row[Option[/* pg_lsn */ Long]](prefix + "replay_lsn"),
