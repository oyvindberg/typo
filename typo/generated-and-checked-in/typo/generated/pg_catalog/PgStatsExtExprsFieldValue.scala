...
object PgStatsExtExprsFieldValue {
  ...
  case class mostCommonVals(override val value: Option[PGobject]) extends PgStatsExtExprsFieldValue("most_common_vals", value)
  ...
  case class histogramBounds(override val value: Option[PGobject]) extends PgStatsExtExprsFieldValue("histogram_bounds", value)
  case class correlation(override val value: Option[Float]) extends PgStatsExtExprsFieldValue("correlation", value)
  case class mostCommonElems(override val value: Option[PGobject]) extends PgStatsExtExprsFieldValue("most_common_elems", value)
