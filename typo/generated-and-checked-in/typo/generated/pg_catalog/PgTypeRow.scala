  ...
  def rowParser(prefix: String): RowParser[PgTypeRow] = { row =>
    Success(
      PgTypeRow(
        ...
        typnamespace = row[Long](prefix + "typnamespace"),
        typowner = row[Long](prefix + "typowner"),
        ...
        typrelid = row[Long](prefix + "typrelid"),
        typsubscript = row[PGobject](prefix + "typsubscript"),
        typelem = row[Long](prefix + "typelem"),
        typarray = row[Long](prefix + "typarray"),
        typinput = row[PGobject](prefix + "typinput"),
        typoutput = row[PGobject](prefix + "typoutput"),
        typreceive = row[PGobject](prefix + "typreceive"),
        typsend = row[PGobject](prefix + "typsend"),
        typmodin = row[PGobject](prefix + "typmodin"),
        typmodout = row[PGobject](prefix + "typmodout"),
        typanalyze = row[PGobject](prefix + "typanalyze"),
        typalign = row[String](prefix + "typalign"),
        typstorage = row[String](prefix + "typstorage"),
        typnotnull = row[Boolean](prefix + "typnotnull"),
        typbasetype = row[Long](prefix + "typbasetype"),
        typtypmod = row[Int](prefix + "typtypmod"),
        typndims = row[Int](prefix + "typndims"),
        typcollation = row[Long](prefix + "typcollation"),
        typdefaultbin = row[Option[PGobject]](prefix + "typdefaultbin"),
        typdefault = row[Option[String]](prefix + "typdefault"),
        typacl = row[Option[Array[PGobject]]](prefix + "typacl")
      )
    )
  }
