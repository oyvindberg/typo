...
object PgConversionRepoImpl extends PgConversionRepo {
  ...
  override def selectByUniqueConnamespaceConforencodingContoencodingOid(connamespace: /* oid */ Long, conforencoding: Int, contoencoding: Int, oid: PgConversionId)(implicit c: Connection): Option[PgConversionRow] = {
  ...
  override def selectByUniqueConnameConnamespace(conname: String, connamespace: /* oid */ Long)(implicit c: Connection): Option[PgConversionRow] = {
