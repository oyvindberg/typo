...
object PgTypeFieldValue {
  ...
  case class typsubscript(override val value: Long) extends PgTypeFieldValue("typsubscript", value)
  ...
  case class typinput(override val value: Long) extends PgTypeFieldValue("typinput", value)
  case class typoutput(override val value: Long) extends PgTypeFieldValue("typoutput", value)
  case class typreceive(override val value: Long) extends PgTypeFieldValue("typreceive", value)
  case class typsend(override val value: Long) extends PgTypeFieldValue("typsend", value)
  case class typmodin(override val value: Long) extends PgTypeFieldValue("typmodin", value)
  case class typmodout(override val value: Long) extends PgTypeFieldValue("typmodout", value)
  case class typanalyze(override val value: Long) extends PgTypeFieldValue("typanalyze", value)
