...
object PgTypeFieldValue {
  ...
  case class typsubscript(override val value: PGobject) extends PgTypeFieldValue("typsubscript", value)
  ...
  case class typinput(override val value: PGobject) extends PgTypeFieldValue("typinput", value)
  case class typoutput(override val value: PGobject) extends PgTypeFieldValue("typoutput", value)
  case class typreceive(override val value: PGobject) extends PgTypeFieldValue("typreceive", value)
  case class typsend(override val value: PGobject) extends PgTypeFieldValue("typsend", value)
  case class typmodin(override val value: PGobject) extends PgTypeFieldValue("typmodin", value)
  case class typmodout(override val value: PGobject) extends PgTypeFieldValue("typmodout", value)
  case class typanalyze(override val value: PGobject) extends PgTypeFieldValue("typanalyze", value)
  ...
  case class typdefaultbin(override val value: Option[PGobject]) extends PgTypeFieldValue("typdefaultbin", value)
  case class typdefault(override val value: Option[String]) extends PgTypeFieldValue("typdefault", value)
  case class typacl(override val value: Option[Array[PGobject]]) extends PgTypeFieldValue("typacl", value)
}
