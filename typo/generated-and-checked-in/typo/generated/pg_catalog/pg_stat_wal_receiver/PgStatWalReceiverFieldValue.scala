...
object PgStatWalReceiverFieldValue {
  ...
  case class receiveStartLsn(override val value: Option[/* pg_lsn */ Long]) extends PgStatWalReceiverFieldValue("receive_start_lsn", value)
  case class receiveStartTli(override val value: Option[Int]) extends PgStatWalReceiverFieldValue("receive_start_tli", value)
  case class writtenLsn(override val value: Option[/* pg_lsn */ Long]) extends PgStatWalReceiverFieldValue("written_lsn", value)
  case class flushedLsn(override val value: Option[/* pg_lsn */ Long]) extends PgStatWalReceiverFieldValue("flushed_lsn", value)
  ...
  case class latestEndLsn(override val value: Option[/* pg_lsn */ Long]) extends PgStatWalReceiverFieldValue("latest_end_lsn", value)
