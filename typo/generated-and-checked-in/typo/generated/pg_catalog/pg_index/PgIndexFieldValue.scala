...
object PgIndexFieldValue {
  ...
  case class indrelid(override val value: /* oid */ Long) extends PgIndexFieldValue("indrelid", value)
  ...
  case class indkey(override val value: /* int2vector */ PGobject) extends PgIndexFieldValue("indkey", value)
  case class indcollation(override val value: /* oidvector */ PGobject) extends PgIndexFieldValue("indcollation", value)
  case class indclass(override val value: /* oidvector */ PGobject) extends PgIndexFieldValue("indclass", value)
  case class indoption(override val value: /* int2vector */ PGobject) extends PgIndexFieldValue("indoption", value)
  case class indexprs(override val value: Option[/* pg_node_tree */ PGobject]) extends PgIndexFieldValue("indexprs", value)
  case class indpred(override val value: Option[/* pg_node_tree */ PGobject]) extends PgIndexFieldValue("indpred", value)
}
