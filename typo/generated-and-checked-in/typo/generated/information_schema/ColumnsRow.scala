  ...
  implicit val rowParser: RowParser[ColumnsRow] = { row =>
    Success(
      ColumnsRow(
        ...
        columnDefault = row[Option[String]]("column_default"),
        ...
        isSelfReferencing = row[Option[String]]("is_self_referencing"),
        isIdentity = row[Option[String]]("is_identity"),
        identityGeneration = row[Option[String]]("identity_generation"),
        identityStart = row[Option[String]]("identity_start"),
        identityIncrement = row[Option[String]]("identity_increment"),
        identityMaximum = row[Option[String]]("identity_maximum"),
        identityMinimum = row[Option[String]]("identity_minimum"),
        identityCycle = row[Option[String]]("identity_cycle"),
        isGenerated = row[Option[String]]("is_generated"),
        generationExpression = row[Option[String]]("generation_expression"),
