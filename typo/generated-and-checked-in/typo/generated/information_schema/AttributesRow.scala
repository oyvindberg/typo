  ...
  implicit val rowParser: RowParser[AttributesRow] = { row =>
    Success(
      AttributesRow(
        ...
        attributeName = row[Option[String]]("attribute_name"),
        ordinalPosition = row[Option[Int]]("ordinal_position"),
        attributeDefault = row[Option[String]]("attribute_default"),
        isNullable = row[Option[String]]("is_nullable"),
        ...
        attributeUdtCatalog = row[Option[String]]("attribute_udt_catalog"),
        attributeUdtSchema = row[Option[String]]("attribute_udt_schema"),
        attributeUdtName = row[Option[String]]("attribute_udt_name"),
        ...
        isDerivedReferenceAttribute = row[Option[String]]("is_derived_reference_attribute")
      )
    )
  }
