  ...
  def rowParser(prefix: String): RowParser[TablesRow] = { row =>
    Success(
      TablesRow(
        ...
        tableType = row[Option[CharacterDataDomain]](prefix + "table_type"),
        selfReferencingColumnName = row[Option[SqlIdentifierDomain]](prefix + "self_referencing_column_name"),
        referenceGeneration = row[Option[CharacterDataDomain]](prefix + "reference_generation"),
        userDefinedTypeCatalog = row[Option[SqlIdentifierDomain]](prefix + "user_defined_type_catalog"),
        userDefinedTypeSchema = row[Option[SqlIdentifierDomain]](prefix + "user_defined_type_schema"),
        userDefinedTypeName = row[Option[SqlIdentifierDomain]](prefix + "user_defined_type_name"),
        isInsertableInto = row[Option[YesOrNoDomain]](prefix + "is_insertable_into"),
        isTyped = row[Option[YesOrNoDomain]](prefix + "is_typed"),
        commitAction = row[Option[CharacterDataDomain]](prefix + "commit_action")
      )
    )
  }
      ...
      JsResult.fromTry(
        Try(
          TablesRow(
            ...
            tableType = json.\("table_type").toOption.map(_.as[CharacterDataDomain]),
            selfReferencingColumnName = json.\("self_referencing_column_name").toOption.map(_.as[SqlIdentifierDomain]),
            referenceGeneration = json.\("reference_generation").toOption.map(_.as[CharacterDataDomain]),
            userDefinedTypeCatalog = json.\("user_defined_type_catalog").toOption.map(_.as[SqlIdentifierDomain]),
            userDefinedTypeSchema = json.\("user_defined_type_schema").toOption.map(_.as[SqlIdentifierDomain]),
            userDefinedTypeName = json.\("user_defined_type_name").toOption.map(_.as[SqlIdentifierDomain]),
            isInsertableInto = json.\("is_insertable_into").toOption.map(_.as[YesOrNoDomain]),
            isTyped = json.\("is_typed").toOption.map(_.as[YesOrNoDomain]),
            commitAction = json.\("commit_action").toOption.map(_.as[CharacterDataDomain])
          )
        )
      )
    }
