...
case class ForeignDataWrappersRow(
  /** Points to [[`_pg_foreign_data_wrappers`.PgForeignDataWrappersRow.foreignDataWrapperCatalog]] */
  ...
  /** Points to [[`_pg_foreign_data_wrappers`.PgForeignDataWrappersRow.foreignDataWrapperName]] */
  ...
  /** Points to [[`_pg_foreign_data_wrappers`.PgForeignDataWrappersRow.authorizationIdentifier]] */
  ...
  /** Points to [[`_pg_foreign_data_wrappers`.PgForeignDataWrappersRow.foreignDataWrapperLanguage]] */
