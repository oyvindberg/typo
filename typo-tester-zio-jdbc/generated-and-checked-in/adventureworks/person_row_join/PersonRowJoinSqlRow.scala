...
case class PersonRowJoinSqlRow(/** Points to [[adventureworks.sales.salesperson.SalespersonRow.businessentityid]] */
                               businessentityid: BusinessentityId, email: /* nullability unknown */ Option[Array[TypoRecord]], emails: /* nullability unknown */ Option[Array[TypoRecord]])

object PersonRowJoinSqlRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[PersonRowJoinSqlRow] = {
    new JdbcDecoder[PersonRowJoinSqlRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PersonRowJoinSqlRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PersonRowJoinSqlRow] = {
    new JsonEncoder[PersonRowJoinSqlRow] {
