...
object PgStatXactSysTablesViewRow {
  implicit lazy val decoder: JsonDecoder[PgStatXactSysTablesViewRow] = DeriveJsonDecoder.gen[PgStatXactSysTablesViewRow]
  implicit lazy val decoder: JsonDecoder[PgStatXactSysTablesViewRow] = DeriveJsonEncoder.gen[PgStatXactSysTablesViewRow]
}
