...
object PgStatAllTablesViewRepoImpl extends PgStatAllTablesViewRepo {
  override def select: SelectBuilder[PgStatAllTablesViewFields, PgStatAllTablesViewRow] = {
    SelectBuilderSql("pg_catalog.pg_stat_all_tables", PgStatAllTablesViewFields, PgStatAllTablesViewRow.jdbcDecoder)
  }
  override def selectAll: ZStream[ZConnection, Throwable, PgStatAllTablesViewRow] = {
