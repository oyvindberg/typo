...
class PgStatAllTablesViewStructure[Row](val prefix: Option[String], val extract: Row => PgStatAllTablesViewRow, val merge: (Row, PgStatAllTablesViewRow) => Row)
  ...
  override val lastVacuum = new OptField[TypoInstant, Row](prefix, "last_vacuum", Some("text"), None)(x => extract(x).lastVacuum, (row, value) => merge(row, extract(row).copy(lastVacuum = value)))
  override val lastAutovacuum = new OptField[TypoInstant, Row](prefix, "last_autovacuum", Some("text"), None)(x => extract(x).lastAutovacuum, (row, value) => merge(row, extract(row).copy(lastAutovacuum = value)))
  override val lastAnalyze = new OptField[TypoInstant, Row](prefix, "last_analyze", Some("text"), None)(x => extract(x).lastAnalyze, (row, value) => merge(row, extract(row).copy(lastAnalyze = value)))
  override val lastAutoanalyze = new OptField[TypoInstant, Row](prefix, "last_autoanalyze", Some("text"), None)(x => extract(x).lastAutoanalyze, (row, value) => merge(row, extract(row).copy(lastAutoanalyze = value)))
