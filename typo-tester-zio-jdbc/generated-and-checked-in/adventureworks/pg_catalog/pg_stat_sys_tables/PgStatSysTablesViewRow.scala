...
object PgStatSysTablesViewRow {
  implicit lazy val decoder: JsonDecoder[PgStatSysTablesViewRow] = DeriveJsonDecoder.gen[PgStatSysTablesViewRow]
  implicit lazy val decoder: JsonDecoder[PgStatSysTablesViewRow] = DeriveJsonEncoder.gen[PgStatSysTablesViewRow]
}
