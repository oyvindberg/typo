...
object PgAvailableExtensionVersionsViewRepoImpl extends PgAvailableExtensionVersionsViewRepo {
  ...
  override def selectAll: ZStream[ZConnection, Throwable, PgAvailableExtensionVersionsViewRow] = {
    sql"""select "name", "version", "installed", "superuser", "trusted", "relocatable", "schema", "requires", "comment" from pg_catalog.pg_available_extension_versions""".query[PgAvailableExtensionVersionsViewRow].selectStream
  }
}
