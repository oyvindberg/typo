...
object PgStatXactUserTablesViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[PgStatXactUserTablesViewRow] = new JdbcDecoder[PgStatXactUserTablesViewRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, PgStatXactUserTablesViewRow) =
      columIndex + 10 ->
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PgStatXactUserTablesViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PgStatXactUserTablesViewRow] = new JsonEncoder[PgStatXactUserTablesViewRow] {
    override def unsafeEncode(a: PgStatXactUserTablesViewRow, indent: Option[Int], out: Write): Unit = {
      out.write("{")
      out.write(""""relid":""")
