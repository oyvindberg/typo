...
object PgStatProgressCopyViewRepoImpl extends PgStatProgressCopyViewRepo {
  ...
  override def selectAll: ZStream[ZConnection, Throwable, PgStatProgressCopyViewRow] = {
    sql"""select "pid", "datid", "datname", "relid", "command", "type", "bytes_processed", "bytes_total", "tuples_processed", "tuples_excluded" from pg_catalog.pg_stat_progress_copy""".query[PgStatProgressCopyViewRow].selectStream
  }
}
