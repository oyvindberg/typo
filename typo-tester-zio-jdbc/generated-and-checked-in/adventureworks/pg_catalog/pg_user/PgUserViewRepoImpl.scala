...
object PgUserViewRepoImpl extends PgUserViewRepo {
  ...
  override def selectAll: ZStream[ZConnection, Throwable, PgUserViewRow] = {
    sql"""select "usename", "usesysid", "usecreatedb", "usesuper", "userepl", "usebypassrls", "passwd", "valuntil"::text, "useconfig" from pg_catalog.pg_user""".query[PgUserViewRow].selectStream
  }
}
