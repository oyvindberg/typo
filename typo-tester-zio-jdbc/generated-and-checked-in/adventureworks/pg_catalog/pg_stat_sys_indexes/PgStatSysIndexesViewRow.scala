...
object PgStatSysIndexesViewRow {
  implicit lazy val decoder: JsonDecoder[PgStatSysIndexesViewRow] = DeriveJsonDecoder.gen[PgStatSysIndexesViewRow]
  implicit lazy val decoder: JsonDecoder[PgStatSysIndexesViewRow] = DeriveJsonEncoder.gen[PgStatSysIndexesViewRow]
}
