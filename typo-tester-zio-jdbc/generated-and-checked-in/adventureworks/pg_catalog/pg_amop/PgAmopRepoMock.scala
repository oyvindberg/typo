...
class PgAmopRepoMock(map: scala.collection.mutable.Map[PgAmopId, PgAmopRow] = scala.collection.mutable.Map.empty) extends PgAmopRepo {
  ...
  override def select: SelectBuilder[PgAmopFields, PgAmopRow] = {
    SelectBuilderMock(PgAmopFields, ZIO.succeed(Chunk.fromIterable(map.values)), SelectParams.empty)
  }
  ...
  override def selectByUnique(amopfamily: /* oid */ Long, amoplefttype: /* oid */ Long, amoprighttype: /* oid */ Long, amopstrategy: TypoShort): ZIO[ZConnection, Throwable, Option[PgAmopRow]] = {
    ZIO.succeed(map.values.find(v => amopfamily == v.amopfamily && amoplefttype == v.amoplefttype && amoprighttype == v.amoprighttype && amopstrategy == v.amopstrategy))
  }
  override def selectByUnique(amopopr: /* oid */ Long, amoppurpose: String, amopfamily: /* oid */ Long): ZIO[ZConnection, Throwable, Option[PgAmopRow]] = {
    ZIO.succeed(map.values.find(v => amopopr == v.amopopr && amoppurpose == v.amoppurpose && amopfamily == v.amopfamily))
  }
