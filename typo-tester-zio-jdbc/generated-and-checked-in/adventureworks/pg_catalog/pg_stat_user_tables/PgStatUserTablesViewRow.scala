...
object PgStatUserTablesViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[PgStatUserTablesViewRow] = new JdbcDecoder[PgStatUserTablesViewRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, PgStatUserTablesViewRow) =
      columIndex + 22 ->
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PgStatUserTablesViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PgStatUserTablesViewRow] = new JsonEncoder[PgStatUserTablesViewRow] {
    override def unsafeEncode(a: PgStatUserTablesViewRow, indent: Option[Int], out: Write): Unit = {
      out.write("{")
      out.write(""""relid":""")
