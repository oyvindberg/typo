...
object PgTablespaceId {
  ...
  implicit lazy val decoder: JsonDecoder[PgTablespaceId] = JsonDecoder.long.map(PgTablespaceId.apply)
  implicit lazy val encoder: JsonEncoder[PgTablespaceId] = JsonEncoder.long.contramap(_.value)
