...
object PgStatioSysTablesViewRow {
  implicit lazy val decoder: JsonDecoder[PgStatioSysTablesViewRow] = DeriveJsonDecoder.gen[PgStatioSysTablesViewRow]
  implicit lazy val decoder: JsonDecoder[PgStatioSysTablesViewRow] = DeriveJsonEncoder.gen[PgStatioSysTablesViewRow]
}
