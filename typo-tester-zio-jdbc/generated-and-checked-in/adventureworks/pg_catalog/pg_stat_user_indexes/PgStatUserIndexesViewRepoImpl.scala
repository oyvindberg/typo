...
object PgStatUserIndexesViewRepoImpl extends PgStatUserIndexesViewRepo {
  ...
  override def selectAll: ZStream[ZConnection, Throwable, PgStatUserIndexesViewRow] = {
    sql"""select "relid", "indexrelid", "schemaname", "relname", "indexrelname", "idx_scan", "idx_tup_read", "idx_tup_fetch" from pg_catalog.pg_stat_user_indexes""".query[PgStatUserIndexesViewRow].selectStream
  }
}
