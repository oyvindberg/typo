...
object VendorRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[VendorRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[VendorRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[VendorRow] = {
