...
object VendorRowUnsaved {
  implicit lazy val decoder: JsonDecoder[VendorRowUnsaved] = DeriveJsonDecoder.gen[VendorRowUnsaved]
  implicit lazy val decoder: JsonDecoder[VendorRowUnsaved] = DeriveJsonEncoder.gen[VendorRowUnsaved]
}
