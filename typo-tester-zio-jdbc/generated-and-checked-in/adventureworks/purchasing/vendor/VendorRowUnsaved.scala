...
object VendorRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[VendorRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[VendorRowUnsaved] = {
  ...
  implicit lazy val text: Text[VendorRowUnsaved] = {
