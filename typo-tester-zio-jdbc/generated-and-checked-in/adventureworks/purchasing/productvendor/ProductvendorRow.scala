...
object ProductvendorRow {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[ProductvendorRow] = {
    new JdbcDecoder[ProductvendorRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[ProductvendorRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[ProductvendorRow] = {
    new JsonEncoder[ProductvendorRow] {
