...
object ProductvendorRow {
  implicit lazy val decoder: JsonDecoder[ProductvendorRow] = DeriveJsonDecoder.gen[ProductvendorRow]
  implicit lazy val decoder: JsonDecoder[ProductvendorRow] = DeriveJsonEncoder.gen[ProductvendorRow]
}
