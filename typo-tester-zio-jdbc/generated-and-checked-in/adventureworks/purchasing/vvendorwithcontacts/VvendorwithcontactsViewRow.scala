...
object VvendorwithcontactsViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[VvendorwithcontactsViewRow] = new JdbcDecoder[VvendorwithcontactsViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[VvendorwithcontactsViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  implicit lazy val jsonEncoder: JsonEncoder[VvendorwithcontactsViewRow] = new JsonEncoder[VvendorwithcontactsViewRow] {
