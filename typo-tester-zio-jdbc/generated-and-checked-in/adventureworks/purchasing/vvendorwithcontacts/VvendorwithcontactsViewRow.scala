...
object VvendorwithcontactsViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[VvendorwithcontactsViewRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[VvendorwithcontactsViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[VvendorwithcontactsViewRow] = {
