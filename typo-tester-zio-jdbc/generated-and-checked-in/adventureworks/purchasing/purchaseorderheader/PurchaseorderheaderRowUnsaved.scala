...
object PurchaseorderheaderRowUnsaved {
  implicit lazy val decoder: JsonDecoder[PurchaseorderheaderRowUnsaved] = DeriveJsonDecoder.gen[PurchaseorderheaderRowUnsaved]
  implicit lazy val decoder: JsonDecoder[PurchaseorderheaderRowUnsaved] = DeriveJsonEncoder.gen[PurchaseorderheaderRowUnsaved]
}
