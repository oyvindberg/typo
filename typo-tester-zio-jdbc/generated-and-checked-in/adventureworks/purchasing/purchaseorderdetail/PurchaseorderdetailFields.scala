...
trait PurchaseorderdetailFields {
  ...
  def compositeIdIn(compositeIds: Array[PurchaseorderdetailId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[PurchaseorderdetailId](purchaseorderid)(_.purchaseorderid)(using as[Array[PurchaseorderheaderId]](PurchaseorderheaderId.arrayJdbcEncoder, PGType.forArray(PurchaseorderheaderId.pgType)), implicitly), TuplePart[PurchaseorderdetailId](purchaseorderdetailid)(_.purchaseorderdetailid)(using as[Array[Int]](adventureworks.IntArrayEncoder, PGType.forArray(PGType.PGTypeInt)), implicitly))
