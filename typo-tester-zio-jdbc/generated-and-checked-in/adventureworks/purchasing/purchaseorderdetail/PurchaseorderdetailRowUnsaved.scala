...
object PurchaseorderdetailRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[PurchaseorderdetailRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PurchaseorderdetailRowUnsaved] = {
    new JsonEncoder[PurchaseorderdetailRowUnsaved] {
