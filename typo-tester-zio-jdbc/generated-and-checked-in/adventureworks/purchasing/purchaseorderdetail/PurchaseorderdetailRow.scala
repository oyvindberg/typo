...
object PurchaseorderdetailRow {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[PurchaseorderdetailRow] = {
    new JdbcDecoder[PurchaseorderdetailRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PurchaseorderdetailRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PurchaseorderdetailRow] = {
