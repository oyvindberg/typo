...
object TypoInterval {
  implicit lazy val arrayJdbcDecoder: JdbcDecoder[Array[TypoInterval]] = {
  ...
  implicit lazy val arraySetter: Setter[Array[TypoInterval]] = {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[TypoInterval] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[TypoInterval] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[TypoInterval] = {
  ...
  implicit lazy val setter: Setter[TypoInterval] = {
    Setter.other(
      (ps, i, v) => {
        ps.setObject(
          i,
