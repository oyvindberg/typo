...
object TypoBox {
  implicit lazy val arrayJdbcDecoder: JdbcDecoder[Array[TypoBox]] = {
    JdbcDecoder[Array[TypoBox]]((rs: ResultSet) => (i: Int) =>
      rs.getArray(i) match {
        case null => null
  ...
  implicit lazy val arraySetter: Setter[Array[TypoBox]] = {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[TypoBox] = {
    JdbcDecoder[TypoBox](
      (rs: ResultSet) => (i: Int) => {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[TypoBox] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[TypoBox] = {
    new JsonEncoder[TypoBox] {
  ...
  implicit lazy val setter: Setter[TypoBox] = {
    Setter.other(
      (ps, i, v) => {
        ps.setObject(
          i,
  ...
  implicit lazy val text: Text[TypoBox] = {
    new Text[TypoBox] {
