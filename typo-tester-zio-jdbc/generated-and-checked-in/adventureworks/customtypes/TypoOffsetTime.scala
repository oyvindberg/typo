...
object TypoOffsetTime {
  ...
  implicit lazy val arrayJdbcDecoder: JdbcDecoder[Array[TypoOffsetTime]] = {
  ...
  implicit lazy val arraySetter: Setter[Array[TypoOffsetTime]] = {
  ...
  implicit lazy val setter: Setter[TypoOffsetTime] = {
    Setter.other(
      (ps, i, v) => {
        ps.setObject(
          i,
