...
object TypoUUID {
  ...
  implicit lazy val arrayJdbcDecoder: JdbcDecoder[Array[TypoUUID]] = {
  ...
  implicit lazy val arraySetter: Setter[Array[TypoUUID]] = {
  ...
  implicit lazy val setter: Setter[TypoUUID] = {
    Setter.other(
      (ps, i, v) => {
        ps.setObject(
          i,
