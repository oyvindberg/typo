...
object TypoInet {
  implicit lazy val arrayJdbcDecoder: JdbcDecoder[Array[TypoInet]] = {
    JdbcDecoder[Array[TypoInet]]((rs: ResultSet) => (i: Int) =>
      rs.getArray(i) match {
        case null => null
  ...
  implicit lazy val arraySetter: Setter[Array[TypoInet]] = {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[TypoInet] = {
  ...
  implicit lazy val setter: Setter[TypoInet] = {
    Setter.other(
      (ps, i, v) => {
        ps.setObject(
          i,
