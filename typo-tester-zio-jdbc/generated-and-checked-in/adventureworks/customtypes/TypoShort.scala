...
object TypoShort {
  implicit lazy val arrayJdbcDecoder: JdbcDecoder[Array[TypoShort]] = {
  ...
  implicit lazy val arraySetter: Setter[Array[TypoShort]] = {
  ...
  implicit lazy val setter: Setter[TypoShort] = {
    Setter.other(
      (ps, i, v) => {
        ps.setObject(
          i,
