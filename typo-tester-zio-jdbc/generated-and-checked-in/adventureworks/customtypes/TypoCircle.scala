...
object TypoCircle {
  implicit lazy val arrayJdbcDecoder: JdbcDecoder[Array[TypoCircle]] = {
  ...
  implicit lazy val arraySetter: Setter[Array[TypoCircle]] = {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[TypoCircle] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[TypoCircle] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[TypoCircle] = {
  ...
  implicit lazy val setter: Setter[TypoCircle] = {
    Setter.other(
      (ps, i, v) => {
        ps.setObject(
          i,
