...
object BeViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[BeViewRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[BeViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[BeViewRow] = {
