...
object PntViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[PntViewRow] = {
    new JdbcDecoder[PntViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PntViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PntViewRow] = {
    new JsonEncoder[PntViewRow] {
