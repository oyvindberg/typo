...
object BecViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[BecViewRow] = {
    new JdbcDecoder[BecViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[BecViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[BecViewRow] = {
    new JsonEncoder[BecViewRow] {
