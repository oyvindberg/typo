...
object BeaViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[BeaViewRow] = {
    new JdbcDecoder[BeaViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[BeaViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[BeaViewRow] = {
    new JsonEncoder[BeaViewRow] {
