...
object AViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[AViewRow] = {
    new JdbcDecoder[AViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[AViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[AViewRow] = {
