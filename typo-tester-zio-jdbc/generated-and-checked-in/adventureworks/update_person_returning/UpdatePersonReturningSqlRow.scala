...
case class UpdatePersonReturningSqlRow(/** Points to [[adventureworks.person.person.PersonRow.firstname]] */
                                       firstname: /* user-picked */ FirstName, /** Points to [[adventureworks.person.person.PersonRow.modifieddate]] */
                                       modifieddate: TypoLocalDateTime)

object UpdatePersonReturningSqlRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[UpdatePersonReturningSqlRow] = {
    new JdbcDecoder[UpdatePersonReturningSqlRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[UpdatePersonReturningSqlRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[UpdatePersonReturningSqlRow] = {
    new JsonEncoder[UpdatePersonReturningSqlRow] {
