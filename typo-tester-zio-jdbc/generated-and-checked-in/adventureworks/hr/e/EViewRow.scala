...
object EViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[EViewRow] = {
    new JdbcDecoder[EViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[EViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[EViewRow] = {
    new JsonEncoder[EViewRow] {
