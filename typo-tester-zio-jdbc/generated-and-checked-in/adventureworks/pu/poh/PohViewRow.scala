...
object PohViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[PohViewRow] = {
    new JdbcDecoder[PohViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PohViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PohViewRow] = {
    new JsonEncoder[PohViewRow] {
