...
object SmViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[SmViewRow] = {
    new JdbcDecoder[SmViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[SmViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[SmViewRow] = {
    new JsonEncoder[SmViewRow] {
