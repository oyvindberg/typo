...
object PodViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[PodViewRow] = {
    new JdbcDecoder[PodViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PodViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PodViewRow] = {
    new JsonEncoder[PodViewRow] {
