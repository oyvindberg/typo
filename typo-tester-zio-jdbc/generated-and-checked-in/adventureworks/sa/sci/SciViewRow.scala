...
object SciViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[SciViewRow] = {
    new JdbcDecoder[SciViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[SciViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[SciViewRow] = {
    new JsonEncoder[SciViewRow] {
