...
object SpqhViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[SpqhViewRow] = {
    new JdbcDecoder[SpqhViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[SpqhViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[SpqhViewRow] = {
    new JsonEncoder[SpqhViewRow] {
