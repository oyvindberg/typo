...
object SodViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[SodViewRow] = new JdbcDecoder[SodViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[SodViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  implicit lazy val jsonEncoder: JsonEncoder[SodViewRow] = new JsonEncoder[SodViewRow] {
