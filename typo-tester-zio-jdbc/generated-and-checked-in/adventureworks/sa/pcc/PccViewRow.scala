...
object PccViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[PccViewRow] = {
    new JdbcDecoder[PccViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PccViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PccViewRow] = {
    new JsonEncoder[PccViewRow] {
