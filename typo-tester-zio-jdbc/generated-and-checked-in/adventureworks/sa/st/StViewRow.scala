...
object StViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[StViewRow] = {
    new JdbcDecoder[StViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[StViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[StViewRow] = {
    new JsonEncoder[StViewRow] {
