...
object SohsrViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[SohsrViewRow] = {
    new JdbcDecoder[SohsrViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[SohsrViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[SohsrViewRow] = {
    new JsonEncoder[SohsrViewRow] {
