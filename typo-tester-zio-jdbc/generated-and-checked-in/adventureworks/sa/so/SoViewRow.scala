...
object SoViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[SoViewRow] = {
    new JdbcDecoder[SoViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[SoViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[SoViewRow] = {
    new JsonEncoder[SoViewRow] {
