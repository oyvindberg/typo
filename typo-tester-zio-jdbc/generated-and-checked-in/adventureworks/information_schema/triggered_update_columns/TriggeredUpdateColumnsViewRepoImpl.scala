...
object TriggeredUpdateColumnsViewRepoImpl extends TriggeredUpdateColumnsViewRepo {
  ...
  override def selectAll: ZStream[ZConnection, Throwable, TriggeredUpdateColumnsViewRow] = {
    sql"""select "trigger_catalog", "trigger_schema", "trigger_name", "event_object_catalog", "event_object_schema", "event_object_table", "event_object_column" from information_schema.triggered_update_columns""".query[TriggeredUpdateColumnsViewRow].selectStream
  }
}
