...
object TablePrivilegesViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[TablePrivilegesViewRow] = new JdbcDecoder[TablePrivilegesViewRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, TablePrivilegesViewRow) =
      columIndex + 7 ->
  ...
  implicit lazy val jsonDecoder: JsonDecoder[TablePrivilegesViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  implicit lazy val jsonEncoder: JsonEncoder[TablePrivilegesViewRow] = new JsonEncoder[TablePrivilegesViewRow] {
    override def unsafeEncode(a: TablePrivilegesViewRow, indent: Option[Int], out: Write): Unit = {
      out.write("{")
      out.write(""""grantor":""")
