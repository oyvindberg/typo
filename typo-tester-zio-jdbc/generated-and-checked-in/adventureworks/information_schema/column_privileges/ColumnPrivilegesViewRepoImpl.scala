...
object ColumnPrivilegesViewRepoImpl extends ColumnPrivilegesViewRepo {
  ...
  override def selectAll: ZStream[ZConnection, Throwable, ColumnPrivilegesViewRow] = {
    sql"""select "grantor", "grantee", "table_catalog", "table_schema", "table_name", "column_name", "privilege_type", "is_grantable" from information_schema.column_privileges""".query[ColumnPrivilegesViewRow].selectStream
  }
}
