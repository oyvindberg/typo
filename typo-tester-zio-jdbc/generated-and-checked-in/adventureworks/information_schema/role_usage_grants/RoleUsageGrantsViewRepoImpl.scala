...
object RoleUsageGrantsViewRepoImpl extends RoleUsageGrantsViewRepo {
  ...
  override def selectAll: ZStream[ZConnection, Throwable, RoleUsageGrantsViewRow] = {
    sql"""select "grantor", "grantee", "object_catalog", "object_schema", "object_name", "object_type", "privilege_type", "is_grantable" from information_schema.role_usage_grants""".query[RoleUsageGrantsViewRow].selectStream
  }
}
