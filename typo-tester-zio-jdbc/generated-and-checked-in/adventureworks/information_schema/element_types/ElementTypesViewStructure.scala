...
class ElementTypesViewStructure[Row](val prefix: Option[String], val extract: Row => ElementTypesViewRow, val merge: (Row, ElementTypesViewRow) => Row)
  ...
  override val collectionTypeIdentifier = new OptField[String, Row](prefix, "collection_type_identifier", None, None)(x => extract(x).collectionTypeIdentifier, (row, value) => merge(row, extract(row).copy(collectionTypeIdentifier = value)))
