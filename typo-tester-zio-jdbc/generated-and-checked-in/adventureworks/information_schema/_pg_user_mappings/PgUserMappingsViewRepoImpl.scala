...
object PgUserMappingsViewRepoImpl extends PgUserMappingsViewRepo {
  ...
  override def selectAll: ZStream[ZConnection, Throwable, PgUserMappingsViewRow] = {
    sql"""select "oid", "umoptions", "umuser", "authorization_identifier", "foreign_server_catalog", "foreign_server_name", "srvowner" from information_schema._pg_user_mappings""".query[PgUserMappingsViewRow].selectStream
  }
}
