...
class TestInsert(val random: Random, val domainInsert: TestDomainInsert) {
  ...
  def personBusinessentity(businessentityid: Defaulted[BusinessentityId] = Defaulted.UseDefault(), rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(), modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ZIO[ZConnection, Throwable, BusinessentityRow] = (new BusinessentityRepoImpl).insert(new BusinessentityRowUnsaved(businessentityid = businessentityid, rowguid = rowguid, modifieddate = modifieddate))
  ...
  def personContacttype(name: Name = domainInsert.publicName(random), contacttypeid: Defaulted[ContacttypeId] = Defaulted.UseDefault(), modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ZIO[ZConnection, Throwable, ContacttypeRow] = (new ContacttypeRepoImpl).insert(new ContacttypeRowUnsaved(name = name, contacttypeid = contacttypeid, modifieddate = modifieddate))
  def personCountryregion(countryregioncode: CountryregionId, name: Name = domainInsert.publicName(random), modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ZIO[ZConnection, Throwable, CountryregionRow] = (new CountryregionRepoImpl).insert(new CountryregionRowUnsaved(countryregioncode = countryregioncode, name = name, modifieddate = modifieddate))
  ...
  def productionCulture(cultureid: CultureId, name: Name = domainInsert.publicName(random), modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ZIO[ZConnection, Throwable, CultureRow] = (new CultureRepoImpl).insert(new CultureRowUnsaved(cultureid = cultureid, name = name, modifieddate = modifieddate))
  ...
  def productionIllustration(diagram: Option[TypoXml] = None, illustrationid: Defaulted[IllustrationId] = Defaulted.UseDefault(), modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ZIO[ZConnection, Throwable, IllustrationRow] = (new IllustrationRepoImpl).insert(new IllustrationRowUnsaved(diagram = diagram, illustrationid = illustrationid, modifieddate = modifieddate))
  ...
  def productionProductdocument(productid: ProductId, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault(), documentnode: Defaulted[DocumentId] = Defaulted.UseDefault()): ZIO[ZConnection, Throwable, ProductdocumentRow] = (new ProductdocumentRepoImpl).insert(new ProductdocumentRowUnsaved(productid = productid, modifieddate = modifieddate, documentnode = documentnode))
  ...
  def productionProductmodelillustration(productmodelid: ProductmodelId, illustrationid: IllustrationId, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ZIO[ZConnection, Throwable, ProductmodelillustrationRow] = (new ProductmodelillustrationRepoImpl).insert(new ProductmodelillustrationRowUnsaved(productmodelid = productmodelid, illustrationid = illustrationid, modifieddate = modifieddate))
  ...
  def productionScrapreason(name: Name = domainInsert.publicName(random), scrapreasonid: Defaulted[ScrapreasonId] = Defaulted.UseDefault(), modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ZIO[ZConnection, Throwable, ScrapreasonRow] = (new ScrapreasonRepoImpl).insert(new ScrapreasonRowUnsaved(name = name, scrapreasonid = scrapreasonid, modifieddate = modifieddate))
  ...
  def productionUnitmeasure(unitmeasurecode: UnitmeasureId, name: Name = domainInsert.publicName(random), modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ZIO[ZConnection, Throwable, UnitmeasureRow] = (new UnitmeasureRepoImpl).insert(new UnitmeasureRowUnsaved(unitmeasurecode = unitmeasurecode, name = name, modifieddate = modifieddate))
  ...
  def publicIdentityTest(name: IdentityTestId, alwaysGenerated: Int = random.nextInt(), defaultGenerated: Defaulted[Int] = Defaulted.UseDefault()): ZIO[ZConnection, Throwable, IdentityTestRow] = (new IdentityTestRepoImpl).insert(new IdentityTestRowUnsaved(name = name, alwaysGenerated = alwaysGenerated, defaultGenerated = defaultGenerated))
  def publicPgtest(
    box: TypoBox,
    bytea: TypoBytea,
    circle: TypoCircle,
  ...
  def salesCountryregioncurrency(countryregioncode: CountryregionId, currencycode: CurrencyId, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ZIO[ZConnection, Throwable, CountryregioncurrencyRow] = (new CountryregioncurrencyRepoImpl).insert(new CountryregioncurrencyRowUnsaved(countryregioncode = countryregioncode, currencycode = currencycode, modifieddate = modifieddate))
  def salesCreditcard(
  ...
  def salesCurrency(currencycode: CurrencyId, name: Name = domainInsert.publicName(random), modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ZIO[ZConnection, Throwable, CurrencyRow] = (new CurrencyRepoImpl).insert(new CurrencyRowUnsaved(currencycode = currencycode, name = name, modifieddate = modifieddate))
