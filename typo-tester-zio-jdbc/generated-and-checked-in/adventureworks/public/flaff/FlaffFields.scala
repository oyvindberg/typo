...
trait FlaffFields {
  ...
  def compositeIdIn(compositeIds: Array[FlaffId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[FlaffId](code)(_.code)(using as[Array[ShortText], Required](ShortText.arrayJdbcEncoder, PGType.forArray(ShortText.pgType)), implicitly), TuplePart[FlaffId](anotherCode)(_.anotherCode)(using as[Array[/* max 20 chars */ String], Required](adventureworks.StringArrayEncoder, PGType.forArray(PGType.PGTypeString)), implicitly), TuplePart[FlaffId](someNumber)(_.someNumber)(using as[Array[Int], Required](adventureworks.IntArrayEncoder, PGType.forArray(PGType.PGTypeInt)), implicitly), TuplePart[FlaffId](specifier)(_.specifier)(using as[Array[ShortText], Required](ShortText.arrayJdbcEncoder, PGType.forArray(ShortText.pgType)), implicitly))
