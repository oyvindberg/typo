...
object PgtestRow {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PgtestRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val boxes = jsonObj.get("boxes").toRight("Missing field 'boxes'").flatMap(_.as(JsonDecoder.array[TypoBox](TypoBox.jsonDecoder, implicitly)))
    val bpchares = jsonObj.get("bpchares").toRight("Missing field 'bpchares'").flatMap(_.as(JsonDecoder.array[String](JsonDecoder.string, implicitly)))
    val chares = jsonObj.get("chares").toRight("Missing field 'chares'").flatMap(_.as(JsonDecoder.array[String](JsonDecoder.string, implicitly)))
    val circlees = jsonObj.get("circlees").toRight("Missing field 'circlees'").flatMap(_.as(JsonDecoder.array[TypoCircle](TypoCircle.jsonDecoder, implicitly)))
    val datees = jsonObj.get("datees").toRight("Missing field 'datees'").flatMap(_.as(JsonDecoder.array[TypoLocalDate](TypoLocalDate.jsonDecoder, implicitly)))
    val float4es = jsonObj.get("float4es").toRight("Missing field 'float4es'").flatMap(_.as(JsonDecoder.array[Float](JsonDecoder.float, implicitly)))
    val float8es = jsonObj.get("float8es").toRight("Missing field 'float8es'").flatMap(_.as(JsonDecoder.array[Double](JsonDecoder.double, implicitly)))
    val inetes = jsonObj.get("inetes").toRight("Missing field 'inetes'").flatMap(_.as(JsonDecoder.array[TypoInet](TypoInet.jsonDecoder, implicitly)))
    val int2es = jsonObj.get("int2es").toRight("Missing field 'int2es'").flatMap(_.as(JsonDecoder.array[TypoShort](TypoShort.jsonDecoder, implicitly)))
    val int2vectores = jsonObj.get("int2vectores").toRight("Missing field 'int2vectores'").flatMap(_.as(JsonDecoder.array[TypoInt2Vector](TypoInt2Vector.jsonDecoder, implicitly)))
    val int4es = jsonObj.get("int4es").toRight("Missing field 'int4es'").flatMap(_.as(JsonDecoder.array[Int](JsonDecoder.int, implicitly)))
    val int8es = jsonObj.get("int8es").toRight("Missing field 'int8es'").flatMap(_.as(JsonDecoder.array[Long](JsonDecoder.long, implicitly)))
    val intervales = jsonObj.get("intervales").toRight("Missing field 'intervales'").flatMap(_.as(JsonDecoder.array[TypoInterval](TypoInterval.jsonDecoder, implicitly)))
    val jsones = jsonObj.get("jsones").toRight("Missing field 'jsones'").flatMap(_.as(JsonDecoder.array[TypoJson](TypoJson.jsonDecoder, implicitly)))
    val jsonbes = jsonObj.get("jsonbes").toRight("Missing field 'jsonbes'").flatMap(_.as(JsonDecoder.array[TypoJsonb](TypoJsonb.jsonDecoder, implicitly)))
    val linees = jsonObj.get("linees").toRight("Missing field 'linees'").flatMap(_.as(JsonDecoder.array[TypoLine](TypoLine.jsonDecoder, implicitly)))
    val lseges = jsonObj.get("lseges").toRight("Missing field 'lseges'").flatMap(_.as(JsonDecoder.array[TypoLineSegment](TypoLineSegment.jsonDecoder, implicitly)))
    val moneyes = jsonObj.get("moneyes").toRight("Missing field 'moneyes'").flatMap(_.as(JsonDecoder.array[TypoMoney](TypoMoney.jsonDecoder, implicitly)))
    val myenumes = jsonObj.get("myenumes").toRight("Missing field 'myenumes'").flatMap(_.as(JsonDecoder.array[Myenum](Myenum.jsonDecoder, implicitly)))
    val namees = jsonObj.get("namees").toRight("Missing field 'namees'").flatMap(_.as(JsonDecoder.array[String](JsonDecoder.string, implicitly)))
    val numerices = jsonObj.get("numerices").toRight("Missing field 'numerices'").flatMap(_.as(JsonDecoder.array[BigDecimal](JsonDecoder.scalaBigDecimal, implicitly)))
    val pathes = jsonObj.get("pathes").toRight("Missing field 'pathes'").flatMap(_.as(JsonDecoder.array[TypoPath](TypoPath.jsonDecoder, implicitly)))
    val pointes = jsonObj.get("pointes").toRight("Missing field 'pointes'").flatMap(_.as(JsonDecoder.array[TypoPoint](TypoPoint.jsonDecoder, implicitly)))
    val polygones = jsonObj.get("polygones").toRight("Missing field 'polygones'").flatMap(_.as(JsonDecoder.array[TypoPolygon](TypoPolygon.jsonDecoder, implicitly)))
    val textes = jsonObj.get("textes").toRight("Missing field 'textes'").flatMap(_.as(JsonDecoder.array[String](JsonDecoder.string, implicitly)))
    val timees = jsonObj.get("timees").toRight("Missing field 'timees'").flatMap(_.as(JsonDecoder.array[TypoLocalTime](TypoLocalTime.jsonDecoder, implicitly)))
    val timestampes = jsonObj.get("timestampes").toRight("Missing field 'timestampes'").flatMap(_.as(JsonDecoder.array[TypoLocalDateTime](TypoLocalDateTime.jsonDecoder, implicitly)))
    val timestampzes = jsonObj.get("timestampzes").toRight("Missing field 'timestampzes'").flatMap(_.as(JsonDecoder.array[TypoInstant](TypoInstant.jsonDecoder, implicitly)))
    val timezes = jsonObj.get("timezes").toRight("Missing field 'timezes'").flatMap(_.as(JsonDecoder.array[TypoOffsetTime](TypoOffsetTime.jsonDecoder, implicitly)))
    val uuides = jsonObj.get("uuides").toRight("Missing field 'uuides'").flatMap(_.as(JsonDecoder.array[TypoUUID](TypoUUID.jsonDecoder, implicitly)))
    val varchares = jsonObj.get("varchares").toRight("Missing field 'varchares'").flatMap(_.as(JsonDecoder.array[String](JsonDecoder.string, implicitly)))
    val xmles = jsonObj.get("xmles").toRight("Missing field 'xmles'").flatMap(_.as(JsonDecoder.array[TypoXml](TypoXml.jsonDecoder, implicitly)))
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PgtestRow] = new JsonEncoder[PgtestRow] {
    override def unsafeEncode(a: PgtestRow, indent: Option[Int], out: Write): Unit = {
      ...
      out.write(",")
      out.write(""""boxes":""")
      JsonEncoder.array[TypoBox](TypoBox.jsonEncoder, implicitly).unsafeEncode(a.boxes, indent, out)
      out.write(",")
      out.write(""""bpchares":""")
      JsonEncoder.array[String](JsonEncoder.string, implicitly).unsafeEncode(a.bpchares, indent, out)
      out.write(",")
      out.write(""""chares":""")
      JsonEncoder.array[String](JsonEncoder.string, implicitly).unsafeEncode(a.chares, indent, out)
      out.write(",")
      out.write(""""circlees":""")
      JsonEncoder.array[TypoCircle](TypoCircle.jsonEncoder, implicitly).unsafeEncode(a.circlees, indent, out)
      out.write(",")
      out.write(""""datees":""")
      JsonEncoder.array[TypoLocalDate](TypoLocalDate.jsonEncoder, implicitly).unsafeEncode(a.datees, indent, out)
      out.write(",")
      out.write(""""float4es":""")
      JsonEncoder.array[Float](JsonEncoder.float, implicitly).unsafeEncode(a.float4es, indent, out)
      out.write(",")
      out.write(""""float8es":""")
      JsonEncoder.array[Double](JsonEncoder.double, implicitly).unsafeEncode(a.float8es, indent, out)
      out.write(",")
      out.write(""""inetes":""")
      JsonEncoder.array[TypoInet](TypoInet.jsonEncoder, implicitly).unsafeEncode(a.inetes, indent, out)
      out.write(",")
      out.write(""""int2es":""")
      JsonEncoder.array[TypoShort](TypoShort.jsonEncoder, implicitly).unsafeEncode(a.int2es, indent, out)
      out.write(",")
      out.write(""""int2vectores":""")
      JsonEncoder.array[TypoInt2Vector](TypoInt2Vector.jsonEncoder, implicitly).unsafeEncode(a.int2vectores, indent, out)
      out.write(",")
      out.write(""""int4es":""")
      JsonEncoder.array[Int](JsonEncoder.int, implicitly).unsafeEncode(a.int4es, indent, out)
      out.write(",")
      out.write(""""int8es":""")
      JsonEncoder.array[Long](JsonEncoder.long, implicitly).unsafeEncode(a.int8es, indent, out)
      out.write(",")
      out.write(""""intervales":""")
      JsonEncoder.array[TypoInterval](TypoInterval.jsonEncoder, implicitly).unsafeEncode(a.intervales, indent, out)
      out.write(",")
      out.write(""""jsones":""")
      JsonEncoder.array[TypoJson](TypoJson.jsonEncoder, implicitly).unsafeEncode(a.jsones, indent, out)
      out.write(",")
      out.write(""""jsonbes":""")
      JsonEncoder.array[TypoJsonb](TypoJsonb.jsonEncoder, implicitly).unsafeEncode(a.jsonbes, indent, out)
      out.write(",")
      out.write(""""linees":""")
      JsonEncoder.array[TypoLine](TypoLine.jsonEncoder, implicitly).unsafeEncode(a.linees, indent, out)
      out.write(",")
      out.write(""""lseges":""")
      JsonEncoder.array[TypoLineSegment](TypoLineSegment.jsonEncoder, implicitly).unsafeEncode(a.lseges, indent, out)
      out.write(",")
      out.write(""""moneyes":""")
      JsonEncoder.array[TypoMoney](TypoMoney.jsonEncoder, implicitly).unsafeEncode(a.moneyes, indent, out)
      out.write(",")
      out.write(""""myenumes":""")
      JsonEncoder.array[Myenum](Myenum.jsonEncoder, implicitly).unsafeEncode(a.myenumes, indent, out)
      out.write(",")
      out.write(""""namees":""")
      JsonEncoder.array[String](JsonEncoder.string, implicitly).unsafeEncode(a.namees, indent, out)
      out.write(",")
      out.write(""""numerices":""")
      JsonEncoder.array[BigDecimal](JsonEncoder.scalaBigDecimal, implicitly).unsafeEncode(a.numerices, indent, out)
      out.write(",")
      out.write(""""pathes":""")
      JsonEncoder.array[TypoPath](TypoPath.jsonEncoder, implicitly).unsafeEncode(a.pathes, indent, out)
      out.write(",")
      out.write(""""pointes":""")
      JsonEncoder.array[TypoPoint](TypoPoint.jsonEncoder, implicitly).unsafeEncode(a.pointes, indent, out)
      out.write(",")
      out.write(""""polygones":""")
      JsonEncoder.array[TypoPolygon](TypoPolygon.jsonEncoder, implicitly).unsafeEncode(a.polygones, indent, out)
      out.write(",")
      out.write(""""textes":""")
      JsonEncoder.array[String](JsonEncoder.string, implicitly).unsafeEncode(a.textes, indent, out)
      out.write(",")
      out.write(""""timees":""")
      JsonEncoder.array[TypoLocalTime](TypoLocalTime.jsonEncoder, implicitly).unsafeEncode(a.timees, indent, out)
      out.write(",")
      out.write(""""timestampes":""")
      JsonEncoder.array[TypoLocalDateTime](TypoLocalDateTime.jsonEncoder, implicitly).unsafeEncode(a.timestampes, indent, out)
      out.write(",")
      out.write(""""timestampzes":""")
      JsonEncoder.array[TypoInstant](TypoInstant.jsonEncoder, implicitly).unsafeEncode(a.timestampzes, indent, out)
      out.write(",")
      out.write(""""timezes":""")
      JsonEncoder.array[TypoOffsetTime](TypoOffsetTime.jsonEncoder, implicitly).unsafeEncode(a.timezes, indent, out)
      out.write(",")
      out.write(""""uuides":""")
      JsonEncoder.array[TypoUUID](TypoUUID.jsonEncoder, implicitly).unsafeEncode(a.uuides, indent, out)
      out.write(",")
      out.write(""""varchares":""")
      JsonEncoder.array[String](JsonEncoder.string, implicitly).unsafeEncode(a.varchares, indent, out)
      out.write(",")
      out.write(""""xmles":""")
      JsonEncoder.array[TypoXml](TypoXml.jsonEncoder, implicitly).unsafeEncode(a.xmles, indent, out)
      out.write("}")
    }
  }
