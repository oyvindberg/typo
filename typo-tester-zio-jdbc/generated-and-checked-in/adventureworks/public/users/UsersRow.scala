...
object UsersRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[UsersRow] = {
    new JdbcDecoder[UsersRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[UsersRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[UsersRow] = {
    new JsonEncoder[UsersRow] {
