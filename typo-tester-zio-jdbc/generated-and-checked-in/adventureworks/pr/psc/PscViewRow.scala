...
object PscViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[PscViewRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PscViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PscViewRow] = {
