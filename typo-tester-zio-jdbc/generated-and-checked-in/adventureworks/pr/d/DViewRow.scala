...
object DViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[DViewRow] = {
    new JdbcDecoder[DViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[DViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[DViewRow] = {
    new JsonEncoder[DViewRow] {
