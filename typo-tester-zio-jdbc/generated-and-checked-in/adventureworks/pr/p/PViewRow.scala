...
object PViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[PViewRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PViewRow] = {
