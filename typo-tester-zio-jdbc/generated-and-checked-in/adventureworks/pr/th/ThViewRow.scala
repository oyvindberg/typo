...
object ThViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[ThViewRow] = {
    new JdbcDecoder[ThViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[ThViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[ThViewRow] = {
    new JsonEncoder[ThViewRow] {
