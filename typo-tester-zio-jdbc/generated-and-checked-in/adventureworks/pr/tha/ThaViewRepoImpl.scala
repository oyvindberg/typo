...
object ThaViewRepoImpl extends ThaViewRepo {
  ...
  override def selectAll: ZStream[ZConnection, Throwable, ThaViewRow] = {
    sql"""select "id", "transactionid", "productid", "referenceorderid", "referenceorderlineid", "transactiondate"::text, "transactiontype", "quantity", "actualcost", "modifieddate"::text from pr.tha""".query[ThaViewRow].selectStream
  }
}
