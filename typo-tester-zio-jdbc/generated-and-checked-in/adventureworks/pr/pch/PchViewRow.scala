...
object PchViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[PchViewRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PchViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PchViewRow] = {
