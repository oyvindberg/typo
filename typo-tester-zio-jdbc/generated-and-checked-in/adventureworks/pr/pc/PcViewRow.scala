...
object PcViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[PcViewRow] = {
    new JdbcDecoder[PcViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PcViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PcViewRow] = {
    new JsonEncoder[PcViewRow] {
