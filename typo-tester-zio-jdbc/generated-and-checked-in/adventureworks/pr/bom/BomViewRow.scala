...
object BomViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[BomViewRow] = {
    new JdbcDecoder[BomViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[BomViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[BomViewRow] = {
    new JsonEncoder[BomViewRow] {
