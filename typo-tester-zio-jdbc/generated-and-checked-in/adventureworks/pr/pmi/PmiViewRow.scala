...
object PmiViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[PmiViewRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PmiViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PmiViewRow] = {
