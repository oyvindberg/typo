...
object WViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[WViewRow] = {
    new JdbcDecoder[WViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[WViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[WViewRow] = {
    new JsonEncoder[WViewRow] {
