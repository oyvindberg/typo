...
object PiViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[PiViewRow] = {
    new JdbcDecoder[PiViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PiViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PiViewRow] = {
    new JsonEncoder[PiViewRow] {
