...
object PrViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[PrViewRow] = {
    new JdbcDecoder[PrViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PrViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PrViewRow] = {
    new JsonEncoder[PrViewRow] {
