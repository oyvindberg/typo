...
object PlphViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[PlphViewRow] = {
    new JdbcDecoder[PlphViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PlphViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PlphViewRow] = {
    new JsonEncoder[PlphViewRow] {
