...
object PdViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[PdViewRow] = {
    new JdbcDecoder[PdViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PdViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PdViewRow] = {
    new JsonEncoder[PdViewRow] {
