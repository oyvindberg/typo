...
object SalesterritoryhistoryRow {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[SalesterritoryhistoryRow] = {
    new JdbcDecoder[SalesterritoryhistoryRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[SalesterritoryhistoryRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[SalesterritoryhistoryRow] = {
    new JsonEncoder[SalesterritoryhistoryRow] {
