...
object SalesterritoryhistoryRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[SalesterritoryhistoryRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[SalesterritoryhistoryRowUnsaved] = {
    new JsonEncoder[SalesterritoryhistoryRowUnsaved] {
