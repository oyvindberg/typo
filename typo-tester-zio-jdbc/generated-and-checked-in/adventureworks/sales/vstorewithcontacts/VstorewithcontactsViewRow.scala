...
object VstorewithcontactsViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[VstorewithcontactsViewRow] = {
    new JdbcDecoder[VstorewithcontactsViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[VstorewithcontactsViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[VstorewithcontactsViewRow] = {
