...
object SalesreasonRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[SalesreasonRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[SalesreasonRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[SalesreasonRow] = {
