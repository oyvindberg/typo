...
object SalesreasonRowUnsaved {
  implicit lazy val decoder: JsonDecoder[SalesreasonRowUnsaved] = DeriveJsonDecoder.gen[SalesreasonRowUnsaved]
  implicit lazy val decoder: JsonDecoder[SalesreasonRowUnsaved] = DeriveJsonEncoder.gen[SalesreasonRowUnsaved]
}
