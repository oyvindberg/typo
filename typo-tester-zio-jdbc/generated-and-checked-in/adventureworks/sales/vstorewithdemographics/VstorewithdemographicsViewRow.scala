...
object VstorewithdemographicsViewRow {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[VstorewithdemographicsViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val AnnualSales = jsonObj.get("AnnualSales").fold[Either[String, Option[TypoMoney]]](Right(None))(_.as(JsonDecoder.option(TypoMoney.jsonDecoder)))
    val AnnualRevenue = jsonObj.get("AnnualRevenue").fold[Either[String, Option[TypoMoney]]](Right(None))(_.as(JsonDecoder.option(TypoMoney.jsonDecoder)))
    val BankName = jsonObj.get("BankName").fold[Either[String, Option[String]]](Right(None))(_.as(JsonDecoder.option(JsonDecoder.string)))
    val BusinessType = jsonObj.get("BusinessType").fold[Either[String, Option[String]]](Right(None))(_.as(JsonDecoder.option(JsonDecoder.string)))
    val YearOpened = jsonObj.get("YearOpened").fold[Either[String, Option[Int]]](Right(None))(_.as(JsonDecoder.option(JsonDecoder.int)))
    val Specialty = jsonObj.get("Specialty").fold[Either[String, Option[String]]](Right(None))(_.as(JsonDecoder.option(JsonDecoder.string)))
    val SquareFeet = jsonObj.get("SquareFeet").fold[Either[String, Option[Int]]](Right(None))(_.as(JsonDecoder.option(JsonDecoder.int)))
    val Brands = jsonObj.get("Brands").fold[Either[String, Option[String]]](Right(None))(_.as(JsonDecoder.option(JsonDecoder.string)))
    val Internet = jsonObj.get("Internet").fold[Either[String, Option[String]]](Right(None))(_.as(JsonDecoder.option(JsonDecoder.string)))
    val NumberEmployees = jsonObj.get("NumberEmployees").fold[Either[String, Option[Int]]](Right(None))(_.as(JsonDecoder.option(JsonDecoder.int)))
  ...
  implicit lazy val jsonEncoder: JsonEncoder[VstorewithdemographicsViewRow] = new JsonEncoder[VstorewithdemographicsViewRow] {
    override def unsafeEncode(a: VstorewithdemographicsViewRow, indent: Option[Int], out: Write): Unit = {
      ...
      JsonEncoder.option(TypoMoney.jsonEncoder).unsafeEncode(a.AnnualSales, indent, out)
      out.write(",")
      out.write(""""AnnualRevenue":""")
      JsonEncoder.option(TypoMoney.jsonEncoder).unsafeEncode(a.AnnualRevenue, indent, out)
      out.write(",")
      out.write(""""BankName":""")
      JsonEncoder.option(JsonEncoder.string).unsafeEncode(a.BankName, indent, out)
      out.write(",")
      out.write(""""BusinessType":""")
      JsonEncoder.option(JsonEncoder.string).unsafeEncode(a.BusinessType, indent, out)
      out.write(",")
      out.write(""""YearOpened":""")
      JsonEncoder.option(JsonEncoder.int).unsafeEncode(a.YearOpened, indent, out)
      out.write(",")
      out.write(""""Specialty":""")
      JsonEncoder.option(JsonEncoder.string).unsafeEncode(a.Specialty, indent, out)
      out.write(",")
      out.write(""""SquareFeet":""")
      JsonEncoder.option(JsonEncoder.int).unsafeEncode(a.SquareFeet, indent, out)
      out.write(",")
      out.write(""""Brands":""")
      JsonEncoder.option(JsonEncoder.string).unsafeEncode(a.Brands, indent, out)
      out.write(",")
      out.write(""""Internet":""")
      JsonEncoder.option(JsonEncoder.string).unsafeEncode(a.Internet, indent, out)
      out.write(",")
      out.write(""""NumberEmployees":""")
      JsonEncoder.option(JsonEncoder.int).unsafeEncode(a.NumberEmployees, indent, out)
      out.write("}")
    }
  }
}
