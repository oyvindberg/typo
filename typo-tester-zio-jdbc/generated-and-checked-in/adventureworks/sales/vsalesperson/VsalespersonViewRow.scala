...
object VsalespersonViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[VsalespersonViewRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[VsalespersonViewRow] = {
    JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
      ...
      val territoryname = jsonObj.get("territoryname").fold[Either[String, Option[Name]]](Right(None))(_.as(JsonDecoder.option(using Name.jsonDecoder)))
      val territorygroup = jsonObj.get("territorygroup").fold[Either[String, Option[String]]](Right(None))(_.as(JsonDecoder.option(using JsonDecoder.string)))
  ...
  implicit lazy val jsonEncoder: JsonEncoder[VsalespersonViewRow] = {
    new JsonEncoder[VsalespersonViewRow] {
      override def unsafeEncode(a: VsalespersonViewRow, indent: Option[Int], out: Write): Unit = {
        ...
        JsonEncoder.option(using Name.jsonEncoder).unsafeEncode(a.territoryname, indent, out)
        out.write(",")
        out.write(""""territorygroup":""")
        JsonEncoder.option(using JsonEncoder.string).unsafeEncode(a.territorygroup, indent, out)
        out.write(",")
