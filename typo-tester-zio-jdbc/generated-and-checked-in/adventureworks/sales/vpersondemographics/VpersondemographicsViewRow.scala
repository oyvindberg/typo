...
object VpersondemographicsViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[VpersondemographicsViewRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[VpersondemographicsViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[VpersondemographicsViewRow] = {
