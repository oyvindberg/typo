...
object CurrencyRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[CurrencyRow] = {
    new JdbcDecoder[CurrencyRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[CurrencyRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[CurrencyRow] = {
