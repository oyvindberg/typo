...
object CountryregioncurrencyId {
  implicit lazy val decoder: JsonDecoder[CountryregioncurrencyId] = DeriveJsonDecoder.gen[CountryregioncurrencyId]
  implicit lazy val decoder: JsonDecoder[CountryregioncurrencyId] = DeriveJsonEncoder.gen[CountryregioncurrencyId]
