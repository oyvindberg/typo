...
object CountryregioncurrencyRow {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[CountryregioncurrencyRow] = {
    new JdbcDecoder[CountryregioncurrencyRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[CountryregioncurrencyRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[CountryregioncurrencyRow] = {
    new JsonEncoder[CountryregioncurrencyRow] {
