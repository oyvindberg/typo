...
object SalestaxrateRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[SalestaxrateRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[SalestaxrateRowUnsaved] = {
    new JsonEncoder[SalestaxrateRowUnsaved] {
