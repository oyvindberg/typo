...
trait SalesorderheadersalesreasonFields {
  ...
  def compositeIdIn(compositeIds: Array[SalesorderheadersalesreasonId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[SalesorderheadersalesreasonId](salesorderid)(_.salesorderid)(using as[Array[SalesorderheaderId]](SalesorderheaderId.arrayJdbcEncoder, PGType.forArray(SalesorderheaderId.pgType)), implicitly), TuplePart[SalesorderheadersalesreasonId](salesreasonid)(_.salesreasonid)(using as[Array[SalesreasonId]](SalesreasonId.arrayJdbcEncoder, PGType.forArray(SalesreasonId.pgType)), implicitly))
