...
trait SalesorderheadersalesreasonFields {
  ...
  def compositeIdIn(compositeIds: Array[SalesorderheadersalesreasonId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[SalesorderheadersalesreasonId](salesorderid)(_.salesorderid)(using as[Array[SalesorderheaderId], Required](SalesorderheaderId.arrayJdbcEncoder, PGType.forArray(SalesorderheaderId.pgType)), implicitly), TuplePart[SalesorderheadersalesreasonId](salesreasonid)(_.salesreasonid)(using as[Array[SalesreasonId], Required](SalesreasonId.arrayJdbcEncoder, PGType.forArray(SalesreasonId.pgType)), implicitly))
