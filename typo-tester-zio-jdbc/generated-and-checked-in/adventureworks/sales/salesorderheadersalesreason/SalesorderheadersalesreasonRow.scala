...
object SalesorderheadersalesreasonRow {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[SalesorderheadersalesreasonRow] = {
    new JdbcDecoder[SalesorderheadersalesreasonRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[SalesorderheadersalesreasonRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[SalesorderheadersalesreasonRow] = {
