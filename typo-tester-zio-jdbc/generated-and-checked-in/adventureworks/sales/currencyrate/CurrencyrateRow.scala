...
object CurrencyrateRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[CurrencyrateRow] = {
    new JdbcDecoder[CurrencyrateRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[CurrencyrateRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[CurrencyrateRow] = {
