...
object StoreRowUnsaved {
  implicit lazy val decoder: JsonDecoder[StoreRowUnsaved] = DeriveJsonDecoder.gen[StoreRowUnsaved]
  implicit lazy val decoder: JsonDecoder[StoreRowUnsaved] = DeriveJsonEncoder.gen[StoreRowUnsaved]
}
