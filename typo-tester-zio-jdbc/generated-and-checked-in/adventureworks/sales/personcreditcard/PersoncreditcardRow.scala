...
/** Table: sales.personcreditcard
  ...
  */
case class PersoncreditcardRow(/** Business entity identification number. Foreign key to Person.BusinessEntityID.
  ...
  def id: PersoncreditcardId = compositeId
...
object PersoncreditcardRow {
  def apply(compositeId: PersoncreditcardId, modifieddate: TypoLocalDateTime): PersoncreditcardRow = new PersoncreditcardRow(compositeId.businessentityid, compositeId.creditcardid, modifieddate)
  implicit lazy val jdbcDecoder: JdbcDecoder[PersoncreditcardRow] = {
    new JdbcDecoder[PersoncreditcardRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PersoncreditcardRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PersoncreditcardRow] = {
    new JsonEncoder[PersoncreditcardRow] {
  ...
  implicit lazy val text: Text[PersoncreditcardRow] = {
