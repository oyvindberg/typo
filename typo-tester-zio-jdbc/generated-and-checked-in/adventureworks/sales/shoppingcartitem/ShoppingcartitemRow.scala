...
object ShoppingcartitemRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[ShoppingcartitemRow] = {
    new JdbcDecoder[ShoppingcartitemRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[ShoppingcartitemRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[ShoppingcartitemRow] = {
  ...
  implicit lazy val text: Text[ShoppingcartitemRow] = {
