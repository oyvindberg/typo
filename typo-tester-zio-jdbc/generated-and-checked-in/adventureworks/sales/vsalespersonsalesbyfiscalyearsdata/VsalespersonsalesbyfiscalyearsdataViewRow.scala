...
object VsalespersonsalesbyfiscalyearsdataViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[VsalespersonsalesbyfiscalyearsdataViewRow] = {
    new JdbcDecoder[VsalespersonsalesbyfiscalyearsdataViewRow] {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[VsalespersonsalesbyfiscalyearsdataViewRow] = {
    new JsonEncoder[VsalespersonsalesbyfiscalyearsdataViewRow] {
