...
object SalesorderheaderRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[SalesorderheaderRow] = {
    new JdbcDecoder[SalesorderheaderRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[SalesorderheaderRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[SalesorderheaderRow] = {
