...
object SalesorderheaderRowUnsaved {
  implicit lazy val decoder: JsonDecoder[SalesorderheaderRowUnsaved] = DeriveJsonDecoder.gen[SalesorderheaderRowUnsaved]
  implicit lazy val decoder: JsonDecoder[SalesorderheaderRowUnsaved] = DeriveJsonEncoder.gen[SalesorderheaderRowUnsaved]
}
