...
object VindividualcustomerViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[VindividualcustomerViewRow] = new JdbcDecoder[VindividualcustomerViewRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, VindividualcustomerViewRow) =
      columIndex + 17 ->
        VindividualcustomerViewRow(
          ...
          phonenumber = JdbcDecoder.optionDecoder(Phone.jdbcDecoder).unsafeDecode(columIndex + 6, rs)._2,
          phonenumbertype = JdbcDecoder.optionDecoder(Name.jdbcDecoder).unsafeDecode(columIndex + 7, rs)._2,
          emailaddress = JdbcDecoder.optionDecoder(JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 8, rs)._2,
          ...
          demographics = JdbcDecoder.optionDecoder(TypoXml.jdbcDecoder).unsafeDecode(columIndex + 17, rs)._2
        )
  }
  implicit lazy val jsonDecoder: JsonDecoder[VindividualcustomerViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  implicit lazy val jsonEncoder: JsonEncoder[VindividualcustomerViewRow] = new JsonEncoder[VindividualcustomerViewRow] {
