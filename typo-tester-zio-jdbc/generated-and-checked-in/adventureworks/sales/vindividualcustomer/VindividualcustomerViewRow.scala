...
object VindividualcustomerViewRow {
  implicit lazy val decoder: JsonDecoder[VindividualcustomerViewRow] = DeriveJsonDecoder.gen[VindividualcustomerViewRow]
  implicit lazy val decoder: JsonDecoder[VindividualcustomerViewRow] = DeriveJsonEncoder.gen[VindividualcustomerViewRow]
}
