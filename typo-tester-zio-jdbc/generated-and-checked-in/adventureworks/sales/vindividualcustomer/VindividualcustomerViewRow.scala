...
object VindividualcustomerViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[VindividualcustomerViewRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[VindividualcustomerViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[VindividualcustomerViewRow] = {
