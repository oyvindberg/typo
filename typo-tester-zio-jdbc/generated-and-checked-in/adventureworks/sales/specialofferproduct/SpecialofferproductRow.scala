...
case class SpecialofferproductRow(
  ...
  def id: SpecialofferproductId = compositeId
...
object SpecialofferproductRow {
  def apply(compositeId: SpecialofferproductId, rowguid: TypoUUID, modifieddate: TypoLocalDateTime): SpecialofferproductRow = {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[SpecialofferproductRow] = {
    new JdbcDecoder[SpecialofferproductRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[SpecialofferproductRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[SpecialofferproductRow] = {
    new JsonEncoder[SpecialofferproductRow] {
  ...
  implicit lazy val text: Text[SpecialofferproductRow] = {
