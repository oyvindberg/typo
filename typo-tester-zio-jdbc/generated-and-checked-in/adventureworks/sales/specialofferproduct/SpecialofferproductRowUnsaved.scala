...
object SpecialofferproductRowUnsaved {
  implicit lazy val decoder: JsonDecoder[SpecialofferproductRowUnsaved] = DeriveJsonDecoder.gen[SpecialofferproductRowUnsaved]
  implicit lazy val decoder: JsonDecoder[SpecialofferproductRowUnsaved] = DeriveJsonEncoder.gen[SpecialofferproductRowUnsaved]
}
