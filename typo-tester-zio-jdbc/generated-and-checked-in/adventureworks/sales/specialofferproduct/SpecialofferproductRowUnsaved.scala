...
object SpecialofferproductRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[SpecialofferproductRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[SpecialofferproductRowUnsaved] = {
    new JsonEncoder[SpecialofferproductRowUnsaved] {
