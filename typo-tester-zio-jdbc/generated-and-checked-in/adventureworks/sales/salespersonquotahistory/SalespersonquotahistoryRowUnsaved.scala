...
object SalespersonquotahistoryRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[SalespersonquotahistoryRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[SalespersonquotahistoryRowUnsaved] = {
    new JsonEncoder[SalespersonquotahistoryRowUnsaved] {
