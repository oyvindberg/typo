...
object SalespersonquotahistoryRow {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[SalespersonquotahistoryRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[SalespersonquotahistoryRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[SalespersonquotahistoryRow] = {
    new JsonEncoder[SalespersonquotahistoryRow] {
