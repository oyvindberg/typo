...
object CreditcardRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[CreditcardRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[CreditcardRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[CreditcardRow] = {
    new JsonEncoder[CreditcardRow] {
  ...
  implicit lazy val text: Text[CreditcardRow] = {
