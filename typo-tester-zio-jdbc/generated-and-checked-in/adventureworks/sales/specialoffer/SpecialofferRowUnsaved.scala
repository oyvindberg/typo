...
object SpecialofferRowUnsaved {
  implicit lazy val decoder: JsonDecoder[SpecialofferRowUnsaved] = DeriveJsonDecoder.gen[SpecialofferRowUnsaved]
  implicit lazy val decoder: JsonDecoder[SpecialofferRowUnsaved] = DeriveJsonEncoder.gen[SpecialofferRowUnsaved]
}
