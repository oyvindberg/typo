...
object SpecialofferRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[SpecialofferRow] = {
    new JdbcDecoder[SpecialofferRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[SpecialofferRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[SpecialofferRow] = {
    new JsonEncoder[SpecialofferRow] {
