...
trait DepartmentRepo {
  ...
  def deleteById(id: DepartmentId): ZIO[ZConnection, Throwable, Boolean]
  def deleteByIds(ids: Array[DepartmentId]): ZIO[ZConnection, Throwable, Long]
  ...
  def selectById(id: DepartmentId): ZIO[ZConnection, Throwable, Option[DepartmentRow]]
  def selectByIds(ids: Array[DepartmentId]): ZStream[ZConnection, Throwable, DepartmentRow]
  def selectByIdsTracked(ids: Array[DepartmentId]): ZIO[ZConnection, Throwable, Map[DepartmentId, DepartmentRow]]
