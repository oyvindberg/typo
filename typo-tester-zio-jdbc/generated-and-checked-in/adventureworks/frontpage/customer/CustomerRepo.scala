...
trait CustomerRepo {
  ...
  def deleteById(id: CustomerId): ZIO[ZConnection, Throwable, Boolean]
  def deleteByIds(ids: Array[CustomerId]): ZIO[ZConnection, Throwable, Long]
  ...
  def selectById(id: CustomerId): ZIO[ZConnection, Throwable, Option[CustomerRow]]
  def selectByIds(ids: Array[CustomerId]): ZStream[ZConnection, Throwable, CustomerRow]
  def selectByIdsTracked(ids: Array[CustomerId]): ZIO[ZConnection, Throwable, Map[CustomerId, CustomerRow]]
