...
trait ProductRepo {
  ...
  def deleteById(id: ProductId): ZIO[ZConnection, Throwable, Boolean]
  def deleteByIds(ids: Array[ProductId]): ZIO[ZConnection, Throwable, Long]
  ...
  def selectById(id: ProductId): ZIO[ZConnection, Throwable, Option[ProductRow]]
  def selectByIds(ids: Array[ProductId]): ZStream[ZConnection, Throwable, ProductRow]
  def selectByIdsTracked(ids: Array[ProductId]): ZIO[ZConnection, Throwable, Map[ProductId, ProductRow]]
