...
object PersonRowUnsaved {
  implicit lazy val decoder: JsonDecoder[PersonRowUnsaved] = DeriveJsonDecoder.gen[PersonRowUnsaved]
  implicit lazy val decoder: JsonDecoder[PersonRowUnsaved] = DeriveJsonEncoder.gen[PersonRowUnsaved]
}
