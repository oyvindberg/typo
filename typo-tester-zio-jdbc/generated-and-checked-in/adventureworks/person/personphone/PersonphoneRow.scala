...
case class PersonphoneRow(
  ...
  def id: PersonphoneId = compositeId
...
object PersonphoneRow {
  def apply(compositeId: PersonphoneId, modifieddate: TypoLocalDateTime): PersonphoneRow = {
    new PersonphoneRow(
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[PersonphoneRow] = {
    new JdbcDecoder[PersonphoneRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PersonphoneRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PersonphoneRow] = {
    new JsonEncoder[PersonphoneRow] {
  ...
  implicit lazy val text: Text[PersonphoneRow] = {
    Text.instance[PersonphoneRow]{ (row, sb) =>
