...
object AddresstypeRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[AddresstypeRow] = {
    new JdbcDecoder[AddresstypeRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[AddresstypeRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[AddresstypeRow] = {
    new JsonEncoder[AddresstypeRow] {
