...
object PhonenumbertypeRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[PhonenumbertypeRow] = {
    new JdbcDecoder[PhonenumbertypeRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PhonenumbertypeRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PhonenumbertypeRow] = {
    new JsonEncoder[PhonenumbertypeRow] {
