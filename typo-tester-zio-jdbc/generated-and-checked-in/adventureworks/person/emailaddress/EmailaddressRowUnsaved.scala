...
object EmailaddressRowUnsaved {
  implicit lazy val decoder: JsonDecoder[EmailaddressRowUnsaved] = DeriveJsonDecoder.gen[EmailaddressRowUnsaved]
  implicit lazy val decoder: JsonDecoder[EmailaddressRowUnsaved] = DeriveJsonEncoder.gen[EmailaddressRowUnsaved]
}
