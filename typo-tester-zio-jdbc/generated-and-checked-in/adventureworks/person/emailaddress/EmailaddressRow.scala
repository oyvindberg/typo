...
object EmailaddressRow {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[EmailaddressRow] = {
    new JdbcDecoder[EmailaddressRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[EmailaddressRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[EmailaddressRow] = {
    new JsonEncoder[EmailaddressRow] {
