...
object BusinessentityaddressId {
  implicit lazy val jsonDecoder: JsonDecoder[BusinessentityaddressId] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[BusinessentityaddressId] = {
