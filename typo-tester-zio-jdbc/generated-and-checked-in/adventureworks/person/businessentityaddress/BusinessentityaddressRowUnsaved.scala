...
object BusinessentityaddressRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[BusinessentityaddressRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[BusinessentityaddressRowUnsaved] = {
  ...
  implicit lazy val text: Text[BusinessentityaddressRowUnsaved] = {
