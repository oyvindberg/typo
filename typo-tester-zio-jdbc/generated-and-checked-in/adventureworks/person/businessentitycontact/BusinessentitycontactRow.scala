...
case class BusinessentitycontactRow(
  ...
  def id: BusinessentitycontactId = compositeId
...
object BusinessentitycontactRow {
  def apply(compositeId: BusinessentitycontactId, rowguid: TypoUUID, modifieddate: TypoLocalDateTime): BusinessentitycontactRow = {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[BusinessentitycontactRow] = {
    new JdbcDecoder[BusinessentitycontactRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[BusinessentitycontactRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[BusinessentitycontactRow] = {
    new JsonEncoder[BusinessentitycontactRow] {
  ...
  implicit lazy val text: Text[BusinessentitycontactRow] = {
    Text.instance[BusinessentitycontactRow]{ (row, sb) =>
