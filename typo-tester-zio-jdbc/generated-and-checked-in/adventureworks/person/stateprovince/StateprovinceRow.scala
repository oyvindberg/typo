...
object StateprovinceRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[StateprovinceRow] = {
    new JdbcDecoder[StateprovinceRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[StateprovinceRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[StateprovinceRow] = {
    new JsonEncoder[StateprovinceRow] {
