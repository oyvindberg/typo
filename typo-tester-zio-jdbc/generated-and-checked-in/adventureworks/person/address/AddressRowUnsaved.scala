...
object AddressRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[AddressRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[AddressRowUnsaved] = {
  ...
  implicit lazy val text: Text[AddressRowUnsaved] = {
