...
/** Table: person.countryregion
  ...
  */
case class CountryregionRow(/** ISO standard code for countries and regions. */
...
object CountryregionRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[CountryregionRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[CountryregionRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[CountryregionRow] = {
  ...
  implicit lazy val text: Text[CountryregionRow] = {
