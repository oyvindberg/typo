...
object VadditionalcontactinfoViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[VadditionalcontactinfoViewRow] = {
    new JdbcDecoder[VadditionalcontactinfoViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[VadditionalcontactinfoViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[VadditionalcontactinfoViewRow] = {
    new JsonEncoder[VadditionalcontactinfoViewRow] {
