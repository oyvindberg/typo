...
object VadditionalcontactinfoViewRow {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[VadditionalcontactinfoViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val street = jsonObj.get("street").fold[Either[String, Option[TypoXml]]](Right(None))(_.as(JsonDecoder.option(TypoXml.jsonDecoder)))
    val city = jsonObj.get("city").fold[Either[String, Option[TypoXml]]](Right(None))(_.as(JsonDecoder.option(TypoXml.jsonDecoder)))
    val stateprovince = jsonObj.get("stateprovince").fold[Either[String, Option[TypoXml]]](Right(None))(_.as(JsonDecoder.option(TypoXml.jsonDecoder)))
    val postalcode = jsonObj.get("postalcode").fold[Either[String, Option[TypoXml]]](Right(None))(_.as(JsonDecoder.option(TypoXml.jsonDecoder)))
    val countryregion = jsonObj.get("countryregion").fold[Either[String, Option[TypoXml]]](Right(None))(_.as(JsonDecoder.option(TypoXml.jsonDecoder)))
    val homeaddressspecialinstructions = jsonObj.get("homeaddressspecialinstructions").fold[Either[String, Option[TypoXml]]](Right(None))(_.as(JsonDecoder.option(TypoXml.jsonDecoder)))
    val emailaddress = jsonObj.get("emailaddress").fold[Either[String, Option[TypoXml]]](Right(None))(_.as(JsonDecoder.option(TypoXml.jsonDecoder)))
    val emailspecialinstructions = jsonObj.get("emailspecialinstructions").fold[Either[String, Option[String]]](Right(None))(_.as(JsonDecoder.option(JsonDecoder.string)))
    val emailtelephonenumber = jsonObj.get("emailtelephonenumber").fold[Either[String, Option[TypoXml]]](Right(None))(_.as(JsonDecoder.option(TypoXml.jsonDecoder)))
  ...
  implicit lazy val jsonEncoder: JsonEncoder[VadditionalcontactinfoViewRow] = new JsonEncoder[VadditionalcontactinfoViewRow] {
    override def unsafeEncode(a: VadditionalcontactinfoViewRow, indent: Option[Int], out: Write): Unit = {
      ...
      JsonEncoder.option(TypoXml.jsonEncoder).unsafeEncode(a.telephonenumber, indent, out)
      out.write(",")
      out.write(""""telephonespecialinstructions":""")
      JsonEncoder.option(JsonEncoder.string).unsafeEncode(a.telephonespecialinstructions, indent, out)
      out.write(",")
      out.write(""""street":""")
      JsonEncoder.option(TypoXml.jsonEncoder).unsafeEncode(a.street, indent, out)
      out.write(",")
      out.write(""""city":""")
      JsonEncoder.option(TypoXml.jsonEncoder).unsafeEncode(a.city, indent, out)
      out.write(",")
      out.write(""""stateprovince":""")
      JsonEncoder.option(TypoXml.jsonEncoder).unsafeEncode(a.stateprovince, indent, out)
      out.write(",")
      out.write(""""postalcode":""")
      JsonEncoder.option(TypoXml.jsonEncoder).unsafeEncode(a.postalcode, indent, out)
      out.write(",")
      out.write(""""countryregion":""")
      JsonEncoder.option(TypoXml.jsonEncoder).unsafeEncode(a.countryregion, indent, out)
      out.write(",")
      out.write(""""homeaddressspecialinstructions":""")
      JsonEncoder.option(TypoXml.jsonEncoder).unsafeEncode(a.homeaddressspecialinstructions, indent, out)
      out.write(",")
      out.write(""""emailaddress":""")
      JsonEncoder.option(TypoXml.jsonEncoder).unsafeEncode(a.emailaddress, indent, out)
      out.write(",")
      out.write(""""emailspecialinstructions":""")
      JsonEncoder.option(JsonEncoder.string).unsafeEncode(a.emailspecialinstructions, indent, out)
      out.write(",")
      out.write(""""emailtelephonenumber":""")
      JsonEncoder.option(TypoXml.jsonEncoder).unsafeEncode(a.emailtelephonenumber, indent, out)
      out.write(",")
      out.write(""""rowguid":""")
