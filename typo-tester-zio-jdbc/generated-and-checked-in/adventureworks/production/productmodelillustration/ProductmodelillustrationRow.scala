...
object ProductmodelillustrationRow {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[ProductmodelillustrationRow] = {
    new JdbcDecoder[ProductmodelillustrationRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[ProductmodelillustrationRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[ProductmodelillustrationRow] = {
    new JsonEncoder[ProductmodelillustrationRow] {
