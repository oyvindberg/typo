...
object ProductmodelillustrationId {
  implicit lazy val decoder: JsonDecoder[ProductmodelillustrationId] = DeriveJsonDecoder.gen[ProductmodelillustrationId]
  implicit lazy val decoder: JsonDecoder[ProductmodelillustrationId] = DeriveJsonEncoder.gen[ProductmodelillustrationId]
