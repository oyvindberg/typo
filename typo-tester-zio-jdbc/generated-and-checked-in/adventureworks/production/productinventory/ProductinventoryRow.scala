...
object ProductinventoryRow {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[ProductinventoryRow] = {
    new JdbcDecoder[ProductinventoryRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[ProductinventoryRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[ProductinventoryRow] = {
    new JsonEncoder[ProductinventoryRow] {
