...
trait ProductinventoryFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductinventoryId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[ProductinventoryId](productid)(_.productid)(using as[Array[ProductId], Required](ProductId.arrayJdbcEncoder, PGType.forArray(ProductId.pgType)), implicitly), TuplePart[ProductinventoryId](locationid)(_.locationid)(using as[Array[LocationId], Required](LocationId.arrayJdbcEncoder, PGType.forArray(LocationId.pgType)), implicitly))
