...
trait ProductinventoryFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductinventoryId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[ProductinventoryId](productid)(_.productid)(using as[Array[ProductId]](ProductId.arrayJdbcEncoder, PGType.forArray(ProductId.pgType)), implicitly), TuplePart[ProductinventoryId](locationid)(_.locationid)(using as[Array[LocationId]](LocationId.arrayJdbcEncoder, PGType.forArray(LocationId.pgType)), implicitly))
