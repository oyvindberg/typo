...
object ProductproductphotoRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[ProductproductphotoRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[ProductproductphotoRowUnsaved] = {
  ...
  implicit lazy val text: Text[ProductproductphotoRowUnsaved] = {
