...
object ProductphotoRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[ProductphotoRow] = {
    new JdbcDecoder[ProductphotoRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[ProductphotoRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[ProductphotoRow] = {
    new JsonEncoder[ProductphotoRow] {
