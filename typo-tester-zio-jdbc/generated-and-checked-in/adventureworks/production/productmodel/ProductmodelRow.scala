...
object ProductmodelRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[ProductmodelRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[ProductmodelRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[ProductmodelRow] = {
    new JsonEncoder[ProductmodelRow] {
