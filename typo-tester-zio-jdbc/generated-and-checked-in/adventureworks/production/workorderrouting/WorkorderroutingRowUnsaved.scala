...
object WorkorderroutingRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[WorkorderroutingRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[WorkorderroutingRowUnsaved] = {
    new JsonEncoder[WorkorderroutingRowUnsaved] {
