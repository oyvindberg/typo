...
object WorkorderroutingRowUnsaved {
  implicit lazy val decoder: JsonDecoder[WorkorderroutingRowUnsaved] = DeriveJsonDecoder.gen[WorkorderroutingRowUnsaved]
  implicit lazy val decoder: JsonDecoder[WorkorderroutingRowUnsaved] = DeriveJsonEncoder.gen[WorkorderroutingRowUnsaved]
}
