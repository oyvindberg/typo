...
case class ProductlistpricehistoryRow(
  ...
  def id: ProductlistpricehistoryId = compositeId
...
object ProductlistpricehistoryRow {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[ProductlistpricehistoryRow] = {
    new JdbcDecoder[ProductlistpricehistoryRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[ProductlistpricehistoryRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[ProductlistpricehistoryRow] = {
    new JsonEncoder[ProductlistpricehistoryRow] {
  ...
  implicit lazy val text: Text[ProductlistpricehistoryRow] = {
