...
object ProductlistpricehistoryRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[ProductlistpricehistoryRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[ProductlistpricehistoryRowUnsaved] = {
    new JsonEncoder[ProductlistpricehistoryRowUnsaved] {
  ...
  implicit lazy val text: Text[ProductlistpricehistoryRowUnsaved] = {
