...
trait ProductlistpricehistoryFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductlistpricehistoryId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[ProductlistpricehistoryId](productid)(_.productid)(using as[Array[ProductId], Required](ProductId.arrayJdbcEncoder, PGType.forArray(ProductId.pgType)), implicitly), TuplePart[ProductlistpricehistoryId](startdate)(_.startdate)(using as[Array[TypoLocalDateTime], Required](TypoLocalDateTime.arrayJdbcEncoder, PGType.forArray(TypoLocalDateTime.pgType)), implicitly))
