...
object TransactionhistoryRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[TransactionhistoryRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[TransactionhistoryRowUnsaved] = {
  ...
  implicit lazy val text: Text[TransactionhistoryRowUnsaved] = {
