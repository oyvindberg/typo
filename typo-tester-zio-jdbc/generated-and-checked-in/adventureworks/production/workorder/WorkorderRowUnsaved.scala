...
object WorkorderRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[WorkorderRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[WorkorderRowUnsaved] = {
    new JsonEncoder[WorkorderRowUnsaved] {
  ...
  implicit lazy val text: Text[WorkorderRowUnsaved] = {
