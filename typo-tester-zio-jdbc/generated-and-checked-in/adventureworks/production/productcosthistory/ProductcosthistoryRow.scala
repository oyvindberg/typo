...
case class ProductcosthistoryRow(
  ...
  def id: ProductcosthistoryId = compositeId
...
object ProductcosthistoryRow {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[ProductcosthistoryRow] = {
    new JdbcDecoder[ProductcosthistoryRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[ProductcosthistoryRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[ProductcosthistoryRow] = {
    new JsonEncoder[ProductcosthistoryRow] {
  ...
  implicit lazy val text: Text[ProductcosthistoryRow] = {
