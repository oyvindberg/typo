...
object IllustrationRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[IllustrationRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[IllustrationRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[IllustrationRow] = {
