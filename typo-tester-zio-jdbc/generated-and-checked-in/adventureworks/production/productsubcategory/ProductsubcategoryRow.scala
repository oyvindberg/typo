...
object ProductsubcategoryRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[ProductsubcategoryRow] = {
    new JdbcDecoder[ProductsubcategoryRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[ProductsubcategoryRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[ProductsubcategoryRow] = {
    new JsonEncoder[ProductsubcategoryRow] {
  ...
  implicit lazy val text: Text[ProductsubcategoryRow] = {
