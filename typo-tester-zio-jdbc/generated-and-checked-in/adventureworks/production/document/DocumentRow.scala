...
object DocumentRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[DocumentRow] = {
    new JdbcDecoder[DocumentRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[DocumentRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[DocumentRow] = {
    new JsonEncoder[DocumentRow] {
