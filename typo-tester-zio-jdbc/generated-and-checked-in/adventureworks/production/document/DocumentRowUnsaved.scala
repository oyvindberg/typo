...
object DocumentRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[DocumentRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[DocumentRowUnsaved] = {
    new JsonEncoder[DocumentRowUnsaved] {
