...
object DocumentRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[DocumentRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val fileextension = jsonObj.get("fileextension").fold[Either[String, Option[String]]](Right(None))(_.as(JsonDecoder.option(JsonDecoder.string)))
    ...
    val documentsummary = jsonObj.get("documentsummary").fold[Either[String, Option[String]]](Right(None))(_.as(JsonDecoder.option(JsonDecoder.string)))
    val document = jsonObj.get("document").fold[Either[String, Option[TypoBytea]]](Right(None))(_.as(JsonDecoder.option(TypoBytea.jsonDecoder)))
  ...
  implicit lazy val jsonEncoder: JsonEncoder[DocumentRowUnsaved] = new JsonEncoder[DocumentRowUnsaved] {
    override def unsafeEncode(a: DocumentRowUnsaved, indent: Option[Int], out: Write): Unit = {
      ...
      JsonEncoder.option(JsonEncoder.string).unsafeEncode(a.fileextension, indent, out)
      out.write(",")
      out.write(""""revision":""")
      ...
      JsonEncoder.option(JsonEncoder.string).unsafeEncode(a.documentsummary, indent, out)
      out.write(",")
      out.write(""""document":""")
      JsonEncoder.option(TypoBytea.jsonEncoder).unsafeEncode(a.document, indent, out)
      out.write(",")
