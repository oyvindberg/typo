...
object BillofmaterialsRowUnsaved {
  implicit lazy val decoder: JsonDecoder[BillofmaterialsRowUnsaved] = DeriveJsonDecoder.gen[BillofmaterialsRowUnsaved]
  implicit lazy val decoder: JsonDecoder[BillofmaterialsRowUnsaved] = DeriveJsonEncoder.gen[BillofmaterialsRowUnsaved]
}
