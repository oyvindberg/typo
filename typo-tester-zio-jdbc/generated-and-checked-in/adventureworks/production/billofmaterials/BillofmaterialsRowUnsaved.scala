...
object BillofmaterialsRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[BillofmaterialsRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[BillofmaterialsRowUnsaved] = {
  ...
  implicit lazy val text: Text[BillofmaterialsRowUnsaved] = {
