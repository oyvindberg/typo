...
object BillofmaterialsRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[BillofmaterialsRow] = {
    new JdbcDecoder[BillofmaterialsRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[BillofmaterialsRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[BillofmaterialsRow] = {
    new JsonEncoder[BillofmaterialsRow] {
