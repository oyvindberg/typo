...
object VproductanddescriptionMVRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[VproductanddescriptionMVRow] = {
    new JdbcDecoder[VproductanddescriptionMVRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[VproductanddescriptionMVRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[VproductanddescriptionMVRow] = {
    new JsonEncoder[VproductanddescriptionMVRow] {
