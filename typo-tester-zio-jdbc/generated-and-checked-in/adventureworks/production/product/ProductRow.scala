...
object ProductRow {
  implicit lazy val decoder: JsonDecoder[ProductRow] = DeriveJsonDecoder.gen[ProductRow]
  implicit lazy val decoder: JsonDecoder[ProductRow] = DeriveJsonEncoder.gen[ProductRow]
}
