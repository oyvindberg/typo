...
object ProductRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[ProductRow] = {
    new JdbcDecoder[ProductRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[ProductRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[ProductRow] = {
    new JsonEncoder[ProductRow] {
