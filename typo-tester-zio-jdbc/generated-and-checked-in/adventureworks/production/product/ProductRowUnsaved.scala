...
object ProductRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[ProductRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[ProductRowUnsaved] = {
    new JsonEncoder[ProductRowUnsaved] {
