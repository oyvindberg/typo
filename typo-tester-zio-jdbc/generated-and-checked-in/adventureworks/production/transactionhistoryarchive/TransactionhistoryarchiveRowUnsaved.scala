...
object TransactionhistoryarchiveRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[TransactionhistoryarchiveRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[TransactionhistoryarchiveRowUnsaved] = {
    new JsonEncoder[TransactionhistoryarchiveRowUnsaved] {
