...
object ProductcategoryRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[ProductcategoryRow] = {
    new JdbcDecoder[ProductcategoryRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[ProductcategoryRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[ProductcategoryRow] = {
    new JsonEncoder[ProductcategoryRow] {
