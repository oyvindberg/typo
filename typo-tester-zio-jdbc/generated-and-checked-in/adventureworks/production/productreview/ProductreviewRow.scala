...
object ProductreviewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[ProductreviewRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[ProductreviewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[ProductreviewRow] = {
  ...
  implicit lazy val text: Text[ProductreviewRow] = {
