...
object ProductmodelproductdescriptioncultureRow {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[ProductmodelproductdescriptioncultureRow] = {
    new JdbcDecoder[ProductmodelproductdescriptioncultureRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[ProductmodelproductdescriptioncultureRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[ProductmodelproductdescriptioncultureRow] = {
    new JsonEncoder[ProductmodelproductdescriptioncultureRow] {
