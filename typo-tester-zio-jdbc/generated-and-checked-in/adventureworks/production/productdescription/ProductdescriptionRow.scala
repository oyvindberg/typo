...
object ProductdescriptionRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[ProductdescriptionRow] = {
    new JdbcDecoder[ProductdescriptionRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[ProductdescriptionRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[ProductdescriptionRow] = {
    new JsonEncoder[ProductdescriptionRow] {
  ...
  implicit lazy val text: Text[ProductdescriptionRow] = {
