...
trait ProductdocumentFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductdocumentId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[ProductdocumentId](productid)(_.productid)(using as[Array[ProductId], Required](ProductId.arrayJdbcEncoder, PGType.forArray(ProductId.pgType)), implicitly), TuplePart[ProductdocumentId](documentnode)(_.documentnode)(using as[Array[DocumentId], Required](DocumentId.arrayJdbcEncoder, PGType.forArray(DocumentId.pgType)), implicitly))
