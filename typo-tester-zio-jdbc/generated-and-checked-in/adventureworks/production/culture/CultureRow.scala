...
/** Table: production.culture
  ...
  */
case class CultureRow(/** Primary key for Culture records. */
...
object CultureRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[CultureRow] = {
    new JdbcDecoder[CultureRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[CultureRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[CultureRow] = {
    new JsonEncoder[CultureRow] {
  ...
  implicit lazy val text: Text[CultureRow] = {
