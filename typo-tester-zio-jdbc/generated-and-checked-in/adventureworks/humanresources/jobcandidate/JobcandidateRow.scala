...
object JobcandidateRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[JobcandidateRow] = {
    new JdbcDecoder[JobcandidateRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[JobcandidateRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[JobcandidateRow] = {
    new JsonEncoder[JobcandidateRow] {
  ...
  implicit lazy val text: Text[JobcandidateRow] = {
