...
object VemployeedepartmentViewRow {
  implicit lazy val decoder: JsonDecoder[VemployeedepartmentViewRow] = DeriveJsonDecoder.gen[VemployeedepartmentViewRow]
  implicit lazy val decoder: JsonDecoder[VemployeedepartmentViewRow] = DeriveJsonEncoder.gen[VemployeedepartmentViewRow]
}
