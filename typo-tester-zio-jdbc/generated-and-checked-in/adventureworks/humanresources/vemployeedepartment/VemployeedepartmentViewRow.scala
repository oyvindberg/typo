...
object VemployeedepartmentViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[VemployeedepartmentViewRow] = {
    new JdbcDecoder[VemployeedepartmentViewRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[VemployeedepartmentViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[VemployeedepartmentViewRow] = {
    new JsonEncoder[VemployeedepartmentViewRow] {
