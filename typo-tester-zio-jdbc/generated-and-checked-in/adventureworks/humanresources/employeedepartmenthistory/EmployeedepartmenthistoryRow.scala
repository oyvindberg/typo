...
object EmployeedepartmenthistoryRow {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[EmployeedepartmenthistoryRow] = {
    new JdbcDecoder[EmployeedepartmenthistoryRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[EmployeedepartmenthistoryRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[EmployeedepartmenthistoryRow] = {
    new JsonEncoder[EmployeedepartmenthistoryRow] {
