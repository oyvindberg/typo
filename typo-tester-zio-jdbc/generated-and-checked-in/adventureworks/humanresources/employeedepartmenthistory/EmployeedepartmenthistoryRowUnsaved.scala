...
object EmployeedepartmenthistoryRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[EmployeedepartmenthistoryRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[EmployeedepartmenthistoryRowUnsaved] = {
    new JsonEncoder[EmployeedepartmenthistoryRowUnsaved] {
