...
object VemployeedepartmenthistoryViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[VemployeedepartmenthistoryViewRow] = {
    new JdbcDecoder[VemployeedepartmenthistoryViewRow] {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[VemployeedepartmenthistoryViewRow] = {
