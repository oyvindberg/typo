...
object VemployeedepartmenthistoryViewRepoImpl extends VemployeedepartmenthistoryViewRepo {
  ...
  override def selectAll: ZStream[ZConnection, Throwable, VemployeedepartmenthistoryViewRow] = {
    sql"""select "businessentityid", "title", "firstname", "middlename", "lastname", "suffix", "shift", "department", "groupname", "startdate"::text, "enddate"::text from humanresources.vemployeedepartmenthistory""".query[VemployeedepartmenthistoryViewRow].selectStream
  }
}
