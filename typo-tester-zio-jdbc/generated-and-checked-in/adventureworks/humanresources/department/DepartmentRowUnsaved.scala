...
object DepartmentRowUnsaved {
  implicit lazy val decoder: JsonDecoder[DepartmentRowUnsaved] = DeriveJsonDecoder.gen[DepartmentRowUnsaved]
  implicit lazy val decoder: JsonDecoder[DepartmentRowUnsaved] = DeriveJsonEncoder.gen[DepartmentRowUnsaved]
}
