...
object DepartmentRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[DepartmentRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[DepartmentRowUnsaved] = {
  ...
  implicit lazy val text: Text[DepartmentRowUnsaved] = {
