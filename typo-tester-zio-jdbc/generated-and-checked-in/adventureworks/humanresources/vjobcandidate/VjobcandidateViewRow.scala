...
object VjobcandidateViewRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[VjobcandidateViewRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[VjobcandidateViewRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[VjobcandidateViewRow] = {
