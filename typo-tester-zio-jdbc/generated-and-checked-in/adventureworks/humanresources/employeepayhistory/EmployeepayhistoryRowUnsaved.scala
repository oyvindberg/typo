...
object EmployeepayhistoryRowUnsaved {
  implicit lazy val jsonDecoder: JsonDecoder[EmployeepayhistoryRowUnsaved] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[EmployeepayhistoryRowUnsaved] = {
    new JsonEncoder[EmployeepayhistoryRowUnsaved] {
