...
object EmployeepayhistoryRow {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[EmployeepayhistoryRow] = {
    new JdbcDecoder[EmployeepayhistoryRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[EmployeepayhistoryRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[EmployeepayhistoryRow] = {
    new JsonEncoder[EmployeepayhistoryRow] {
