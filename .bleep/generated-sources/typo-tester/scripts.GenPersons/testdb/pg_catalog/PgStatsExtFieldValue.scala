...
object PgStatsExtFieldValue {
  ...
  case class attnames(override val value: /* typo doesn't know how to translate: columnType: Array, columnTypeName: _name, columnClassName: java.sql.Array */ Any) extends PgStatsExtFieldValue("attnames", value)
  ...
  case class mostCommonValNulls(override val value: /* typo doesn't know how to translate: columnType: Array, columnTypeName: _bool, columnClassName: java.sql.Array */ Any) extends PgStatsExtFieldValue("most_common_val_nulls", value)
