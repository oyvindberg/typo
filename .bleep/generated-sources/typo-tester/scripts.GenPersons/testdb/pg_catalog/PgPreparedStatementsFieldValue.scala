...
object PgPreparedStatementsFieldValue {
  ...
  case class parameterTypes(override val value: /* typo doesn't know how to translate: columnType: Array, columnTypeName: _regtype, columnClassName: java.sql.Array */ Any) extends PgPreparedStatementsFieldValue("parameter_types", value)
