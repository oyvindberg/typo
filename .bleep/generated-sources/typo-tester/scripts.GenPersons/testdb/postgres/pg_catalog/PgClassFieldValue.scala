...
object PgClassFieldValue {
  ...
  case class reloftype(override val value: /* oid */ Long) extends PgClassFieldValue("reloftype", value)
  case class relowner(override val value: /* oid */ Long) extends PgClassFieldValue("relowner", value)
  case class relam(override val value: /* oid */ Long) extends PgClassFieldValue("relam", value)
  case class relfilenode(override val value: /* oid */ Long) extends PgClassFieldValue("relfilenode", value)
  case class reltablespace(override val value: /* oid */ Long) extends PgClassFieldValue("reltablespace", value)
  ...
  case class reltoastrelid(override val value: /* oid */ Long) extends PgClassFieldValue("reltoastrelid", value)
  ...
  case class relrewrite(override val value: /* oid */ Long) extends PgClassFieldValue("relrewrite", value)
  case class relfrozenxid(override val value: /* xid */ PGobject) extends PgClassFieldValue("relfrozenxid", value)
  case class relminmxid(override val value: /* xid */ PGobject) extends PgClassFieldValue("relminmxid", value)
  case class relacl(override val value: Option[Array[/* aclitem */ PGobject]]) extends PgClassFieldValue("relacl", value)
  case class reloptions(override val value: Option[Array[String]]) extends PgClassFieldValue("reloptions", value)
  case class relpartbound(override val value: Option[/* pg_node_tree */ PGobject]) extends PgClassFieldValue("relpartbound", value)
}
