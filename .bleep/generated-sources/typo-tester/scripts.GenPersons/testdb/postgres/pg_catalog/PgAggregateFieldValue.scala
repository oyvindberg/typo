...
object PgAggregateFieldValue {
  ...
  case class aggtransfn(override val value: /* regproc */ PGobject) extends PgAggregateFieldValue("aggtransfn", value)
  case class aggfinalfn(override val value: /* regproc */ PGobject) extends PgAggregateFieldValue("aggfinalfn", value)
  case class aggcombinefn(override val value: /* regproc */ PGobject) extends PgAggregateFieldValue("aggcombinefn", value)
  case class aggserialfn(override val value: /* regproc */ PGobject) extends PgAggregateFieldValue("aggserialfn", value)
  case class aggdeserialfn(override val value: /* regproc */ PGobject) extends PgAggregateFieldValue("aggdeserialfn", value)
  case class aggmtransfn(override val value: /* regproc */ PGobject) extends PgAggregateFieldValue("aggmtransfn", value)
  case class aggminvtransfn(override val value: /* regproc */ PGobject) extends PgAggregateFieldValue("aggminvtransfn", value)
  case class aggmfinalfn(override val value: /* regproc */ PGobject) extends PgAggregateFieldValue("aggmfinalfn", value)
  ...
  case class aggsortop(override val value: /* oid */ Long) extends PgAggregateFieldValue("aggsortop", value)
  case class aggtranstype(override val value: /* oid */ Long) extends PgAggregateFieldValue("aggtranstype", value)
  case class aggtransspace(override val value: Int) extends PgAggregateFieldValue("aggtransspace", value)
  case class aggmtranstype(override val value: /* oid */ Long) extends PgAggregateFieldValue("aggmtranstype", value)
