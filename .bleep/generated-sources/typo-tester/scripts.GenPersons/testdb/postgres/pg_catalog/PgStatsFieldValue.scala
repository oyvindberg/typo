...
object PgStatsFieldValue {
  ...
  case class mostCommonVals(override val value: Option[PGobject]) extends PgStatsFieldValue("most_common_vals", value)
  case class mostCommonFreqs(override val value: Option[Array[Float]]) extends PgStatsFieldValue("most_common_freqs", value)
  case class histogramBounds(override val value: Option[PGobject]) extends PgStatsFieldValue("histogram_bounds", value)
  case class correlation(override val value: Option[Float]) extends PgStatsFieldValue("correlation", value)
  case class mostCommonElems(override val value: Option[PGobject]) extends PgStatsFieldValue("most_common_elems", value)
