...
object PgTriggerFieldValue {
  ...
  case class tgattr(override val value: PGobject) extends PgTriggerFieldValue("tgattr", value)
  case class tgargs(override val value: Array[Byte]) extends PgTriggerFieldValue("tgargs", value)
  case class tgqual(override val value: Option[PGobject]) extends PgTriggerFieldValue("tgqual", value)
