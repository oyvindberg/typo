...
object PgProcFieldValue {
  ...
  case class prosupport(override val value: PGobject) extends PgProcFieldValue("prosupport", value)
  ...
  case class proargtypes(override val value: PGobject) extends PgProcFieldValue("proargtypes", value)
  ...
  case class proargdefaults(override val value: Option[PGobject]) extends PgProcFieldValue("proargdefaults", value)
  ...
  case class prosqlbody(override val value: Option[PGobject]) extends PgProcFieldValue("prosqlbody", value)
  case class proconfig(override val value: Option[Array[String]]) extends PgProcFieldValue("proconfig", value)
  case class proacl(override val value: Option[Array[PGobject]]) extends PgProcFieldValue("proacl", value)
}
