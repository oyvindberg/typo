...
object PgProcRepoImpl extends PgProcRepo {
  ...
  override def selectByUniquePronameProargtypesPronamespace(proname: String, proargtypes: /* oidvector */ PGobject, pronamespace: /* oid */ Long)(implicit c: Connection): Option[PgProcRow] = {
