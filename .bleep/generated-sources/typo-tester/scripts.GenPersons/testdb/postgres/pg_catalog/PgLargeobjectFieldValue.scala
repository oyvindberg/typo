...
object PgLargeobjectFieldValue {
  case class loid(override val value: /* oid */ Long) extends PgLargeobjectFieldValue("loid", value)
  case class pageno(override val value: Int) extends PgLargeobjectFieldValue("pageno", value)
  case class data(override val value: Array[Byte]) extends PgLargeobjectFieldValue("data", value)
}
