...
object PgConversionFieldValue {
  ...
  case class connamespace(override val value: /* oid */ Long) extends PgConversionFieldValue("connamespace", value)
  case class conowner(override val value: /* oid */ Long) extends PgConversionFieldValue("conowner", value)
  ...
  case class conproc(override val value: /* regproc */ PGobject) extends PgConversionFieldValue("conproc", value)
