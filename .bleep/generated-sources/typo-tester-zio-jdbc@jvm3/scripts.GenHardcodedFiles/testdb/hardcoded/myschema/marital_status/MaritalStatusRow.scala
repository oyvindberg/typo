...
object MaritalStatusRow {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[MaritalStatusRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[MaritalStatusRow] = {
  ...
  implicit lazy val text: Text[MaritalStatusRow] = {
