...
object PViewFieldValue {
  ...
  case class title(override val value: Option[/* max 8 chars */ String]) extends PViewFieldValue("title", value)
  ...
  case class suffix(override val value: Option[/* max 10 chars */ String]) extends PViewFieldValue("suffix", value)
