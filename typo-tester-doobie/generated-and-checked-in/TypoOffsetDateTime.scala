...
object TypoOffsetDateTime {
  ...
  implicit val decoder: Decoder[TypoOffsetDateTime] = Decoder.forProduct1[TypoOffsetDateTime, OffsetDateTime]("value")(TypoOffsetDateTime.apply)(Decoder.decodeOffsetDateTime)
  implicit val encoder: Encoder[TypoOffsetDateTime] = Encoder.forProduct1[TypoOffsetDateTime, OffsetDateTime]("value")(x => (x.value))(Encoder.encodeOffsetDateTime)
