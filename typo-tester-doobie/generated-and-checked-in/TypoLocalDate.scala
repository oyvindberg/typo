...
object TypoLocalDate {
  ...
  implicit val decoder: Decoder[TypoLocalDate] = Decoder.forProduct1[TypoLocalDate, LocalDate]("value")(TypoLocalDate.apply)
  implicit val encoder: Encoder[TypoLocalDate] = Encoder.forProduct1[TypoLocalDate, LocalDate]("value")(x => (x.value))
