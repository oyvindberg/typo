...
trait StoreRepo {
  ...
  def selectByFieldValues(fieldValues: List[StoreFieldOrIdValue[_]]): Stream[ConnectionIO, StoreRow]
  ...
  def updateFieldValues(businessentityid: BusinessentityId, fieldValues: List[StoreFieldValue[_]]): ConnectionIO[Boolean]
