...
class VstorewithdemographicsViewStructure[Row](val prefix: Option[String], val extract: Row => VstorewithdemographicsViewRow, val merge: (Row, VstorewithdemographicsViewRow) => Row)
  ...
  override val AnnualSales = new OptField[TypoMoney, Row](prefix, "AnnualSales", Some("numeric"), Some("money"))(x => extract(x).AnnualSales, (row, value) => merge(row, extract(row).copy(AnnualSales = value)))
  override val AnnualRevenue = new OptField[TypoMoney, Row](prefix, "AnnualRevenue", Some("numeric"), Some("money"))(x => extract(x).AnnualRevenue, (row, value) => merge(row, extract(row).copy(AnnualRevenue = value)))
  ...
  override val YearOpened = new OptField[Int, Row](prefix, "YearOpened", None, Some("int4"))(x => extract(x).YearOpened, (row, value) => merge(row, extract(row).copy(YearOpened = value)))
  ...
  override val SquareFeet = new OptField[Int, Row](prefix, "SquareFeet", None, Some("int4"))(x => extract(x).SquareFeet, (row, value) => merge(row, extract(row).copy(SquareFeet = value)))
  ...
  override val NumberEmployees = new OptField[Int, Row](prefix, "NumberEmployees", None, Some("int4"))(x => extract(x).NumberEmployees, (row, value) => merge(row, extract(row).copy(NumberEmployees = value)))
