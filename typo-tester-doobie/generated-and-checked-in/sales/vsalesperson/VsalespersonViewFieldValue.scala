...
object VsalespersonViewFieldValue {
  ...
  case class title(override val value: Option[/* max 8 chars */ String]) extends VsalespersonViewFieldValue("title", value)
  ...
  case class suffix(override val value: Option[/* max 10 chars */ String]) extends VsalespersonViewFieldValue("suffix", value)
  case class jobtitle(override val value: Option[/* max 50 chars */ String]) extends VsalespersonViewFieldValue("jobtitle", value)
  ...
  case class emailaddress(override val value: Option[/* max 50 chars */ String]) extends VsalespersonViewFieldValue("emailaddress", value)
  case class emailpromotion(override val value: Option[Int]) extends VsalespersonViewFieldValue("emailpromotion", value)
  case class addressline1(override val value: Option[/* max 60 chars */ String]) extends VsalespersonViewFieldValue("addressline1", value)
  case class addressline2(override val value: Option[/* max 60 chars */ String]) extends VsalespersonViewFieldValue("addressline2", value)
  case class city(override val value: Option[/* max 30 chars */ String]) extends VsalespersonViewFieldValue("city", value)
  case class stateprovincename(override val value: Option[Name]) extends VsalespersonViewFieldValue("stateprovincename", value)
  case class postalcode(override val value: Option[/* max 15 chars */ String]) extends VsalespersonViewFieldValue("postalcode", value)
  ...
  case class territorygroup(override val value: Option[/* max 50 chars */ String]) extends VsalespersonViewFieldValue("territorygroup", value)
