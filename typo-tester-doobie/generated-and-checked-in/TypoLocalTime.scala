...
object TypoLocalTime {
  ...
  implicit val decoder: Decoder[TypoLocalTime] = Decoder.forProduct1[TypoLocalTime, LocalTime]("value")(TypoLocalTime.apply)
  implicit val encoder: Encoder[TypoLocalTime] = Encoder.forProduct1[TypoLocalTime, LocalTime]("value")(x => (x.value))
