...
object PgStatXactSysTablesViewRow {
  implicit val decoder: Decoder[PgStatXactSysTablesViewRow] =
    (c: HCursor) =>
      for {
      ...
      } yield PgStatXactSysTablesViewRow(relid, schemaname, relname, seqScan, seqTupRead, idxScan, idxTupFetch, nTupIns, nTupUpd, nTupDel, nTupHotUpd)
  implicit val encoder: Encoder[PgStatXactSysTablesViewRow] = {
  ...
  implicit val read: Read[PgStatXactSysTablesViewRow] =
    new Read[PgStatXactSysTablesViewRow](
      gets = List(
