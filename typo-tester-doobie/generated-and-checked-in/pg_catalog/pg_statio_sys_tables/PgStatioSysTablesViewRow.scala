...
object PgStatioSysTablesViewRow {
  implicit val decoder: Decoder[PgStatioSysTablesViewRow] =
    (c: HCursor) =>
      for {
      ...
      } yield PgStatioSysTablesViewRow(relid, schemaname, relname, heapBlksRead, heapBlksHit, idxBlksRead, idxBlksHit, toastBlksRead, toastBlksHit, tidxBlksRead, tidxBlksHit)
  implicit val encoder: Encoder[PgStatioSysTablesViewRow] = {
  ...
  implicit val read: Read[PgStatioSysTablesViewRow] =
    new Read[PgStatioSysTablesViewRow](
      gets = List(
