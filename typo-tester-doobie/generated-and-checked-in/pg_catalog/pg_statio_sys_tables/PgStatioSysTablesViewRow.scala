...
object PgStatioSysTablesViewRow {
  implicit val decoder: Decoder[PgStatioSysTablesViewRow] = Decoder.forProduct11[PgStatioSysTablesViewRow, Option[/* oid */ Long], Option[String], Option[String], Option[Long], Option[Long], Option[Long], Option[Long], Option[Long], Option[Long], Option[Long], Option[Long]]("relid", "schemaname", "relname", "heap_blks_read", "heap_blks_hit", "idx_blks_read", "idx_blks_hit", "toast_blks_read", "toast_blks_hit", "tidx_blks_read", "tidx_blks_hit")(PgStatioSysTablesViewRow.apply)
