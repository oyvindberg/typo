...
object PgStatSysIndexesViewRow {
  implicit val decoder: Decoder[PgStatSysIndexesViewRow] =
    (c: HCursor) =>
      for {
      ...
      } yield PgStatSysIndexesViewRow(relid, indexrelid, schemaname, relname, indexrelname, idxScan, idxTupRead, idxTupFetch)
  implicit val encoder: Encoder[PgStatSysIndexesViewRow] = {
  ...
  implicit val read: Read[PgStatSysIndexesViewRow] =
    new Read[PgStatSysIndexesViewRow](
      gets = List(
