...
object PgStatAllIndexesViewRow {
  implicit val decoder: Decoder[PgStatAllIndexesViewRow] =
    (c: HCursor) =>
      for {
      ...
      } yield PgStatAllIndexesViewRow(relid, indexrelid, schemaname, relname, indexrelname, idxScan, idxTupRead, idxTupFetch)
  implicit val encoder: Encoder[PgStatAllIndexesViewRow] = {
  ...
  implicit val read: Read[PgStatAllIndexesViewRow] =
    new Read[PgStatAllIndexesViewRow](
      gets = List(
