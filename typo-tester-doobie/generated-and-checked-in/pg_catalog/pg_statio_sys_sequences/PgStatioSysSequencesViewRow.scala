...
object PgStatioSysSequencesViewRow {
  implicit val decoder: Decoder[PgStatioSysSequencesViewRow] =
    (c: HCursor) =>
      for {
      ...
      } yield PgStatioSysSequencesViewRow(relid, schemaname, relname, blksRead, blksHit)
  implicit val encoder: Encoder[PgStatioSysSequencesViewRow] = {
  ...
  implicit val read: Read[PgStatioSysSequencesViewRow] =
    new Read[PgStatioSysSequencesViewRow](
      gets = List(
