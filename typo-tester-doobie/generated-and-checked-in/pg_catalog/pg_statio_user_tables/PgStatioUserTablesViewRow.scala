...
object PgStatioUserTablesViewRow {
  implicit val decoder: Decoder[PgStatioUserTablesViewRow] =
    (c: HCursor) =>
      for {
      ...
      } yield PgStatioUserTablesViewRow(relid, schemaname, relname, heapBlksRead, heapBlksHit, idxBlksRead, idxBlksHit, toastBlksRead, toastBlksHit, tidxBlksRead, tidxBlksHit)
  implicit val encoder: Encoder[PgStatioUserTablesViewRow] = {
  ...
  implicit val read: Read[PgStatioUserTablesViewRow] =
    new Read[PgStatioUserTablesViewRow](
      gets = List(
