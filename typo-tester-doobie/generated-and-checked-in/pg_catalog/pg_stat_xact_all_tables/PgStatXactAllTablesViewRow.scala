...
object PgStatXactAllTablesViewRow {
  implicit val decoder: Decoder[PgStatXactAllTablesViewRow] =
    (c: HCursor) =>
      for {
      ...
      } yield PgStatXactAllTablesViewRow(relid, schemaname, relname, seqScan, seqTupRead, idxScan, idxTupFetch, nTupIns, nTupUpd, nTupDel, nTupHotUpd)
  implicit val encoder: Encoder[PgStatXactAllTablesViewRow] = {
  ...
  implicit val read: Read[PgStatXactAllTablesViewRow] =
    new Read[PgStatXactAllTablesViewRow](
      gets = List(
