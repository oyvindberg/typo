...
object VadditionalcontactinfoViewFieldValue {
  ...
  case class telephonenumber(override val value: Option[PgSQLXML]) extends VadditionalcontactinfoViewFieldValue("telephonenumber", value)
  ...
  case class street(override val value: Option[PgSQLXML]) extends VadditionalcontactinfoViewFieldValue("street", value)
  case class city(override val value: Option[PgSQLXML]) extends VadditionalcontactinfoViewFieldValue("city", value)
  case class stateprovince(override val value: Option[PgSQLXML]) extends VadditionalcontactinfoViewFieldValue("stateprovince", value)
  case class postalcode(override val value: Option[PgSQLXML]) extends VadditionalcontactinfoViewFieldValue("postalcode", value)
  case class countryregion(override val value: Option[PgSQLXML]) extends VadditionalcontactinfoViewFieldValue("countryregion", value)
  case class homeaddressspecialinstructions(override val value: Option[PgSQLXML]) extends VadditionalcontactinfoViewFieldValue("homeaddressspecialinstructions", value)
  case class emailaddress(override val value: Option[PgSQLXML]) extends VadditionalcontactinfoViewFieldValue("emailaddress", value)
  ...
  case class emailtelephonenumber(override val value: Option[PgSQLXML]) extends VadditionalcontactinfoViewFieldValue("emailtelephonenumber", value)
