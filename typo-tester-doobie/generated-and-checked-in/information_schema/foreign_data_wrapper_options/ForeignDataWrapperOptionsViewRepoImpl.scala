...
object ForeignDataWrapperOptionsViewRepoImpl extends ForeignDataWrapperOptionsViewRepo {
  override def selectAll: Stream[ConnectionIO, ForeignDataWrapperOptionsViewRow] = {
    sql"select foreign_data_wrapper_catalog, foreign_data_wrapper_name, option_name, option_value from information_schema.foreign_data_wrapper_options".query[ForeignDataWrapperOptionsViewRow].stream
  }
}
