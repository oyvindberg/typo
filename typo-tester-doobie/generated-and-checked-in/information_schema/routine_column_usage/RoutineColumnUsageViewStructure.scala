...
class RoutineColumnUsageViewStructure[Row](val prefix: Option[String], val extract: Row => RoutineColumnUsageViewRow, val merge: (Row, RoutineColumnUsageViewRow) => Row)
  ...
  override def copy[NewRow](prefix: Option[String], extract: NewRow => RoutineColumnUsageViewRow, merge: (NewRow, RoutineColumnUsageViewRow) => NewRow): RoutineColumnUsageViewStructure[NewRow] =
    new RoutineColumnUsageViewStructure(prefix, extract, merge)
}
