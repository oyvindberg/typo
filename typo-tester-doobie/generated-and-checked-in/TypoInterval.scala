...
object TypoInterval {
  implicit val arrayGet: Get[Array[TypoInterval]] = Get.Advanced.array[AnyRef](NonEmptyList.one("_interval"))
  ...
  implicit val arrayPut: Put[Array[TypoInterval]] = Put.Advanced.array[AnyRef](NonEmptyList.one("_interval"), "interval")
    .contramap(_.map(v => new PGInterval(v.years, v.months, v.days, v.hours, v.minutes, v.seconds)))
  implicit val decoder: Decoder[TypoInterval] = Decoder.forProduct6[TypoInterval, Int, Int, Int, Int, Int, Double]("years", "months", "days", "hours", "minutes", "seconds")(TypoInterval.apply)
  implicit val encoder: Encoder[TypoInterval] = Encoder.forProduct6[TypoInterval, Int, Int, Int, Int, Int, Double]("years", "months", "days", "hours", "minutes", "seconds")(x => (x.years, x.months, x.days, x.hours, x.minutes, x.seconds))
