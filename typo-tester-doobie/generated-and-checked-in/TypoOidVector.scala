...
object TypoOidVector {
  ...
  implicit val decoder: Decoder[TypoOidVector] = Decoder.forProduct1[TypoOidVector, String]("value")(TypoOidVector.apply)
  implicit val encoder: Encoder[TypoOidVector] = Encoder.forProduct1[TypoOidVector, String]("value")(x => (x.value))
