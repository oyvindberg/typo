...
object TypoOffsetTime {
  ...
  implicit val decoder: Decoder[TypoOffsetTime] = Decoder.forProduct1[TypoOffsetTime, OffsetTime]("value")(TypoOffsetTime.apply)
  implicit val encoder: Encoder[TypoOffsetTime] = Encoder.forProduct1[TypoOffsetTime, OffsetTime]("value")(x => (x.value))
