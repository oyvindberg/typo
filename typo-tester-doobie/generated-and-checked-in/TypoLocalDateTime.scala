...
object TypoLocalDateTime {
  ...
  implicit val decoder: Decoder[TypoLocalDateTime] = Decoder.forProduct1[TypoLocalDateTime, LocalDateTime]("value")(TypoLocalDateTime.apply)
  implicit val encoder: Encoder[TypoLocalDateTime] = Encoder.forProduct1[TypoLocalDateTime, LocalDateTime]("value")(x => (x.value))
