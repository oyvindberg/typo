...
class SalesorderheaderRepoImpl extends SalesorderheaderRepo {
  ...
  override def deleteById(salesorderid: SalesorderheaderId): ConnectionIO[Boolean] = {
    sql"""delete from "sales"."salesorderheader" where "salesorderid" = ${fromWrite(salesorderid)(new Write.Single(SalesorderheaderId.put))}""".update.run.map(_ > 0)
  }
  ...
  override def insert(unsaved: SalesorderheaderRowUnsaved): ConnectionIO[SalesorderheaderRow] = {
    val fs = List(
      ...
      Some((Fragment.const0(s""""purchaseordernumber""""), fr"${fromWrite(unsaved.purchaseordernumber)(new Write.SingleOpt(OrderNumber.put))}::varchar")),
      Some((Fragment.const0(s""""accountnumber""""), fr"${fromWrite(unsaved.accountnumber)(new Write.SingleOpt(AccountNumber.put))}::varchar")),
      Some((Fragment.const0(s""""customerid""""), fr"${fromWrite(unsaved.customerid)(new Write.Single(CustomerId.put))}::int4")),
      ...
      Some((Fragment.const0(s""""billtoaddressid""""), fr"${fromWrite(unsaved.billtoaddressid)(new Write.Single(AddressId.put))}::int4")),
      Some((Fragment.const0(s""""shiptoaddressid""""), fr"${fromWrite(unsaved.shiptoaddressid)(new Write.Single(AddressId.put))}::int4")),
      Some((Fragment.const0(s""""shipmethodid""""), fr"${fromWrite(unsaved.shipmethodid)(new Write.Single(ShipmethodId.put))}::int4")),
      Some((Fragment.const0(s""""creditcardid""""), fr"${fromWrite(unsaved.creditcardid)(new Write.SingleOpt(/* user-picked */ CustomCreditcardId.put))}::int4")),
      Some((Fragment.const0(s""""creditcardapprovalcode""""), fr"${fromWrite(unsaved.creditcardapprovalcode)(new Write.SingleOpt(Meta.StringMeta.put))}")),
      Some((Fragment.const0(s""""currencyrateid""""), fr"${fromWrite(unsaved.currencyrateid)(new Write.SingleOpt(CurrencyrateId.put))}::int4")),
      Some((Fragment.const0(s""""totaldue""""), fr"${fromWrite(unsaved.totaldue)(new Write.SingleOpt(Meta.ScalaBigDecimalMeta.put))}::numeric")),
      Some((Fragment.const0(s""""comment""""), fr"${fromWrite(unsaved.comment)(new Write.SingleOpt(Meta.StringMeta.put))}")),
      unsaved.salesorderid match {
        case Defaulted.UseDefault => None
        case Defaulted.Provided(value) => Some((Fragment.const0(s""""salesorderid""""), fr"${fromWrite(value: SalesorderheaderId)(new Write.Single(SalesorderheaderId.put))}::int4"))
      },
      unsaved.revisionnumber match {
        case Defaulted.UseDefault => None
        case Defaulted.Provided(value) => Some((Fragment.const0(s""""revisionnumber""""), fr"${fromWrite(value: TypoShort)(new Write.Single(TypoShort.put))}::int2"))
      },
      unsaved.orderdate match {
        case Defaulted.UseDefault => None
        case Defaulted.Provided(value) => Some((Fragment.const0(s""""orderdate""""), fr"${fromWrite(value: TypoLocalDateTime)(new Write.Single(TypoLocalDateTime.put))}::timestamp"))
      },
      unsaved.status match {
        case Defaulted.UseDefault => None
        case Defaulted.Provided(value) => Some((Fragment.const0(s""""status""""), fr"${fromWrite(value: TypoShort)(new Write.Single(TypoShort.put))}::int2"))
      },
      unsaved.onlineorderflag match {
        case Defaulted.UseDefault => None
        case Defaulted.Provided(value) => Some((Fragment.const0(s""""onlineorderflag""""), fr"${fromWrite(value: Flag)(new Write.Single(Flag.put))}::bool"))
      },
      unsaved.subtotal match {
        case Defaulted.UseDefault => None
        case Defaulted.Provided(value) => Some((Fragment.const0(s""""subtotal""""), fr"${fromWrite(value: BigDecimal)(new Write.Single(Meta.ScalaBigDecimalMeta.put))}::numeric"))
      },
      unsaved.taxamt match {
        case Defaulted.UseDefault => None
        case Defaulted.Provided(value) => Some((Fragment.const0(s""""taxamt""""), fr"${fromWrite(value: BigDecimal)(new Write.Single(Meta.ScalaBigDecimalMeta.put))}::numeric"))
      },
      unsaved.freight match {
        case Defaulted.UseDefault => None
        case Defaulted.Provided(value) => Some((Fragment.const0(s""""freight""""), fr"${fromWrite(value: BigDecimal)(new Write.Single(Meta.ScalaBigDecimalMeta.put))}::numeric"))
      },
  ...
  override def selectById(salesorderid: SalesorderheaderId): ConnectionIO[Option[SalesorderheaderRow]] = {
    sql"""select "salesorderid", "revisionnumber", "orderdate"::text, "duedate"::text, "shipdate"::text, "status", "onlineorderflag", "purchaseordernumber", "accountnumber", "customerid", "salespersonid", "territoryid", "billtoaddressid", "shiptoaddressid", "shipmethodid", "creditcardid", "creditcardapprovalcode", "currencyrateid", "subtotal", "taxamt", "freight", "totaldue", "comment", "rowguid", "modifieddate"::text from "sales"."salesorderheader" where "salesorderid" = ${fromWrite(salesorderid)(new Write.Single(SalesorderheaderId.put))}""".query(using SalesorderheaderRow.read).option
  }
  ...
  override def update(row: SalesorderheaderRow): ConnectionIO[Boolean] = {
    ...
    sql"""update "sales"."salesorderheader"
          set "revisionnumber" = ${fromWrite(row.revisionnumber)(new Write.Single(TypoShort.put))}::int2,
              "orderdate" = ${fromWrite(row.orderdate)(new Write.Single(TypoLocalDateTime.put))}::timestamp,
              "duedate" = ${fromWrite(row.duedate)(new Write.Single(TypoLocalDateTime.put))}::timestamp,
              "shipdate" = ${fromWrite(row.shipdate)(new Write.SingleOpt(TypoLocalDateTime.put))}::timestamp,
              "status" = ${fromWrite(row.status)(new Write.Single(TypoShort.put))}::int2,
              "onlineorderflag" = ${fromWrite(row.onlineorderflag)(new Write.Single(Flag.put))}::bool,
              "purchaseordernumber" = ${fromWrite(row.purchaseordernumber)(new Write.SingleOpt(OrderNumber.put))}::varchar,
              "accountnumber" = ${fromWrite(row.accountnumber)(new Write.SingleOpt(AccountNumber.put))}::varchar,
              "customerid" = ${fromWrite(row.customerid)(new Write.Single(CustomerId.put))}::int4,
              ...
              "billtoaddressid" = ${fromWrite(row.billtoaddressid)(new Write.Single(AddressId.put))}::int4,
              "shiptoaddressid" = ${fromWrite(row.shiptoaddressid)(new Write.Single(AddressId.put))}::int4,
              "shipmethodid" = ${fromWrite(row.shipmethodid)(new Write.Single(ShipmethodId.put))}::int4,
              "creditcardid" = ${fromWrite(row.creditcardid)(new Write.SingleOpt(/* user-picked */ CustomCreditcardId.put))}::int4,
              "creditcardapprovalcode" = ${fromWrite(row.creditcardapprovalcode)(new Write.SingleOpt(Meta.StringMeta.put))},
              "currencyrateid" = ${fromWrite(row.currencyrateid)(new Write.SingleOpt(CurrencyrateId.put))}::int4,
              "subtotal" = ${fromWrite(row.subtotal)(new Write.Single(Meta.ScalaBigDecimalMeta.put))}::numeric,
              ...
              "totaldue" = ${fromWrite(row.totaldue)(new Write.SingleOpt(Meta.ScalaBigDecimalMeta.put))}::numeric,
  ...
  override def upsert(unsaved: SalesorderheaderRow): ConnectionIO[SalesorderheaderRow] = {
    sql"""insert into "sales"."salesorderheader"("salesorderid", "revisionnumber", "orderdate", "duedate", "shipdate", "status", "onlineorderflag", "purchaseordernumber", "accountnumber", "customerid", "salespersonid", "territoryid", "billtoaddressid", "shiptoaddressid", "shipmethodid", "creditcardid", "creditcardapprovalcode", "currencyrateid", "subtotal", "taxamt", "freight", "totaldue", "comment", "rowguid", "modifieddate")
          values (
            ...
            ${fromWrite(unsaved.revisionnumber)(new Write.Single(TypoShort.put))}::int2,
            ${fromWrite(unsaved.orderdate)(new Write.Single(TypoLocalDateTime.put))}::timestamp,
            ${fromWrite(unsaved.duedate)(new Write.Single(TypoLocalDateTime.put))}::timestamp,
            ${fromWrite(unsaved.shipdate)(new Write.SingleOpt(TypoLocalDateTime.put))}::timestamp,
            ${fromWrite(unsaved.status)(new Write.Single(TypoShort.put))}::int2,
            ${fromWrite(unsaved.onlineorderflag)(new Write.Single(Flag.put))}::bool,
            ${fromWrite(unsaved.purchaseordernumber)(new Write.SingleOpt(OrderNumber.put))}::varchar,
            ${fromWrite(unsaved.accountnumber)(new Write.SingleOpt(AccountNumber.put))}::varchar,
            ...
            ${fromWrite(unsaved.billtoaddressid)(new Write.Single(AddressId.put))}::int4,
            ${fromWrite(unsaved.shiptoaddressid)(new Write.Single(AddressId.put))}::int4,
            ${fromWrite(unsaved.shipmethodid)(new Write.Single(ShipmethodId.put))}::int4,
            ${fromWrite(unsaved.creditcardid)(new Write.SingleOpt(/* user-picked */ CustomCreditcardId.put))}::int4,
            ${fromWrite(unsaved.creditcardapprovalcode)(new Write.SingleOpt(Meta.StringMeta.put))},
            ${fromWrite(unsaved.currencyrateid)(new Write.SingleOpt(CurrencyrateId.put))}::int4,
            ${fromWrite(unsaved.subtotal)(new Write.Single(Meta.ScalaBigDecimalMeta.put))}::numeric,
            ${fromWrite(unsaved.taxamt)(new Write.Single(Meta.ScalaBigDecimalMeta.put))}::numeric,
            ${fromWrite(unsaved.freight)(new Write.Single(Meta.ScalaBigDecimalMeta.put))}::numeric,
            ${fromWrite(unsaved.totaldue)(new Write.SingleOpt(Meta.ScalaBigDecimalMeta.put))}::numeric,
            ${fromWrite(unsaved.comment)(new Write.SingleOpt(Meta.StringMeta.put))},
