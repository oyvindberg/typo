...
object SalesorderheaderRowUnsaved {
  implicit lazy val decoder: Decoder[SalesorderheaderRowUnsaved] = {
  ...
  implicit lazy val encoder: Encoder[SalesorderheaderRowUnsaved] = {
    Encoder[SalesorderheaderRowUnsaved](row =>
      Json.obj(
  ...
  implicit lazy val text: Text[SalesorderheaderRowUnsaved] = {
