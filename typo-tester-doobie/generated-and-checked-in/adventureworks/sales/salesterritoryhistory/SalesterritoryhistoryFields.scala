...
trait SalesterritoryhistoryFields {
  ...
  def compositeIdIn(compositeIds: Array[SalesterritoryhistoryId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[SalesterritoryhistoryId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId], Required](BusinessentityId.arrayPut, Write.fromPut(BusinessentityId.arrayPut)), implicitly), TuplePart[SalesterritoryhistoryId](startdate)(_.startdate)(using as[Array[TypoLocalDateTime], Required](TypoLocalDateTime.arrayPut, Write.fromPut(TypoLocalDateTime.arrayPut)), implicitly), TuplePart[SalesterritoryhistoryId](territoryid)(_.territoryid)(using as[Array[SalesterritoryId], Required](SalesterritoryId.arrayPut, Write.fromPut(SalesterritoryId.arrayPut)), implicitly))
