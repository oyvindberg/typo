...
trait SalesorderdetailFields {
  ...
  def compositeIdIn(compositeIds: Array[SalesorderdetailId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[SalesorderdetailId](salesorderid)(_.salesorderid)(using as[Array[SalesorderheaderId]](SalesorderheaderId.arrayPut), implicitly), TuplePart[SalesorderdetailId](salesorderdetailid)(_.salesorderdetailid)(using as[Array[Int]](adventureworks.IntegerArrayMeta.put), implicitly))
  ...
  def extractSpecialofferproductIdIn(ids: Array[SpecialofferproductId]): SqlExpr[Boolean] =
    new CompositeIn(ids)(TuplePart[SpecialofferproductId](specialofferid)(_.specialofferid)(using as[Array[SpecialofferId]](SpecialofferId.arrayPut), implicitly), TuplePart[SpecialofferproductId](productid)(_.productid)(using as[Array[ProductId]](ProductId.arrayPut), implicitly))
