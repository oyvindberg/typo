...
class VindividualcustomerViewRepoImpl extends VindividualcustomerViewRepo {
  def select: SelectBuilder[VindividualcustomerViewFields, VindividualcustomerViewRow] = SelectBuilderSql("sales.vindividualcustomer", VindividualcustomerViewFields.structure, VindividualcustomerViewRow.read)
