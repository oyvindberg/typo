...
object PgUserViewRow {
  implicit lazy val decoder: Decoder[PgUserViewRow] = Decoder.forProduct9[PgUserViewRow, Option[String], Option[PgAuthidId], Option[Boolean], Option[Boolean], Option[Boolean], Option[Boolean], /* nullability unknown */ Option[String], Option[TypoOffsetDateTime], Option[Array[String]]]("usename", "usesysid", "usecreatedb", "usesuper", "userepl", "usebypassrls", "passwd", "valuntil", "useconfig")(PgUserViewRow.apply)(Decoder.decodeOption(Decoder.decodeString), Decoder.decodeOption(PgAuthidId.decoder), Decoder.decodeOption(Decoder.decodeBoolean), Decoder.decodeOption(Decoder.decodeBoolean), Decoder.decodeOption(Decoder.decodeBoolean), Decoder.decodeOption(Decoder.decodeBoolean), Decoder.decodeOption(Decoder.decodeString), Decoder.decodeOption(TypoOffsetDateTime.decoder), Decoder.decodeOption(Decoder.decodeArray[String](Decoder.decodeString, implicitly)))
  implicit lazy val encoder: Encoder[PgUserViewRow] = Encoder.forProduct9[PgUserViewRow, Option[String], Option[PgAuthidId], Option[Boolean], Option[Boolean], Option[Boolean], Option[Boolean], /* nullability unknown */ Option[String], Option[TypoOffsetDateTime], Option[Array[String]]]("usename", "usesysid", "usecreatedb", "usesuper", "userepl", "usebypassrls", "passwd", "valuntil", "useconfig")(x => (x.usename, x.usesysid, x.usecreatedb, x.usesuper, x.userepl, x.usebypassrls, x.passwd, x.valuntil, x.useconfig))(Encoder.encodeOption(Encoder.encodeString), Encoder.encodeOption(PgAuthidId.encoder), Encoder.encodeOption(Encoder.encodeBoolean), Encoder.encodeOption(Encoder.encodeBoolean), Encoder.encodeOption(Encoder.encodeBoolean), Encoder.encodeOption(Encoder.encodeBoolean), Encoder.encodeOption(Encoder.encodeString), Encoder.encodeOption(TypoOffsetDateTime.encoder), Encoder.encodeOption(Encoder.encodeIterable[String, Array](Encoder.encodeString, implicitly)))
