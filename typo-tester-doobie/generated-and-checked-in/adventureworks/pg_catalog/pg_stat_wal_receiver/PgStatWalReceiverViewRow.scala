...
object PgStatWalReceiverViewRow {
  implicit lazy val decoder: Decoder[PgStatWalReceiverViewRow] = Decoder.forProduct15[PgStatWalReceiverViewRow, /* nullability unknown */ Option[Int], /* nullability unknown */ Option[String], /* nullability unknown */ Option[/* pg_lsn */ Long], /* nullability unknown */ Option[Int], /* nullability unknown */ Option[/* pg_lsn */ Long], /* nullability unknown */ Option[/* pg_lsn */ Long], /* nullability unknown */ Option[Int], /* nullability unknown */ Option[TypoOffsetDateTime], /* nullability unknown */ Option[TypoOffsetDateTime], /* nullability unknown */ Option[/* pg_lsn */ Long], /* nullability unknown */ Option[TypoOffsetDateTime], /* nullability unknown */ Option[String], /* nullability unknown */ Option[String], /* nullability unknown */ Option[Int], /* nullability unknown */ Option[String]]("pid", "status", "receive_start_lsn", "receive_start_tli", "written_lsn", "flushed_lsn", "received_tli", "last_msg_send_time", "last_msg_receipt_time", "latest_end_lsn", "latest_end_time", "slot_name", "sender_host", "sender_port", "conninfo")(PgStatWalReceiverViewRow.apply)(Decoder.decodeOption(Decoder.decodeInt), Decoder.decodeOption(Decoder.decodeString), Decoder.decodeOption(Decoder.decodeLong), Decoder.decodeOption(Decoder.decodeInt), Decoder.decodeOption(Decoder.decodeLong), Decoder.decodeOption(Decoder.decodeLong), Decoder.decodeOption(Decoder.decodeInt), Decoder.decodeOption(TypoOffsetDateTime.decoder), Decoder.decodeOption(TypoOffsetDateTime.decoder), Decoder.decodeOption(Decoder.decodeLong), Decoder.decodeOption(TypoOffsetDateTime.decoder), Decoder.decodeOption(Decoder.decodeString), Decoder.decodeOption(Decoder.decodeString), Decoder.decodeOption(Decoder.decodeInt), Decoder.decodeOption(Decoder.decodeString))
  implicit lazy val encoder: Encoder[PgStatWalReceiverViewRow] = Encoder.forProduct15[PgStatWalReceiverViewRow, /* nullability unknown */ Option[Int], /* nullability unknown */ Option[String], /* nullability unknown */ Option[/* pg_lsn */ Long], /* nullability unknown */ Option[Int], /* nullability unknown */ Option[/* pg_lsn */ Long], /* nullability unknown */ Option[/* pg_lsn */ Long], /* nullability unknown */ Option[Int], /* nullability unknown */ Option[TypoOffsetDateTime], /* nullability unknown */ Option[TypoOffsetDateTime], /* nullability unknown */ Option[/* pg_lsn */ Long], /* nullability unknown */ Option[TypoOffsetDateTime], /* nullability unknown */ Option[String], /* nullability unknown */ Option[String], /* nullability unknown */ Option[Int], /* nullability unknown */ Option[String]]("pid", "status", "receive_start_lsn", "receive_start_tli", "written_lsn", "flushed_lsn", "received_tli", "last_msg_send_time", "last_msg_receipt_time", "latest_end_lsn", "latest_end_time", "slot_name", "sender_host", "sender_port", "conninfo")(x => (x.pid, x.status, x.receiveStartLsn, x.receiveStartTli, x.writtenLsn, x.flushedLsn, x.receivedTli, x.lastMsgSendTime, x.lastMsgReceiptTime, x.latestEndLsn, x.latestEndTime, x.slotName, x.senderHost, x.senderPort, x.conninfo))(Encoder.encodeOption(Encoder.encodeInt), Encoder.encodeOption(Encoder.encodeString), Encoder.encodeOption(Encoder.encodeLong), Encoder.encodeOption(Encoder.encodeInt), Encoder.encodeOption(Encoder.encodeLong), Encoder.encodeOption(Encoder.encodeLong), Encoder.encodeOption(Encoder.encodeInt), Encoder.encodeOption(TypoOffsetDateTime.encoder), Encoder.encodeOption(TypoOffsetDateTime.encoder), Encoder.encodeOption(Encoder.encodeLong), Encoder.encodeOption(TypoOffsetDateTime.encoder), Encoder.encodeOption(Encoder.encodeString), Encoder.encodeOption(Encoder.encodeString), Encoder.encodeOption(Encoder.encodeInt), Encoder.encodeOption(Encoder.encodeString))
