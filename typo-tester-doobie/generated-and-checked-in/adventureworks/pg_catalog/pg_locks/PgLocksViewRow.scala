...
object PgLocksViewRow {
  implicit lazy val decoder: Decoder[PgLocksViewRow] = Decoder.forProduct16[PgLocksViewRow, /* nullability unknown */ Option[String], /* nullability unknown */ Option[/* oid */ Long], /* nullability unknown */ Option[/* oid */ Long], /* nullability unknown */ Option[Int], /* nullability unknown */ Option[TypoShort], /* nullability unknown */ Option[String], /* nullability unknown */ Option[TypoXid], /* nullability unknown */ Option[/* oid */ Long], /* nullability unknown */ Option[/* oid */ Long], /* nullability unknown */ Option[TypoShort], /* nullability unknown */ Option[String], /* nullability unknown */ Option[Int], /* nullability unknown */ Option[String], /* nullability unknown */ Option[Boolean], /* nullability unknown */ Option[Boolean], /* nullability unknown */ Option[TypoInstant]]("locktype", "database", "relation", "page", "tuple", "virtualxid", "transactionid", "classid", "objid", "objsubid", "virtualtransaction", "pid", "mode", "granted", "fastpath", "waitstart")(PgLocksViewRow.apply)(Decoder.decodeOption(Decoder.decodeString), Decoder.decodeOption(Decoder.decodeLong), Decoder.decodeOption(Decoder.decodeLong), Decoder.decodeOption(Decoder.decodeInt), Decoder.decodeOption(TypoShort.decoder), Decoder.decodeOption(Decoder.decodeString), Decoder.decodeOption(TypoXid.decoder), Decoder.decodeOption(Decoder.decodeLong), Decoder.decodeOption(Decoder.decodeLong), Decoder.decodeOption(TypoShort.decoder), Decoder.decodeOption(Decoder.decodeString), Decoder.decodeOption(Decoder.decodeInt), Decoder.decodeOption(Decoder.decodeString), Decoder.decodeOption(Decoder.decodeBoolean), Decoder.decodeOption(Decoder.decodeBoolean), Decoder.decodeOption(TypoInstant.decoder))
  implicit lazy val encoder: Encoder[PgLocksViewRow] = Encoder.forProduct16[PgLocksViewRow, /* nullability unknown */ Option[String], /* nullability unknown */ Option[/* oid */ Long], /* nullability unknown */ Option[/* oid */ Long], /* nullability unknown */ Option[Int], /* nullability unknown */ Option[TypoShort], /* nullability unknown */ Option[String], /* nullability unknown */ Option[TypoXid], /* nullability unknown */ Option[/* oid */ Long], /* nullability unknown */ Option[/* oid */ Long], /* nullability unknown */ Option[TypoShort], /* nullability unknown */ Option[String], /* nullability unknown */ Option[Int], /* nullability unknown */ Option[String], /* nullability unknown */ Option[Boolean], /* nullability unknown */ Option[Boolean], /* nullability unknown */ Option[TypoInstant]]("locktype", "database", "relation", "page", "tuple", "virtualxid", "transactionid", "classid", "objid", "objsubid", "virtualtransaction", "pid", "mode", "granted", "fastpath", "waitstart")(x => (x.locktype, x.database, x.relation, x.page, x.tuple, x.virtualxid, x.transactionid, x.classid, x.objid, x.objsubid, x.virtualtransaction, x.pid, x.mode, x.granted, x.fastpath, x.waitstart))(Encoder.encodeOption(Encoder.encodeString), Encoder.encodeOption(Encoder.encodeLong), Encoder.encodeOption(Encoder.encodeLong), Encoder.encodeOption(Encoder.encodeInt), Encoder.encodeOption(TypoShort.encoder), Encoder.encodeOption(Encoder.encodeString), Encoder.encodeOption(TypoXid.encoder), Encoder.encodeOption(Encoder.encodeLong), Encoder.encodeOption(Encoder.encodeLong), Encoder.encodeOption(TypoShort.encoder), Encoder.encodeOption(Encoder.encodeString), Encoder.encodeOption(Encoder.encodeInt), Encoder.encodeOption(Encoder.encodeString), Encoder.encodeOption(Encoder.encodeBoolean), Encoder.encodeOption(Encoder.encodeBoolean), Encoder.encodeOption(TypoInstant.encoder))
  implicit lazy val read: Read[PgLocksViewRow] = new Read[PgLocksViewRow](
    ...
    unsafeGet = (rs: ResultSet, i: Int) => PgLocksViewRow(
      ...
      waitstart = TypoInstant.get.unsafeGetNullable(rs, i + 15)
    )
  )
}
