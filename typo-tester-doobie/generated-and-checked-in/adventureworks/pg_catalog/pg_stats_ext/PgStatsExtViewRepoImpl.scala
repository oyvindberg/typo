...
object PgStatsExtViewRepoImpl extends PgStatsExtViewRepo {
  ...
  override def selectAll: Stream[ConnectionIO, PgStatsExtViewRow] = {
    sql"""select "schemaname", "tablename", "statistics_schemaname", "statistics_name", "statistics_owner", "attnames", "exprs", "kinds", "n_distinct"::text, "dependencies"::text, "most_common_vals", "most_common_val_nulls", "most_common_freqs", "most_common_base_freqs" from pg_catalog.pg_stats_ext""".query(PgStatsExtViewRow.read).stream
  }
}
