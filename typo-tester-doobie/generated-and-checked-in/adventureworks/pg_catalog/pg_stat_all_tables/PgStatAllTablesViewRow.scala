...
object PgStatAllTablesViewRow {
  implicit lazy val decoder: Decoder[PgStatAllTablesViewRow] = Decoder.instanceTry[PgStatAllTablesViewRow]((c: HCursor) =>
    Try {
      ...
      PgStatAllTablesViewRow(
        relid = orThrow(c.get("relid")(PgClassId.decoder)),
  ...
  implicit lazy val encoder: Encoder[PgStatAllTablesViewRow] = Encoder[PgStatAllTablesViewRow](row =>
    Json.obj(
      "relid" -> PgClassId.encoder.apply(row.relid),
  ...
  implicit lazy val read: Read[PgStatAllTablesViewRow] = new Read[PgStatAllTablesViewRow](
    ...
    unsafeGet = (rs: ResultSet, i: Int) => PgStatAllTablesViewRow(
      ...
      lastVacuum = TypoInstant.get.unsafeGetNullable(rs, i + 15),
      lastAutovacuum = TypoInstant.get.unsafeGetNullable(rs, i + 16),
      lastAnalyze = TypoInstant.get.unsafeGetNullable(rs, i + 17),
      lastAutoanalyze = TypoInstant.get.unsafeGetNullable(rs, i + 18),
