...
object PgStatisticRow {
  implicit lazy val decoder: Decoder[PgStatisticRow] = Decoder.instanceTry[PgStatisticRow]((c: HCursor) =>
    Try {
      ...
      PgStatisticRow(
        ...
        staattnum = orThrow(c.get("staattnum")(TypoShort.decoder)),
        ...
        stakind1 = orThrow(c.get("stakind1")(TypoShort.decoder)),
        stakind2 = orThrow(c.get("stakind2")(TypoShort.decoder)),
        stakind3 = orThrow(c.get("stakind3")(TypoShort.decoder)),
        stakind4 = orThrow(c.get("stakind4")(TypoShort.decoder)),
        stakind5 = orThrow(c.get("stakind5")(TypoShort.decoder)),
  ...
  implicit lazy val encoder: Encoder[PgStatisticRow] = Encoder[PgStatisticRow](row =>
    Json.obj(
      ...
      "staattnum" -> TypoShort.encoder.apply(row.staattnum),
      ...
      "stakind1" -> TypoShort.encoder.apply(row.stakind1),
      "stakind2" -> TypoShort.encoder.apply(row.stakind2),
      "stakind3" -> TypoShort.encoder.apply(row.stakind3),
      "stakind4" -> TypoShort.encoder.apply(row.stakind4),
      "stakind5" -> TypoShort.encoder.apply(row.stakind5),
  ...
  implicit lazy val read: Read[PgStatisticRow] = new Read[PgStatisticRow](
    ...
    unsafeGet = (rs: ResultSet, i: Int) => PgStatisticRow(
      ...
      staattnum = TypoShort.get.unsafeGetNonNullable(rs, i + 1),
      ...
      stakind1 = TypoShort.get.unsafeGetNonNullable(rs, i + 6),
      stakind2 = TypoShort.get.unsafeGetNonNullable(rs, i + 7),
      stakind3 = TypoShort.get.unsafeGetNonNullable(rs, i + 8),
      stakind4 = TypoShort.get.unsafeGetNonNullable(rs, i + 9),
      stakind5 = TypoShort.get.unsafeGetNonNullable(rs, i + 10),
