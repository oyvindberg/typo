...
class AttributesViewStructure[Row](val prefix: Option[String], val extract: Row => AttributesViewRow, val merge: (Row, AttributesViewRow) => Row)
  ...
  override val attributeName = new Field[SqlIdentifier, Row](prefix, "attribute_name", None, Some("information_schema.sql_identifier"))(x => extract(x).attributeName, (row, value) => merge(row, extract(row).copy(attributeName = value)))
  ...
  override val attributeDefault = new Field[CharacterData, Row](prefix, "attribute_default", None, Some("information_schema.character_data"))(x => extract(x).attributeDefault, (row, value) => merge(row, extract(row).copy(attributeDefault = value)))
  ...
  override val attributeUdtCatalog = new Field[SqlIdentifier, Row](prefix, "attribute_udt_catalog", None, Some("information_schema.sql_identifier"))(x => extract(x).attributeUdtCatalog, (row, value) => merge(row, extract(row).copy(attributeUdtCatalog = value)))
  override val attributeUdtSchema = new Field[SqlIdentifier, Row](prefix, "attribute_udt_schema", None, Some("information_schema.sql_identifier"))(x => extract(x).attributeUdtSchema, (row, value) => merge(row, extract(row).copy(attributeUdtSchema = value)))
  override val attributeUdtName = new Field[SqlIdentifier, Row](prefix, "attribute_udt_name", None, Some("information_schema.sql_identifier"))(x => extract(x).attributeUdtName, (row, value) => merge(row, extract(row).copy(attributeUdtName = value)))
  ...
  override val isDerivedReferenceAttribute = new Field[YesOrNo, Row](prefix, "is_derived_reference_attribute", None, Some("information_schema.yes_or_no"))(x => extract(x).isDerivedReferenceAttribute, (row, value) => merge(row, extract(row).copy(isDerivedReferenceAttribute = value)))
