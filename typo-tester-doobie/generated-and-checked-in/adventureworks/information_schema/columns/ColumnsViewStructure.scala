...
class ColumnsViewStructure[Row](val prefix: Option[String], val extract: Row => ColumnsViewRow, val merge: (Row, ColumnsViewRow) => Row)
  ...
  override val ordinalPosition = new Field[CardinalNumber, Row](prefix, "ordinal_position", None, Some("information_schema.cardinal_number"))(x => extract(x).ordinalPosition, (row, value) => merge(row, extract(row).copy(ordinalPosition = value)))
  override val columnDefault = new Field[CharacterData, Row](prefix, "column_default", None, Some("information_schema.character_data"))(x => extract(x).columnDefault, (row, value) => merge(row, extract(row).copy(columnDefault = value)))
  override val isNullable = new Field[YesOrNo, Row](prefix, "is_nullable", None, Some("information_schema.yes_or_no"))(x => extract(x).isNullable, (row, value) => merge(row, extract(row).copy(isNullable = value)))
  ...
  override val characterMaximumLength = new Field[CardinalNumber, Row](prefix, "character_maximum_length", None, Some("information_schema.cardinal_number"))(x => extract(x).characterMaximumLength, (row, value) => merge(row, extract(row).copy(characterMaximumLength = value)))
  override val characterOctetLength = new Field[CardinalNumber, Row](prefix, "character_octet_length", None, Some("information_schema.cardinal_number"))(x => extract(x).characterOctetLength, (row, value) => merge(row, extract(row).copy(characterOctetLength = value)))
  ...
  override val datetimePrecision = new Field[CardinalNumber, Row](prefix, "datetime_precision", None, Some("information_schema.cardinal_number"))(x => extract(x).datetimePrecision, (row, value) => merge(row, extract(row).copy(datetimePrecision = value)))
  override val intervalType = new Field[CharacterData, Row](prefix, "interval_type", None, Some("information_schema.character_data"))(x => extract(x).intervalType, (row, value) => merge(row, extract(row).copy(intervalType = value)))
  override val intervalPrecision = new Field[CardinalNumber, Row](prefix, "interval_precision", None, Some("information_schema.cardinal_number"))(x => extract(x).intervalPrecision, (row, value) => merge(row, extract(row).copy(intervalPrecision = value)))
  ...
  override val scopeCatalog = new Field[SqlIdentifier, Row](prefix, "scope_catalog", None, Some("information_schema.sql_identifier"))(x => extract(x).scopeCatalog, (row, value) => merge(row, extract(row).copy(scopeCatalog = value)))
  override val scopeSchema = new Field[SqlIdentifier, Row](prefix, "scope_schema", None, Some("information_schema.sql_identifier"))(x => extract(x).scopeSchema, (row, value) => merge(row, extract(row).copy(scopeSchema = value)))
  override val scopeName = new Field[SqlIdentifier, Row](prefix, "scope_name", None, Some("information_schema.sql_identifier"))(x => extract(x).scopeName, (row, value) => merge(row, extract(row).copy(scopeName = value)))
  override val maximumCardinality = new Field[CardinalNumber, Row](prefix, "maximum_cardinality", None, Some("information_schema.cardinal_number"))(x => extract(x).maximumCardinality, (row, value) => merge(row, extract(row).copy(maximumCardinality = value)))
  ...
  override val isSelfReferencing = new Field[YesOrNo, Row](prefix, "is_self_referencing", None, Some("information_schema.yes_or_no"))(x => extract(x).isSelfReferencing, (row, value) => merge(row, extract(row).copy(isSelfReferencing = value)))
  override val isIdentity = new Field[YesOrNo, Row](prefix, "is_identity", None, Some("information_schema.yes_or_no"))(x => extract(x).isIdentity, (row, value) => merge(row, extract(row).copy(isIdentity = value)))
  override val identityGeneration = new Field[CharacterData, Row](prefix, "identity_generation", None, Some("information_schema.character_data"))(x => extract(x).identityGeneration, (row, value) => merge(row, extract(row).copy(identityGeneration = value)))
  override val identityStart = new Field[CharacterData, Row](prefix, "identity_start", None, Some("information_schema.character_data"))(x => extract(x).identityStart, (row, value) => merge(row, extract(row).copy(identityStart = value)))
  override val identityIncrement = new Field[CharacterData, Row](prefix, "identity_increment", None, Some("information_schema.character_data"))(x => extract(x).identityIncrement, (row, value) => merge(row, extract(row).copy(identityIncrement = value)))
  override val identityMaximum = new Field[CharacterData, Row](prefix, "identity_maximum", None, Some("information_schema.character_data"))(x => extract(x).identityMaximum, (row, value) => merge(row, extract(row).copy(identityMaximum = value)))
  override val identityMinimum = new Field[CharacterData, Row](prefix, "identity_minimum", None, Some("information_schema.character_data"))(x => extract(x).identityMinimum, (row, value) => merge(row, extract(row).copy(identityMinimum = value)))
  override val identityCycle = new Field[YesOrNo, Row](prefix, "identity_cycle", None, Some("information_schema.yes_or_no"))(x => extract(x).identityCycle, (row, value) => merge(row, extract(row).copy(identityCycle = value)))
  override val isGenerated = new Field[CharacterData, Row](prefix, "is_generated", None, Some("information_schema.character_data"))(x => extract(x).isGenerated, (row, value) => merge(row, extract(row).copy(isGenerated = value)))
  override val generationExpression = new Field[CharacterData, Row](prefix, "generation_expression", None, Some("information_schema.character_data"))(x => extract(x).generationExpression, (row, value) => merge(row, extract(row).copy(generationExpression = value)))
