...
class UserDefinedTypesViewStructure[Row](val prefix: Option[String], val extract: Row => UserDefinedTypesViewRow, val merge: (Row, UserDefinedTypesViewRow) => Row)
  ...
  override val userDefinedTypeCategory = new Field[CharacterData, Row](prefix, "user_defined_type_category", None, Some("information_schema.character_data"))(x => extract(x).userDefinedTypeCategory, (row, value) => merge(row, extract(row).copy(userDefinedTypeCategory = value)))
  override val isInstantiable = new Field[YesOrNo, Row](prefix, "is_instantiable", None, Some("information_schema.yes_or_no"))(x => extract(x).isInstantiable, (row, value) => merge(row, extract(row).copy(isInstantiable = value)))
  override val isFinal = new Field[YesOrNo, Row](prefix, "is_final", None, Some("information_schema.yes_or_no"))(x => extract(x).isFinal, (row, value) => merge(row, extract(row).copy(isFinal = value)))
  override val orderingForm = new Field[CharacterData, Row](prefix, "ordering_form", None, Some("information_schema.character_data"))(x => extract(x).orderingForm, (row, value) => merge(row, extract(row).copy(orderingForm = value)))
  override val orderingCategory = new Field[CharacterData, Row](prefix, "ordering_category", None, Some("information_schema.character_data"))(x => extract(x).orderingCategory, (row, value) => merge(row, extract(row).copy(orderingCategory = value)))
  override val orderingRoutineCatalog = new Field[SqlIdentifier, Row](prefix, "ordering_routine_catalog", None, Some("information_schema.sql_identifier"))(x => extract(x).orderingRoutineCatalog, (row, value) => merge(row, extract(row).copy(orderingRoutineCatalog = value)))
  override val orderingRoutineSchema = new Field[SqlIdentifier, Row](prefix, "ordering_routine_schema", None, Some("information_schema.sql_identifier"))(x => extract(x).orderingRoutineSchema, (row, value) => merge(row, extract(row).copy(orderingRoutineSchema = value)))
  override val orderingRoutineName = new Field[SqlIdentifier, Row](prefix, "ordering_routine_name", None, Some("information_schema.sql_identifier"))(x => extract(x).orderingRoutineName, (row, value) => merge(row, extract(row).copy(orderingRoutineName = value)))
  override val referenceType = new Field[CharacterData, Row](prefix, "reference_type", None, Some("information_schema.character_data"))(x => extract(x).referenceType, (row, value) => merge(row, extract(row).copy(referenceType = value)))
  ...
  override val sourceDtdIdentifier = new Field[SqlIdentifier, Row](prefix, "source_dtd_identifier", None, Some("information_schema.sql_identifier"))(x => extract(x).sourceDtdIdentifier, (row, value) => merge(row, extract(row).copy(sourceDtdIdentifier = value)))
  override val refDtdIdentifier = new Field[SqlIdentifier, Row](prefix, "ref_dtd_identifier", None, Some("information_schema.sql_identifier"))(x => extract(x).refDtdIdentifier, (row, value) => merge(row, extract(row).copy(refDtdIdentifier = value)))
