...
class ParametersViewStructure[Row](val prefix: Option[String], val extract: Row => ParametersViewRow, val merge: (Row, ParametersViewRow) => Row)
  ...
  override val parameterMode = new Field[CharacterData, Row](prefix, "parameter_mode", None, Some("information_schema.character_data"))(x => extract(x).parameterMode, (row, value) => merge(row, extract(row).copy(parameterMode = value)))
  override val isResult = new Field[YesOrNo, Row](prefix, "is_result", None, Some("information_schema.yes_or_no"))(x => extract(x).isResult, (row, value) => merge(row, extract(row).copy(isResult = value)))
  override val asLocator = new Field[YesOrNo, Row](prefix, "as_locator", None, Some("information_schema.yes_or_no"))(x => extract(x).asLocator, (row, value) => merge(row, extract(row).copy(asLocator = value)))
  override val parameterName = new Field[SqlIdentifier, Row](prefix, "parameter_name", None, Some("information_schema.sql_identifier"))(x => extract(x).parameterName, (row, value) => merge(row, extract(row).copy(parameterName = value)))
  ...
  override val parameterDefault = new Field[CharacterData, Row](prefix, "parameter_default", None, Some("information_schema.character_data"))(x => extract(x).parameterDefault, (row, value) => merge(row, extract(row).copy(parameterDefault = value)))
