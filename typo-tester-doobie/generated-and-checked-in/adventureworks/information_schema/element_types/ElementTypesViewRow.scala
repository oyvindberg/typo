...
object ElementTypesViewRow {
  implicit lazy val decoder: Decoder[ElementTypesViewRow] = Decoder.instanceTry[ElementTypesViewRow]((c: HCursor) =>
    Try {
      ...
      ElementTypesViewRow(
        objectCatalog = orThrow(c.get("object_catalog")(SqlIdentifier.decoder)),
        objectSchema = orThrow(c.get("object_schema")(SqlIdentifier.decoder)),
        objectName = orThrow(c.get("object_name")(SqlIdentifier.decoder)),
        objectType = orThrow(c.get("object_type")(CharacterData.decoder)),
        collectionTypeIdentifier = orThrow(c.get("collection_type_identifier")(SqlIdentifier.decoder)),
  ...
  implicit lazy val encoder: Encoder[ElementTypesViewRow] = Encoder[ElementTypesViewRow](row =>
    Json.obj(
      "object_catalog" -> SqlIdentifier.encoder.apply(row.objectCatalog),
      "object_schema" -> SqlIdentifier.encoder.apply(row.objectSchema),
      "object_name" -> SqlIdentifier.encoder.apply(row.objectName),
      "object_type" -> CharacterData.encoder.apply(row.objectType),
      "collection_type_identifier" -> SqlIdentifier.encoder.apply(row.collectionTypeIdentifier),
  ...
  implicit lazy val read: Read[ElementTypesViewRow] = new Read[ElementTypesViewRow](
    ...
    unsafeGet = (rs: ResultSet, i: Int) => ElementTypesViewRow(
      ...
      collectionTypeIdentifier = SqlIdentifier.get.unsafeGetNonNullable(rs, i + 4),
      dataType = CharacterData.get.unsafeGetNonNullable(rs, i + 5),
      characterMaximumLength = CardinalNumber.get.unsafeGetNonNullable(rs, i + 6),
      characterOctetLength = CardinalNumber.get.unsafeGetNonNullable(rs, i + 7),
      characterSetCatalog = SqlIdentifier.get.unsafeGetNonNullable(rs, i + 8),
      characterSetSchema = SqlIdentifier.get.unsafeGetNonNullable(rs, i + 9),
      characterSetName = SqlIdentifier.get.unsafeGetNonNullable(rs, i + 10),
      collationCatalog = SqlIdentifier.get.unsafeGetNonNullable(rs, i + 11),
      collationSchema = SqlIdentifier.get.unsafeGetNonNullable(rs, i + 12),
      collationName = SqlIdentifier.get.unsafeGetNonNullable(rs, i + 13),
      numericPrecision = CardinalNumber.get.unsafeGetNonNullable(rs, i + 14),
      numericPrecisionRadix = CardinalNumber.get.unsafeGetNonNullable(rs, i + 15),
      numericScale = CardinalNumber.get.unsafeGetNonNullable(rs, i + 16),
      datetimePrecision = CardinalNumber.get.unsafeGetNonNullable(rs, i + 17),
      intervalType = CharacterData.get.unsafeGetNonNullable(rs, i + 18),
      intervalPrecision = CardinalNumber.get.unsafeGetNonNullable(rs, i + 19),
      domainDefault = CharacterData.get.unsafeGetNonNullable(rs, i + 20),
      udtCatalog = SqlIdentifier.get.unsafeGetNonNullable(rs, i + 21),
      udtSchema = SqlIdentifier.get.unsafeGetNonNullable(rs, i + 22),
      udtName = SqlIdentifier.get.unsafeGetNonNullable(rs, i + 23),
      scopeCatalog = SqlIdentifier.get.unsafeGetNonNullable(rs, i + 24),
      scopeSchema = SqlIdentifier.get.unsafeGetNonNullable(rs, i + 25),
      scopeName = SqlIdentifier.get.unsafeGetNonNullable(rs, i + 26),
      maximumCardinality = CardinalNumber.get.unsafeGetNonNullable(rs, i + 27),
      dtdIdentifier = SqlIdentifier.get.unsafeGetNonNullable(rs, i + 28)
    )
  )
}
