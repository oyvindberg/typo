...
class ElementTypesViewStructure[Row](val prefix: Option[String], val extract: Row => ElementTypesViewRow, val merge: (Row, ElementTypesViewRow) => Row)
  ...
  override val collectionTypeIdentifier = new Field[SqlIdentifier, Row](prefix, "collection_type_identifier", None, Some("information_schema.sql_identifier"))(x => extract(x).collectionTypeIdentifier, (row, value) => merge(row, extract(row).copy(collectionTypeIdentifier = value)))
  ...
  override val domainDefault = new Field[CharacterData, Row](prefix, "domain_default", None, Some("information_schema.character_data"))(x => extract(x).domainDefault, (row, value) => merge(row, extract(row).copy(domainDefault = value)))
