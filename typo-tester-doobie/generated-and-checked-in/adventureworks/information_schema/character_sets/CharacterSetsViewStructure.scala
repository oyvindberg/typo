...
class CharacterSetsViewStructure[Row](val prefix: Option[String], val extract: Row => CharacterSetsViewRow, val merge: (Row, CharacterSetsViewRow) => Row)
  ...
  override val characterRepertoire = new Field[SqlIdentifier, Row](prefix, "character_repertoire", None, Some("information_schema.sql_identifier"))(x => extract(x).characterRepertoire, (row, value) => merge(row, extract(row).copy(characterRepertoire = value)))
  override val formOfUse = new Field[SqlIdentifier, Row](prefix, "form_of_use", None, Some("information_schema.sql_identifier"))(x => extract(x).formOfUse, (row, value) => merge(row, extract(row).copy(formOfUse = value)))
  override val defaultCollateCatalog = new Field[SqlIdentifier, Row](prefix, "default_collate_catalog", None, Some("information_schema.sql_identifier"))(x => extract(x).defaultCollateCatalog, (row, value) => merge(row, extract(row).copy(defaultCollateCatalog = value)))
  override val defaultCollateSchema = new Field[SqlIdentifier, Row](prefix, "default_collate_schema", None, Some("information_schema.sql_identifier"))(x => extract(x).defaultCollateSchema, (row, value) => merge(row, extract(row).copy(defaultCollateSchema = value)))
  override val defaultCollateName = new Field[SqlIdentifier, Row](prefix, "default_collate_name", None, Some("information_schema.sql_identifier"))(x => extract(x).defaultCollateName, (row, value) => merge(row, extract(row).copy(defaultCollateName = value)))
