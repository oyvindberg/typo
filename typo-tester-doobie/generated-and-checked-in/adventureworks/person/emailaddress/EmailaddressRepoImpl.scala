...
class EmailaddressRepoImpl extends EmailaddressRepo {
  ...
  def insertStreaming(unsaved: Stream[ConnectionIO, EmailaddressRow], batchSize: Int = 10000): ConnectionIO[Long] = new FragmentOps(sql"""COPY person.emailaddress("businessentityid", "emailaddressid", "emailaddress", "rowguid", "modifieddate") FROM STDIN""").copyIn(unsaved, batchSize)(using EmailaddressRow.text)
  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Stream[ConnectionIO, EmailaddressRowUnsaved], batchSize: Int = 10000): ConnectionIO[Long] = new FragmentOps(sql"""COPY person.emailaddress("businessentityid", "emailaddress", "emailaddressid", "rowguid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""").copyIn(unsaved, batchSize)(using EmailaddressRowUnsaved.text)
  def select: SelectBuilder[EmailaddressFields, EmailaddressRow] = SelectBuilderSql("person.emailaddress", EmailaddressFields.structure, EmailaddressRow.read)
  ...
  def update: UpdateBuilder[EmailaddressFields, EmailaddressRow] = UpdateBuilder("person.emailaddress", EmailaddressFields.structure, EmailaddressRow.read)
