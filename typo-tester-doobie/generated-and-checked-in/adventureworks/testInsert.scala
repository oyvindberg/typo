...
class TestInsert(random: Random, domainInsert: TestDomainInsert) {
  def frontpageAddress(city: String = random.alphanumeric.take(20).mkString,
                      ...
                      ): ConnectionIO[AddressRow] = (new AddressRepoImpl).insert(new AddressRowUnsaved(city = city, country = country, id = id))
  def frontpageCategory(name: String = random.alphanumeric.take(20).mkString, id: Defaulted[CategoryId] = Defaulted.UseDefault): ConnectionIO[CategoryRow] = (new CategoryRepoImpl).insert(new CategoryRowUnsaved(name = name, id = id))
  def frontpageCompany(name: String = random.alphanumeric.take(20).mkString, id: Defaulted[CompanyId] = Defaulted.UseDefault): ConnectionIO[CompanyRow] = (new CompanyRepoImpl).insert(new CompanyRowUnsaved(name = name, id = id))
  def frontpageCustomer(userId: Option[UserId] = None,
                       ...
                       ): ConnectionIO[CustomerRow] = (new CustomerRepoImpl).insert(new CustomerRowUnsaved(userId = userId, companyName = companyName, creditLimit = creditLimit, id = id, verified = verified))
  def frontpageDepartment(name: String = random.alphanumeric.take(20).mkString,
                         ...
                         ): ConnectionIO[DepartmentRow] = (new DepartmentRepoImpl).insert(new DepartmentRowUnsaved(name = name, budget = budget, companyId = companyId, id = id))
  def frontpageEmployee(personId: PersonId,
                       ...
                       ): ConnectionIO[EmployeeRow] = (new EmployeeRepoImpl).insert(new EmployeeRowUnsaved(personId = personId, salary = salary, id = id))
  def frontpageLocation(name: String = random.alphanumeric.take(20).mkString,
                       ...
                       ): ConnectionIO[LocationRow] = (new LocationRepoImpl).insert(new LocationRowUnsaved(name = name, position = position, area = area, ipRange = ipRange, id = id, metadata = metadata))
  def frontpageOrder(userId: Option[UserId] = None,
                    ...
                    ): ConnectionIO[OrderRow] = (new OrderRepoImpl).insert(new OrderRowUnsaved(userId = userId, productId = productId, total = total, shippedAt = shippedAt, id = id, status = status, createdAt = createdAt))
  def frontpageOrderItem(orderId: Option[OrderId] = None,
                        ...
                        ): ConnectionIO[OrderItemRow] = (new OrderItemRepoImpl).insert(new OrderItemRowUnsaved(orderId = orderId, productId = productId, quantity = quantity, price = price, shippedAt = shippedAt, id = id))
  def frontpagePermission(name: String = random.alphanumeric.take(20).mkString, id: Defaulted[PermissionId] = Defaulted.UseDefault): ConnectionIO[PermissionRow] = (new PermissionRepoImpl).insert(new PermissionRowUnsaved(name = name, id = id))
  def frontpagePerson(name: String = random.alphanumeric.take(20).mkString,
                      ...
                      createdAt: Defaulted[Option[TypoLocalDateTime]] = Defaulted.UseDefault
                     ): ConnectionIO[PersonRow] = (new PersonRepoImpl).insert(new PersonRowUnsaved(name = name, addressId = addressId, id = id, createdAt = createdAt))
  def frontpageProduct(name: String = random.alphanumeric.take(20).mkString,
                      ...
                      ): ConnectionIO[ProductRow] = (new ProductRepoImpl).insert(new ProductRowUnsaved(name = name, price = price, lastRestocked = lastRestocked, id = id, inStock = inStock, quantity = quantity, lastModified = lastModified, tags = tags, categories = categories, prices = prices, attributes = attributes))
  def frontpageProductCategory(productId: ProductId, categoryId: CategoryId): ConnectionIO[ProductCategoryRow] = (new ProductCategoryRepoImpl).insert(new ProductCategoryRow(productId = productId, categoryId = categoryId))
  def frontpageRole(name: String = random.alphanumeric.take(20).mkString, id: Defaulted[RoleId] = Defaulted.UseDefault): ConnectionIO[RoleRow] = (new RoleRepoImpl).insert(new RoleRowUnsaved(name = name, id = id))
  def frontpageUser(email: Email = domainInsert.frontpageEmail(random),
                   ...
                   ): ConnectionIO[UserRow] = (new UserRepoImpl).insert(new UserRowUnsaved(email = email, name = name, departmentId = departmentId, managerId = managerId, id = id, createdAt = createdAt, status = status, verified = verified, role = role))
  def frontpageUserPermission(userId: UserId,
                              permissionId: PermissionId,
                              grantedAt: Defaulted[Option[TypoLocalDateTime]] = Defaulted.UseDefault
                             ): ConnectionIO[UserPermissionRow] = (new UserPermissionRepoImpl).insert(new UserPermissionRowUnsaved(userId = userId, permissionId = permissionId, grantedAt = grantedAt))
  def humanresourcesDepartment(name: Name = domainInsert.publicName(random),
                              ...
                              ): ConnectionIO[adventureworks.humanresources.department.DepartmentRow] = (new adventureworks.humanresources.department.DepartmentRepoImpl).insert(new adventureworks.humanresources.department.DepartmentRowUnsaved(name = name, groupname = groupname, departmentid = departmentid, modifieddate = modifieddate))
  ...
  def productionLocation(name: Name = domainInsert.publicName(random),
                         ...
                         modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault
                        ): ConnectionIO[adventureworks.production.location.LocationRow] = (new adventureworks.production.location.LocationRepoImpl).insert(new adventureworks.production.location.LocationRowUnsaved(name = name, locationid = locationid, costrate = costrate, availability = availability, modifieddate = modifieddate))
  ...
  def publicOnlyPkColumns(keyColumn1: String = random.alphanumeric.take(20).mkString, keyColumn2: Int = random.nextInt()): ConnectionIO[OnlyPkColumnsRow] = (new OnlyPkColumnsRepoImpl).insert(new OnlyPkColumnsRow(keyColumn1 = keyColumn1, keyColumn2 = keyColumn2))
  ...
  def publicTestOrganisasjon(organisasjonskode: TestOrganisasjonId = TestOrganisasjonId(random.alphanumeric.take(20).mkString)): ConnectionIO[TestOrganisasjonRow] = (new TestOrganisasjonRepoImpl).insert(new TestOrganisasjonRow(organisasjonskode = organisasjonskode))
  ...
  def publicTestUtdanningstilbud(organisasjonskode: TestOrganisasjonId, utdanningsmulighetKode: String = random.alphanumeric.take(20).mkString): ConnectionIO[TestUtdanningstilbudRow] = (new TestUtdanningstilbudRepoImpl).insert(new TestUtdanningstilbudRow(organisasjonskode = organisasjonskode, utdanningsmulighetKode = utdanningsmulighetKode))
  ...
  def salesCustomer(personid: Option[BusinessentityId] = None,
                    ...
                    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault,
                    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault
                   ): ConnectionIO[adventureworks.sales.customer.CustomerRow] = (new adventureworks.sales.customer.CustomerRepoImpl).insert(new adventureworks.sales.customer.CustomerRowUnsaved(personid = personid, storeid = storeid, territoryid = territoryid, customerid = customerid, rowguid = rowguid, modifieddate = modifieddate))
