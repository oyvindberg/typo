...
class TestInsert(val random: Random, val domainInsert: TestDomainInsert) {
  ...
  def personBusinessentity(businessentityid: Defaulted[BusinessentityId] = Defaulted.UseDefault(), rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(), modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ConnectionIO[BusinessentityRow] = (new BusinessentityRepoImpl).insert(new BusinessentityRowUnsaved(businessentityid = businessentityid, rowguid = rowguid, modifieddate = modifieddate))
  ...
  def personContacttype(name: Name = domainInsert.publicName(random), contacttypeid: Defaulted[ContacttypeId] = Defaulted.UseDefault(), modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ConnectionIO[ContacttypeRow] = (new ContacttypeRepoImpl).insert(new ContacttypeRowUnsaved(name = name, contacttypeid = contacttypeid, modifieddate = modifieddate))
  def personCountryregion(countryregioncode: CountryregionId, name: Name = domainInsert.publicName(random), modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ConnectionIO[CountryregionRow] = (new CountryregionRepoImpl).insert(new CountryregionRowUnsaved(countryregioncode = countryregioncode, name = name, modifieddate = modifieddate))
  ...
  def personPhonenumbertype(name: Name = domainInsert.publicName(random), phonenumbertypeid: Defaulted[PhonenumbertypeId] = Defaulted.UseDefault(), modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ConnectionIO[PhonenumbertypeRow] = (new PhonenumbertypeRepoImpl).insert(new PhonenumbertypeRowUnsaved(name = name, phonenumbertypeid = phonenumbertypeid, modifieddate = modifieddate))
  ...
  def productionCulture(cultureid: CultureId, name: Name = domainInsert.publicName(random), modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ConnectionIO[CultureRow] = (new CultureRepoImpl).insert(new CultureRowUnsaved(cultureid = cultureid, name = name, modifieddate = modifieddate))
  ...
  def productionIllustration(diagram: Option[TypoXml] = None, illustrationid: Defaulted[IllustrationId] = Defaulted.UseDefault(), modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ConnectionIO[IllustrationRow] = (new IllustrationRepoImpl).insert(new IllustrationRowUnsaved(diagram = diagram, illustrationid = illustrationid, modifieddate = modifieddate))
  ...
  def productionProductmodelillustration(productmodelid: ProductmodelId, illustrationid: IllustrationId, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ConnectionIO[ProductmodelillustrationRow] = (new ProductmodelillustrationRepoImpl).insert(new ProductmodelillustrationRowUnsaved(productmodelid = productmodelid, illustrationid = illustrationid, modifieddate = modifieddate))
  ...
  def productionScrapreason(name: Name = domainInsert.publicName(random), scrapreasonid: Defaulted[ScrapreasonId] = Defaulted.UseDefault(), modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ConnectionIO[ScrapreasonRow] = (new ScrapreasonRepoImpl).insert(new ScrapreasonRowUnsaved(name = name, scrapreasonid = scrapreasonid, modifieddate = modifieddate))
  ...
  def productionUnitmeasure(unitmeasurecode: UnitmeasureId, name: Name = domainInsert.publicName(random), modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ConnectionIO[UnitmeasureRow] = (new UnitmeasureRepoImpl).insert(new UnitmeasureRowUnsaved(unitmeasurecode = unitmeasurecode, name = name, modifieddate = modifieddate))
  ...
  def publicIdentityTest(name: IdentityTestId, alwaysGenerated: Int = random.nextInt(), defaultGenerated: Defaulted[Int] = Defaulted.UseDefault()): ConnectionIO[IdentityTestRow] = (new IdentityTestRepoImpl).insert(new IdentityTestRowUnsaved(name = name, alwaysGenerated = alwaysGenerated, defaultGenerated = defaultGenerated))
  def publicPgtest(
    box: TypoBox,
    bytea: TypoBytea,
    circle: TypoCircle,
  ...
  def salesCountryregioncurrency(countryregioncode: CountryregionId, currencycode: CurrencyId, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ConnectionIO[CountryregioncurrencyRow] = (new CountryregioncurrencyRepoImpl).insert(new CountryregioncurrencyRowUnsaved(countryregioncode = countryregioncode, currencycode = currencycode, modifieddate = modifieddate))
  def salesCreditcard(
  ...
  def salesCurrency(currencycode: CurrencyId, name: Name = domainInsert.publicName(random), modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ConnectionIO[CurrencyRow] = (new CurrencyRepoImpl).insert(new CurrencyRowUnsaved(currencycode = currencycode, name = name, modifieddate = modifieddate))
  ...
  def salesPersoncreditcard(businessentityid: BusinessentityId, creditcardid: /* user-picked */ CustomCreditcardId, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()): ConnectionIO[PersoncreditcardRow] = (new PersoncreditcardRepoImpl).insert(new PersoncreditcardRowUnsaved(businessentityid = businessentityid, creditcardid = creditcardid, modifieddate = modifieddate))
