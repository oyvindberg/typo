...
trait CustomerRepo {
  ...
  def deleteById(id: CustomerId): ConnectionIO[Boolean]
  def deleteByIds(ids: Array[CustomerId]): ConnectionIO[Int]
  ...
  def selectById(id: CustomerId): ConnectionIO[Option[CustomerRow]]
  def selectByIds(ids: Array[CustomerId]): Stream[ConnectionIO, CustomerRow]
  def selectByIdsTracked(ids: Array[CustomerId]): ConnectionIO[Map[CustomerId, CustomerRow]]
