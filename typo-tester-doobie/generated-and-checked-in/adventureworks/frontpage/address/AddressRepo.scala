...
trait AddressRepo {
  ...
  def deleteById(id: AddressId): ConnectionIO[Boolean]
  def deleteByIds(ids: Array[AddressId]): ConnectionIO[Int]
  ...
  def selectById(id: AddressId): ConnectionIO[Option[AddressRow]]
  def selectByIds(ids: Array[AddressId]): Stream[ConnectionIO, AddressRow]
  def selectByIdsTracked(ids: Array[AddressId]): ConnectionIO[Map[AddressId, AddressRow]]
