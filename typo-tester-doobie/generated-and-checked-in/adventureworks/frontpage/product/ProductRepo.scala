...
trait ProductRepo {
  ...
  def deleteById(id: ProductId): ConnectionIO[Boolean]
  def deleteByIds(ids: Array[ProductId]): ConnectionIO[Int]
  ...
  def selectById(id: ProductId): ConnectionIO[Option[ProductRow]]
  def selectByIds(ids: Array[ProductId]): Stream[ConnectionIO, ProductRow]
  def selectByIdsTracked(ids: Array[ProductId]): ConnectionIO[Map[ProductId, ProductRow]]
