...
trait ProductmodelillustrationFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductmodelillustrationId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[ProductmodelillustrationId](productmodelid)(_.productmodelid)(using as[Array[ProductmodelId], Required](ProductmodelId.arrayPut, Write.fromPut(ProductmodelId.arrayPut)), implicitly), TuplePart[ProductmodelillustrationId](illustrationid)(_.illustrationid)(using as[Array[IllustrationId], Required](IllustrationId.arrayPut, Write.fromPut(IllustrationId.arrayPut)), implicitly))
