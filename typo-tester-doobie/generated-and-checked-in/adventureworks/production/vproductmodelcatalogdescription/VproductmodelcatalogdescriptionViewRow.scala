...
object VproductmodelcatalogdescriptionViewRow {
  implicit lazy val decoder: Decoder[VproductmodelcatalogdescriptionViewRow] = {
  ...
  implicit lazy val encoder: Encoder[VproductmodelcatalogdescriptionViewRow] = {
    Encoder[VproductmodelcatalogdescriptionViewRow](row =>
      Json.obj(
  ...
  implicit lazy val read: Read[VproductmodelcatalogdescriptionViewRow] = {
