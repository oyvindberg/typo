...
class WorkorderroutingStructure[Row](val prefix: Option[String], val extract: Row => WorkorderroutingRow, val merge: (Row, WorkorderroutingRow) => Row)
  extends Relation[WorkorderroutingFields, WorkorderroutingRow, Row]
    with WorkorderroutingFields[Row] { outer =>
  ...
  override val columns: List[FieldLikeNoHkt[?, Row]] =
    List[FieldLikeNoHkt[?, Row]](workorderid, productid, operationsequence, locationid, scheduledstartdate, scheduledenddate, actualstartdate, actualenddate, actualresourcehrs, plannedcost, actualcost, modifieddate)

  override def copy[NewRow](prefix: Option[String], extract: NewRow => WorkorderroutingRow, merge: (NewRow, WorkorderroutingRow) => NewRow): WorkorderroutingStructure[NewRow] =
    new WorkorderroutingStructure(prefix, extract, merge)
}
