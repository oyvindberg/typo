...
trait ProductcosthistoryFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductcosthistoryId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[ProductcosthistoryId](productid)(_.productid)(using as[Array[ProductId]](ProductId.arrayPut), implicitly), TuplePart[ProductcosthistoryId](startdate)(_.startdate)(using as[Array[TypoLocalDateTime]](TypoLocalDateTime.arrayPut), implicitly))
