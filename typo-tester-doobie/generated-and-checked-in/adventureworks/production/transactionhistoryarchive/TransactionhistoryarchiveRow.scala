...
object TransactionhistoryarchiveRow {
  ...
  implicit lazy val read: Read[TransactionhistoryarchiveRow] = {
  ...
  implicit lazy val write: Write[TransactionhistoryarchiveRow] = {
    new Write[TransactionhistoryarchiveRow](
