...
trait ProductmodelproductdescriptioncultureFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductmodelproductdescriptioncultureId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[ProductmodelproductdescriptioncultureId](productmodelid)(_.productmodelid)(using as[Array[ProductmodelId], Required](ProductmodelId.arrayPut, Write.fromPut(ProductmodelId.arrayPut)), implicitly), TuplePart[ProductmodelproductdescriptioncultureId](productdescriptionid)(_.productdescriptionid)(using as[Array[ProductdescriptionId], Required](ProductdescriptionId.arrayPut, Write.fromPut(ProductdescriptionId.arrayPut)), implicitly), TuplePart[ProductmodelproductdescriptioncultureId](cultureid)(_.cultureid)(using as[Array[CultureId], Required](CultureId.arrayPut, Write.fromPut(CultureId.arrayPut)), implicitly))
