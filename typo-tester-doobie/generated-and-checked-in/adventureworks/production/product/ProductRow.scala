...
object ProductRow {
  implicit lazy val decoder: Decoder[ProductRow] = {
    Decoder.instanceTry[ProductRow]((c: HCursor) =>
      Try {
  ...
  implicit lazy val encoder: Encoder[ProductRow] = {
    Encoder[ProductRow](row =>
      Json.obj(
  ...
  implicit lazy val read: Read[ProductRow] = {
    new Read[ProductRow](
      gets = List(
  ...
  implicit lazy val write: Write[ProductRow] = {
    new Write[ProductRow](
