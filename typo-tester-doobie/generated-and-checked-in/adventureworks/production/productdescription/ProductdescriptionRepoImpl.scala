...
class ProductdescriptionRepoImpl extends ProductdescriptionRepo {
  ...
  def deleteById(productdescriptionid: ProductdescriptionId): ConnectionIO[Boolean] = sql"""delete from production.productdescription where "productdescriptionid" = ${fromWrite(productdescriptionid)(Write.fromPut(ProductdescriptionId.put))}""".update.run.map(_ > 0)
  def deleteByIds(productdescriptionids: Array[ProductdescriptionId]): ConnectionIO[Int] = sql"""delete from production.productdescription where "productdescriptionid" = ANY(${fromWrite(productdescriptionids)(Write.fromPut(ProductdescriptionId.arrayPut))})""".update.run
  ...
  def insertStreaming(unsaved: Stream[ConnectionIO, ProductdescriptionRow], batchSize: Int = 10000): ConnectionIO[Long] = new FragmentOps(sql"""COPY production.productdescription("productdescriptionid", "description", "rowguid", "modifieddate") FROM STDIN""").copyIn(unsaved, batchSize)(using ProductdescriptionRow.text)
  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Stream[ConnectionIO, ProductdescriptionRowUnsaved], batchSize: Int = 10000): ConnectionIO[Long] = new FragmentOps(sql"""COPY production.productdescription("description", "productdescriptionid", "rowguid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""").copyIn(unsaved, batchSize)(using ProductdescriptionRowUnsaved.text)
  def select: SelectBuilder[ProductdescriptionFields, ProductdescriptionRow] = SelectBuilderSql("production.productdescription", ProductdescriptionFields.structure, ProductdescriptionRow.read)
  def selectAll: Stream[ConnectionIO, ProductdescriptionRow] = sql"""select "productdescriptionid", "description", "rowguid", "modifieddate"::text from production.productdescription""".query(using ProductdescriptionRow.read).stream
  def selectById(productdescriptionid: ProductdescriptionId): ConnectionIO[Option[ProductdescriptionRow]] = sql"""select "productdescriptionid", "description", "rowguid", "modifieddate"::text from production.productdescription where "productdescriptionid" = ${fromWrite(productdescriptionid)(Write.fromPut(ProductdescriptionId.put))}""".query(using ProductdescriptionRow.read).option
  def selectByIds(productdescriptionids: Array[ProductdescriptionId]): Stream[ConnectionIO, ProductdescriptionRow] = sql"""select "productdescriptionid", "description", "rowguid", "modifieddate"::text from production.productdescription where "productdescriptionid" = ANY(${fromWrite(productdescriptionids)(Write.fromPut(ProductdescriptionId.arrayPut))})""".query(using ProductdescriptionRow.read).stream
  ...
  def update: UpdateBuilder[ProductdescriptionFields, ProductdescriptionRow] = UpdateBuilder("production.productdescription", ProductdescriptionFields.structure, ProductdescriptionRow.read)
