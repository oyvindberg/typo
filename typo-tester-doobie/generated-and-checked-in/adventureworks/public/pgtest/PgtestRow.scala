...
object PgtestRow {
  implicit lazy val decoder: Decoder[PgtestRow] = Decoder.instanceTry[PgtestRow]((c: HCursor) =>
    Try {
      ...
      PgtestRow(
        ...
        timestampzs = orThrow(c.get("timestampzs")(Decoder.decodeArray[TypoInstant](TypoInstant.decoder, implicitly))),
  ...
  implicit lazy val encoder: Encoder[PgtestRow] = Encoder[PgtestRow](row =>
    Json.obj(
      ...
      "timestampzs" -> Encoder.encodeIterable[TypoInstant, Array](TypoInstant.encoder, implicitly).apply(row.timestampzs),
  ...
  implicit lazy val read: Read[PgtestRow] = new Read[PgtestRow](
    ...
    unsafeGet = (rs: ResultSet, i: Int) => PgtestRow(
      ...
      timestampz = TypoInstant.get.unsafeGetNonNullable(rs, i + 15),
      ...
      vector = TypoVector.get.unsafeGetNonNullable(rs, i + 21),
      boxes = TypoBox.arrayGet.unsafeGetNonNullable(rs, i + 22),
      circlees = TypoCircle.arrayGet.unsafeGetNonNullable(rs, i + 23),
      linees = TypoLine.arrayGet.unsafeGetNonNullable(rs, i + 24),
      lseges = TypoLineSegment.arrayGet.unsafeGetNonNullable(rs, i + 25),
      pathes = TypoPath.arrayGet.unsafeGetNonNullable(rs, i + 26),
      pointes = TypoPoint.arrayGet.unsafeGetNonNullable(rs, i + 27),
      polygones = TypoPolygon.arrayGet.unsafeGetNonNullable(rs, i + 28),
      intervales = TypoInterval.arrayGet.unsafeGetNonNullable(rs, i + 29),
      moneyes = TypoMoney.arrayGet.unsafeGetNonNullable(rs, i + 30),
      xmles = TypoXml.arrayGet.unsafeGetNonNullable(rs, i + 31),
      jsones = TypoJson.arrayGet.unsafeGetNonNullable(rs, i + 32),
      jsonbes = TypoJsonb.arrayGet.unsafeGetNonNullable(rs, i + 33),
      inets = TypoInet.arrayGet.unsafeGetNonNullable(rs, i + 34),
      timestamps = TypoLocalDateTime.arrayGet.unsafeGetNonNullable(rs, i + 35),
      timestampzs = TypoInstant.arrayGet.unsafeGetNonNullable(rs, i + 36),
