...
object testInsert {
  def humanresourcesDepartment(name: Name, groupname: Name, departmentid: Defaulted[DepartmentId] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): DepartmentRow = DepartmentRepoImpl.insert(new DepartmentRowUnsaved(name = name, groupname = groupname, departmentid = departmentid, modifieddate = modifieddate))
  ...
  def humanresourcesEmployeedepartmenthistory(businessentityid: BusinessentityId, departmentid: DepartmentId, shiftid: ShiftId, startdate: TypoLocalDate = TypoLocalDate.now, enddate: Option[TypoLocalDate] = None, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): EmployeedepartmenthistoryRow = EmployeedepartmenthistoryRepoImpl.insert(new EmployeedepartmenthistoryRowUnsaved(businessentityid = businessentityid, departmentid = departmentid, shiftid = shiftid, startdate = startdate, enddate = enddate, modifieddate = modifieddate))
  def humanresourcesEmployeepayhistory(businessentityid: BusinessentityId, rate: BigDecimal, ratechangedate: TypoLocalDateTime = TypoLocalDateTime.now, payfrequency: Int = 1, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): EmployeepayhistoryRow = EmployeepayhistoryRepoImpl.insert(new EmployeepayhistoryRowUnsaved(businessentityid = businessentityid, rate = rate, ratechangedate = ratechangedate, payfrequency = payfrequency, modifieddate = modifieddate))
  ...
  def humanresourcesShift(name: Name, starttime: TypoLocalTime = TypoLocalTime.now, endtime: TypoLocalTime = TypoLocalTime.now, shiftid: Defaulted[ShiftId] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): ShiftRow = ShiftRepoImpl.insert(new ShiftRowUnsaved(name = name, starttime = starttime, endtime = endtime, shiftid = shiftid, modifieddate = modifieddate))
  def informationSchemaSqlFeatures(featureId: Option[CharacterData] = None, featureName: Option[CharacterData] = None, subFeatureId: Option[CharacterData] = None, subFeatureName: Option[CharacterData] = None, isSupported: Option[YesOrNo] = None, isVerifiedBy: Option[CharacterData] = None, comments: Option[CharacterData] = None)(implicit c: Connection): SqlFeaturesRow = SqlFeaturesRepoImpl.insert(new SqlFeaturesRow(featureId = featureId, featureName = featureName, subFeatureId = subFeatureId, subFeatureName = subFeatureName, isSupported = isSupported, isVerifiedBy = isVerifiedBy, comments = comments))
  def informationSchemaSqlImplementationInfo(implementationInfoId: Option[CharacterData] = None, implementationInfoName: Option[CharacterData] = None, integerValue: Option[CardinalNumber] = None, characterValue: Option[CharacterData] = None, comments: Option[CharacterData] = None)(implicit c: Connection): SqlImplementationInfoRow = SqlImplementationInfoRepoImpl.insert(new SqlImplementationInfoRow(implementationInfoId = implementationInfoId, implementationInfoName = implementationInfoName, integerValue = integerValue, characterValue = characterValue, comments = comments))
  def informationSchemaSqlParts(featureId: Option[CharacterData] = None, featureName: Option[CharacterData] = None, isSupported: Option[YesOrNo] = None, isVerifiedBy: Option[CharacterData] = None, comments: Option[CharacterData] = None)(implicit c: Connection): SqlPartsRow = SqlPartsRepoImpl.insert(new SqlPartsRow(featureId = featureId, featureName = featureName, isSupported = isSupported, isVerifiedBy = isVerifiedBy, comments = comments))
  def informationSchemaSqlSizing(sizingId: Option[CardinalNumber] = None, sizingName: Option[CharacterData] = None, supportedValue: Option[CardinalNumber] = None, comments: Option[CharacterData] = None)(implicit c: Connection): SqlSizingRow = SqlSizingRepoImpl.insert(new SqlSizingRow(sizingId = sizingId, sizingName = sizingName, supportedValue = supportedValue, comments = comments))
  def personAddress(stateprovinceid: StateprovinceId, addressline1: /* max 60 chars */ String = "addressline1", addressline2: Option[/* max 60 chars */ String] = None, city: /* max 30 chars */ String = "city", postalcode: /* max 15 chars */ String = "postalcode", spatiallocation: Option[Array[Byte]] = None, addressid: Defaulted[AddressId] = Defaulted.UseDefault, rowguid: Defaulted[UUID] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): AddressRow = AddressRepoImpl.insert(new AddressRowUnsaved(stateprovinceid = stateprovinceid, addressline1 = addressline1, addressline2 = addressline2, city = city, postalcode = postalcode, spatiallocation = spatiallocation, addressid = addressid, rowguid = rowguid, modifieddate = modifieddate))
  def personAddresstype(name: Name, addresstypeid: Defaulted[AddresstypeId] = Defaulted.UseDefault, rowguid: Defaulted[UUID] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): AddresstypeRow = AddresstypeRepoImpl.insert(new AddresstypeRowUnsaved(name = name, addresstypeid = addresstypeid, rowguid = rowguid, modifieddate = modifieddate))
  def personBusinessentity(businessentityid: Defaulted[BusinessentityId] = Defaulted.UseDefault, rowguid: Defaulted[UUID] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): BusinessentityRow = BusinessentityRepoImpl.insert(new BusinessentityRowUnsaved(businessentityid = businessentityid, rowguid = rowguid, modifieddate = modifieddate))
  def personBusinessentityaddress(businessentityid: BusinessentityId, addressid: AddressId, addresstypeid: AddresstypeId, rowguid: Defaulted[UUID] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): BusinessentityaddressRow = BusinessentityaddressRepoImpl.insert(new BusinessentityaddressRowUnsaved(businessentityid = businessentityid, addressid = addressid, addresstypeid = addresstypeid, rowguid = rowguid, modifieddate = modifieddate))
  def personBusinessentitycontact(businessentityid: BusinessentityId, personid: BusinessentityId, contacttypeid: ContacttypeId, rowguid: Defaulted[UUID] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): BusinessentitycontactRow = BusinessentitycontactRepoImpl.insert(new BusinessentitycontactRowUnsaved(businessentityid = businessentityid, personid = personid, contacttypeid = contacttypeid, rowguid = rowguid, modifieddate = modifieddate))
  def personContacttype(name: Name, contacttypeid: Defaulted[ContacttypeId] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): ContacttypeRow = ContacttypeRepoImpl.insert(new ContacttypeRowUnsaved(name = name, contacttypeid = contacttypeid, modifieddate = modifieddate))
  def personCountryregion(countryregioncode: CountryregionId, name: Name, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): CountryregionRow = CountryregionRepoImpl.insert(new CountryregionRowUnsaved(countryregioncode = countryregioncode, name = name, modifieddate = modifieddate))
  def personEmailaddress(businessentityid: BusinessentityId, emailaddress: Option[/* max 50 chars */ String] = None, emailaddressid: Defaulted[Int] = Defaulted.UseDefault, rowguid: Defaulted[UUID] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): EmailaddressRow = EmailaddressRepoImpl.insert(new EmailaddressRowUnsaved(businessentityid = businessentityid, emailaddress = emailaddress, emailaddressid = emailaddressid, rowguid = rowguid, modifieddate = modifieddate))
  def personPassword(businessentityid: BusinessentityId, passwordhash: /* max 128 chars */ String = "passwordhash", passwordsalt: /* max 10 chars */ String = "passwordsa", rowguid: Defaulted[UUID] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): PasswordRow = PasswordRepoImpl.insert(new PasswordRowUnsaved(businessentityid = businessentityid, passwordhash = passwordhash, passwordsalt = passwordsalt, rowguid = rowguid, modifieddate = modifieddate))
  def personPerson(businessentityid: BusinessentityId, firstname: Name, lastname: Name, persontype: /* bpchar */ String = "persontype", title: Option[/* max 8 chars */ String] = None, middlename: Option[Name] = None, suffix: Option[/* max 10 chars */ String] = None, additionalcontactinfo: Option[TypoXml] = None, demographics: Option[TypoXml] = None, namestyle: Defaulted[NameStyle] = Defaulted.UseDefault, emailpromotion: Defaulted[Int] = Defaulted.UseDefault, rowguid: Defaulted[UUID] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): PersonRow = PersonRepoImpl.insert(new PersonRowUnsaved(businessentityid = businessentityid, firstname = firstname, lastname = lastname, persontype = persontype, title = title, middlename = middlename, suffix = suffix, additionalcontactinfo = additionalcontactinfo, demographics = demographics, namestyle = namestyle, emailpromotion = emailpromotion, rowguid = rowguid, modifieddate = modifieddate))
  def personPersonphone(businessentityid: BusinessentityId, phonenumber: Phone, phonenumbertypeid: PhonenumbertypeId, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): PersonphoneRow = PersonphoneRepoImpl.insert(new PersonphoneRowUnsaved(businessentityid = businessentityid, phonenumber = phonenumber, phonenumbertypeid = phonenumbertypeid, modifieddate = modifieddate))
  ...
  def pgCatalogPgInherits(inhrelid: /* oid */ Long = 1L, inhparent: /* oid */ Long = 1L, inhseqno: Int = 1, inhdetachpending: Boolean = false)(implicit c: Connection): PgInheritsRow = PgInheritsRepoImpl.insert(new PgInheritsRow(inhrelid = inhrelid, inhparent = inhparent, inhseqno = inhseqno, inhdetachpending = inhdetachpending))
  def pgCatalogPgInitPrivs(objoid: /* oid */ Long = 1L, classoid: /* oid */ Long = 1L, objsubid: Int = 1, privtype: String = "privtype", initprivs: Array[TypoAclItem] = Array.empty)(implicit c: Connection): PgInitPrivsRow = PgInitPrivsRepoImpl.insert(new PgInitPrivsRow(objoid = objoid, classoid = classoid, objsubid = objsubid, privtype = privtype, initprivs = initprivs))
  def pgCatalogPgLanguage(oid: PgLanguageId, lanname: String = "lanname", lanowner: /* oid */ Long = 1L, lanispl: Boolean = false, lanpltrusted: Boolean = false, lanplcallfoid: /* oid */ Long = 1L, laninline: /* oid */ Long = 1L, lanvalidator: /* oid */ Long = 1L, lanacl: Option[Array[TypoAclItem]] = None)(implicit c: Connection): PgLanguageRow = PgLanguageRepoImpl.insert(new PgLanguageRow(oid = oid, lanname = lanname, lanowner = lanowner, lanispl = lanispl, lanpltrusted = lanpltrusted, lanplcallfoid = lanplcallfoid, laninline = laninline, lanvalidator = lanvalidator, lanacl = lanacl))
  def pgCatalogPgLargeobject(loid: /* oid */ Long = 1L, pageno: Int = 1, data: Array[Byte] = Array.empty)(implicit c: Connection): PgLargeobjectRow = PgLargeobjectRepoImpl.insert(new PgLargeobjectRow(loid = loid, pageno = pageno, data = data))
  def pgCatalogPgLargeobjectMetadata(oid: PgLargeobjectMetadataId, lomowner: /* oid */ Long = 1L, lomacl: Option[Array[TypoAclItem]] = None)(implicit c: Connection): PgLargeobjectMetadataRow = PgLargeobjectMetadataRepoImpl.insert(new PgLargeobjectMetadataRow(oid = oid, lomowner = lomowner, lomacl = lomacl))
  def pgCatalogPgNamespace(oid: PgNamespaceId, nspname: String = "nspname", nspowner: /* oid */ Long = 1L, nspacl: Option[Array[TypoAclItem]] = None)(implicit c: Connection): PgNamespaceRow = PgNamespaceRepoImpl.insert(new PgNamespaceRow(oid = oid, nspname = nspname, nspowner = nspowner, nspacl = nspacl))
  def pgCatalogPgOpclass(oid: PgOpclassId, opcmethod: /* oid */ Long = 1L, opcname: String = "opcname", opcnamespace: /* oid */ Long = 1L, opcowner: /* oid */ Long = 1L, opcfamily: /* oid */ Long = 1L, opcintype: /* oid */ Long = 1L, opcdefault: Boolean = false, opckeytype: /* oid */ Long = 1L)(implicit c: Connection): PgOpclassRow = PgOpclassRepoImpl.insert(new PgOpclassRow(oid = oid, opcmethod = opcmethod, opcname = opcname, opcnamespace = opcnamespace, opcowner = opcowner, opcfamily = opcfamily, opcintype = opcintype, opcdefault = opcdefault, opckeytype = opckeytype))
  def pgCatalogPgOperator(oid: PgOperatorId, oprcode: TypoRegproc, oprrest: TypoRegproc, oprjoin: TypoRegproc, oprname: String = "oprname", oprnamespace: /* oid */ Long = 1L, oprowner: /* oid */ Long = 1L, oprkind: String = "oprkind", oprcanmerge: Boolean = false, oprcanhash: Boolean = false, oprleft: /* oid */ Long = 1L, oprright: /* oid */ Long = 1L, oprresult: /* oid */ Long = 1L, oprcom: /* oid */ Long = 1L, oprnegate: /* oid */ Long = 1L)(implicit c: Connection): PgOperatorRow = PgOperatorRepoImpl.insert(new PgOperatorRow(oid = oid, oprcode = oprcode, oprrest = oprrest, oprjoin = oprjoin, oprname = oprname, oprnamespace = oprnamespace, oprowner = oprowner, oprkind = oprkind, oprcanmerge = oprcanmerge, oprcanhash = oprcanhash, oprleft = oprleft, oprright = oprright, oprresult = oprresult, oprcom = oprcom, oprnegate = oprnegate))
  def pgCatalogPgOpfamily(oid: PgOpfamilyId, opfmethod: /* oid */ Long = 1L, opfname: String = "opfname", opfnamespace: /* oid */ Long = 1L, opfowner: /* oid */ Long = 1L)(implicit c: Connection): PgOpfamilyRow = PgOpfamilyRepoImpl.insert(new PgOpfamilyRow(oid = oid, opfmethod = opfmethod, opfname = opfname, opfnamespace = opfnamespace, opfowner = opfowner))
  def pgCatalogPgPartitionedTable(partrelid: PgPartitionedTableId, partattrs: TypoInt2Vector, partclass: TypoOidVector, partcollation: TypoOidVector, partstrat: String = "partstrat", partnatts: Int = 1, partdefid: /* oid */ Long = 1L, partexprs: Option[TypoPgNodeTree] = None)(implicit c: Connection): PgPartitionedTableRow = PgPartitionedTableRepoImpl.insert(new PgPartitionedTableRow(partrelid = partrelid, partattrs = partattrs, partclass = partclass, partcollation = partcollation, partstrat = partstrat, partnatts = partnatts, partdefid = partdefid, partexprs = partexprs))
  def pgCatalogPgPolicy(oid: PgPolicyId, polname: String = "polname", polrelid: /* oid */ Long = 1L, polcmd: String = "polcmd", polpermissive: Boolean = false, polroles: Array[/* oid */ Long] = Array.empty, polqual: Option[TypoPgNodeTree] = None, polwithcheck: Option[TypoPgNodeTree] = None)(implicit c: Connection): PgPolicyRow = PgPolicyRepoImpl.insert(new PgPolicyRow(oid = oid, polname = polname, polrelid = polrelid, polcmd = polcmd, polpermissive = polpermissive, polroles = polroles, polqual = polqual, polwithcheck = polwithcheck))
  def pgCatalogPgProc(oid: PgProcId, prosupport: TypoRegproc, proargtypes: TypoOidVector, proname: String = "proname", pronamespace: /* oid */ Long = 1L, proowner: /* oid */ Long = 1L, prolang: /* oid */ Long = 1L, procost: Float = 1.0f, prorows: Float = 1.0f, provariadic: /* oid */ Long = 1L, prokind: String = "prokind", prosecdef: Boolean = false, proleakproof: Boolean = false, proisstrict: Boolean = false, proretset: Boolean = false, provolatile: String = "provolatile", proparallel: String = "proparallel", pronargs: Int = 1, pronargdefaults: Int = 1, prorettype: /* oid */ Long = 1L, proallargtypes: Option[Array[/* oid */ Long]] = None, proargmodes: Option[Array[String]] = None, proargnames: Option[Array[String]] = None, proargdefaults: Option[TypoPgNodeTree] = None, protrftypes: Option[Array[/* oid */ Long]] = None, prosrc: String = "prosrc", probin: Option[String] = None, prosqlbody: Option[TypoPgNodeTree] = None, proconfig: Option[Array[String]] = None, proacl: Option[Array[TypoAclItem]] = None)(implicit c: Connection): PgProcRow = PgProcRepoImpl.insert(new PgProcRow(oid = oid, prosupport = prosupport, proargtypes = proargtypes, proname = proname, pronamespace = pronamespace, proowner = proowner, prolang = prolang, procost = procost, prorows = prorows, provariadic = provariadic, prokind = prokind, prosecdef = prosecdef, proleakproof = proleakproof, proisstrict = proisstrict, proretset = proretset, provolatile = provolatile, proparallel = proparallel, pronargs = pronargs, pronargdefaults = pronargdefaults, prorettype = prorettype, proallargtypes = proallargtypes, proargmodes = proargmodes, proargnames = proargnames, proargdefaults = proargdefaults, protrftypes = protrftypes, prosrc = prosrc, probin = probin, prosqlbody = prosqlbody, proconfig = proconfig, proacl = proacl))
  def pgCatalogPgPublication(oid: PgPublicationId, pubname: String = "pubname", pubowner: /* oid */ Long = 1L, puballtables: Boolean = false, pubinsert: Boolean = false, pubupdate: Boolean = false, pubdelete: Boolean = false, pubtruncate: Boolean = false, pubviaroot: Boolean = false)(implicit c: Connection): PgPublicationRow = PgPublicationRepoImpl.insert(new PgPublicationRow(oid = oid, pubname = pubname, pubowner = pubowner, puballtables = puballtables, pubinsert = pubinsert, pubupdate = pubupdate, pubdelete = pubdelete, pubtruncate = pubtruncate, pubviaroot = pubviaroot))
  def pgCatalogPgPublicationRel(oid: PgPublicationRelId, prpubid: /* oid */ Long = 1L, prrelid: /* oid */ Long = 1L)(implicit c: Connection): PgPublicationRelRow = PgPublicationRelRepoImpl.insert(new PgPublicationRelRow(oid = oid, prpubid = prpubid, prrelid = prrelid))
  def pgCatalogPgRange(rngtypid: PgRangeId, rngcanonical: TypoRegproc, rngsubdiff: TypoRegproc, rngsubtype: /* oid */ Long = 1L, rngmultitypid: /* oid */ Long = 1L, rngcollation: /* oid */ Long = 1L, rngsubopc: /* oid */ Long = 1L)(implicit c: Connection): PgRangeRow = PgRangeRepoImpl.insert(new PgRangeRow(rngtypid = rngtypid, rngcanonical = rngcanonical, rngsubdiff = rngsubdiff, rngsubtype = rngsubtype, rngmultitypid = rngmultitypid, rngcollation = rngcollation, rngsubopc = rngsubopc))
  def pgCatalogPgReplicationOrigin(roident: PgReplicationOriginId, roname: String = "roname")(implicit c: Connection): PgReplicationOriginRow = PgReplicationOriginRepoImpl.insert(new PgReplicationOriginRow(roident = roident, roname = roname))
  def pgCatalogPgRewrite(oid: PgRewriteId, evQual: TypoPgNodeTree, evAction: TypoPgNodeTree, rulename: String = "rulename", evClass: /* oid */ Long = 1L, evType: String = "ev_type", evEnabled: String = "ev_enabled", isInstead: Boolean = false)(implicit c: Connection): PgRewriteRow = PgRewriteRepoImpl.insert(new PgRewriteRow(oid = oid, evQual = evQual, evAction = evAction, rulename = rulename, evClass = evClass, evType = evType, evEnabled = evEnabled, isInstead = isInstead))
  def pgCatalogPgSeclabel(objoid: /* oid */ Long = 1L, classoid: /* oid */ Long = 1L, objsubid: Int = 1, provider: String = "provider", label: String = "label")(implicit c: Connection): PgSeclabelRow = PgSeclabelRepoImpl.insert(new PgSeclabelRow(objoid = objoid, classoid = classoid, objsubid = objsubid, provider = provider, label = label))
  def pgCatalogPgSequence(seqrelid: PgSequenceId, seqtypid: /* oid */ Long = 1L, seqstart: Long = 1L, seqincrement: Long = 1L, seqmax: Long = 1L, seqmin: Long = 1L, seqcache: Long = 1L, seqcycle: Boolean = false)(implicit c: Connection): PgSequenceRow = PgSequenceRepoImpl.insert(new PgSequenceRow(seqrelid = seqrelid, seqtypid = seqtypid, seqstart = seqstart, seqincrement = seqincrement, seqmax = seqmax, seqmin = seqmin, seqcache = seqcache, seqcycle = seqcycle))
  def pgCatalogPgShdepend(dbid: /* oid */ Long = 1L, classid: /* oid */ Long = 1L, objid: /* oid */ Long = 1L, objsubid: Int = 1, refclassid: /* oid */ Long = 1L, refobjid: /* oid */ Long = 1L, deptype: String = "deptype")(implicit c: Connection): PgShdependRow = PgShdependRepoImpl.insert(new PgShdependRow(dbid = dbid, classid = classid, objid = objid, objsubid = objsubid, refclassid = refclassid, refobjid = refobjid, deptype = deptype))
  def pgCatalogPgShdescription(objoid: /* oid */ Long = 1L, classoid: /* oid */ Long = 1L, description: String = "description")(implicit c: Connection): PgShdescriptionRow = PgShdescriptionRepoImpl.insert(new PgShdescriptionRow(objoid = objoid, classoid = classoid, description = description))
  def pgCatalogPgShseclabel(objoid: /* oid */ Long = 1L, classoid: /* oid */ Long = 1L, provider: String = "provider", label: String = "label")(implicit c: Connection): PgShseclabelRow = PgShseclabelRepoImpl.insert(new PgShseclabelRow(objoid = objoid, classoid = classoid, provider = provider, label = label))
  def pgCatalogPgStatistic(starelid: /* oid */ Long = 1L, staattnum: Int = 1, stainherit: Boolean = false, stanullfrac: Float = 1.0f, stawidth: Int = 1, stadistinct: Float = 1.0f, stakind1: Int = 1, stakind2: Int = 1, stakind3: Int = 1, stakind4: Int = 1, stakind5: Int = 1, staop1: /* oid */ Long = 1L, staop2: /* oid */ Long = 1L, staop3: /* oid */ Long = 1L, staop4: /* oid */ Long = 1L, staop5: /* oid */ Long = 1L, stacoll1: /* oid */ Long = 1L, stacoll2: /* oid */ Long = 1L, stacoll3: /* oid */ Long = 1L, stacoll4: /* oid */ Long = 1L, stacoll5: /* oid */ Long = 1L, stanumbers1: Option[Array[Float]] = None, stanumbers2: Option[Array[Float]] = None, stanumbers3: Option[Array[Float]] = None, stanumbers4: Option[Array[Float]] = None, stanumbers5: Option[Array[Float]] = None, stavalues1: Option[TypoAnyArray] = None, stavalues2: Option[TypoAnyArray] = None, stavalues3: Option[TypoAnyArray] = None, stavalues4: Option[TypoAnyArray] = None, stavalues5: Option[TypoAnyArray] = None)(implicit c: Connection): PgStatisticRow = PgStatisticRepoImpl.insert(new PgStatisticRow(starelid = starelid, staattnum = staattnum, stainherit = stainherit, stanullfrac = stanullfrac, stawidth = stawidth, stadistinct = stadistinct, stakind1 = stakind1, stakind2 = stakind2, stakind3 = stakind3, stakind4 = stakind4, stakind5 = stakind5, staop1 = staop1, staop2 = staop2, staop3 = staop3, staop4 = staop4, staop5 = staop5, stacoll1 = stacoll1, stacoll2 = stacoll2, stacoll3 = stacoll3, stacoll4 = stacoll4, stacoll5 = stacoll5, stanumbers1 = stanumbers1, stanumbers2 = stanumbers2, stanumbers3 = stanumbers3, stanumbers4 = stanumbers4, stanumbers5 = stanumbers5, stavalues1 = stavalues1, stavalues2 = stavalues2, stavalues3 = stavalues3, stavalues4 = stavalues4, stavalues5 = stavalues5))
  def pgCatalogPgStatisticExt(oid: PgStatisticExtId, stxkeys: TypoInt2Vector, stxrelid: /* oid */ Long = 1L, stxname: String = "stxname", stxnamespace: /* oid */ Long = 1L, stxowner: /* oid */ Long = 1L, stxstattarget: Int = 1, stxkind: Array[String] = Array.empty, stxexprs: Option[TypoPgNodeTree] = None)(implicit c: Connection): PgStatisticExtRow = PgStatisticExtRepoImpl.insert(new PgStatisticExtRow(oid = oid, stxkeys = stxkeys, stxrelid = stxrelid, stxname = stxname, stxnamespace = stxnamespace, stxowner = stxowner, stxstattarget = stxstattarget, stxkind = stxkind, stxexprs = stxexprs))
  def pgCatalogPgStatisticExtData(stxoid: PgStatisticExtDataId, stxdndistinct: Option[String] = None, stxddependencies: Option[String] = None, stxdmcv: Option[String] = None, stxdexpr: Option[String] = None)(implicit c: Connection): PgStatisticExtDataRow = PgStatisticExtDataRepoImpl.insert(new PgStatisticExtDataRow(stxoid = stxoid, stxdndistinct = stxdndistinct, stxddependencies = stxddependencies, stxdmcv = stxdmcv, stxdexpr = stxdexpr))
  def pgCatalogPgSubscription(oid: PgSubscriptionId, subdbid: /* oid */ Long = 1L, subname: String = "subname", subowner: /* oid */ Long = 1L, subenabled: Boolean = false, subbinary: Boolean = false, substream: Boolean = false, subconninfo: String = "subconninfo", subslotname: Option[String] = None, subsynccommit: String = "subsynccommit", subpublications: Array[String] = Array.empty)(implicit c: Connection): PgSubscriptionRow = PgSubscriptionRepoImpl.insert(new PgSubscriptionRow(oid = oid, subdbid = subdbid, subname = subname, subowner = subowner, subenabled = subenabled, subbinary = subbinary, substream = substream, subconninfo = subconninfo, subslotname = subslotname, subsynccommit = subsynccommit, subpublications = subpublications))
  def pgCatalogPgSubscriptionRel(srsubid: /* oid */ Long = 1L, srrelid: /* oid */ Long = 1L, srsubstate: String = "srsubstate", srsublsn: Option[/* pg_lsn */ Long] = None)(implicit c: Connection): PgSubscriptionRelRow = PgSubscriptionRelRepoImpl.insert(new PgSubscriptionRelRow(srsubid = srsubid, srrelid = srrelid, srsubstate = srsubstate, srsublsn = srsublsn))
  def pgCatalogPgTablespace(oid: PgTablespaceId, spcname: String = "spcname", spcowner: /* oid */ Long = 1L, spcacl: Option[Array[TypoAclItem]] = None, spcoptions: Option[Array[String]] = None)(implicit c: Connection): PgTablespaceRow = PgTablespaceRepoImpl.insert(new PgTablespaceRow(oid = oid, spcname = spcname, spcowner = spcowner, spcacl = spcacl, spcoptions = spcoptions))
  def pgCatalogPgTransform(oid: PgTransformId, trffromsql: TypoRegproc, trftosql: TypoRegproc, trftype: /* oid */ Long = 1L, trflang: /* oid */ Long = 1L)(implicit c: Connection): PgTransformRow = PgTransformRepoImpl.insert(new PgTransformRow(oid = oid, trffromsql = trffromsql, trftosql = trftosql, trftype = trftype, trflang = trflang))
  def pgCatalogPgTrigger(oid: PgTriggerId, tgattr: TypoInt2Vector, tgrelid: /* oid */ Long = 1L, tgparentid: /* oid */ Long = 1L, tgname: String = "tgname", tgfoid: /* oid */ Long = 1L, tgtype: Int = 1, tgenabled: String = "tgenabled", tgisinternal: Boolean = false, tgconstrrelid: /* oid */ Long = 1L, tgconstrindid: /* oid */ Long = 1L, tgconstraint: /* oid */ Long = 1L, tgdeferrable: Boolean = false, tginitdeferred: Boolean = false, tgnargs: Int = 1, tgargs: Array[Byte] = Array.empty, tgqual: Option[TypoPgNodeTree] = None, tgoldtable: Option[String] = None, tgnewtable: Option[String] = None)(implicit c: Connection): PgTriggerRow = PgTriggerRepoImpl.insert(new PgTriggerRow(oid = oid, tgattr = tgattr, tgrelid = tgrelid, tgparentid = tgparentid, tgname = tgname, tgfoid = tgfoid, tgtype = tgtype, tgenabled = tgenabled, tgisinternal = tgisinternal, tgconstrrelid = tgconstrrelid, tgconstrindid = tgconstrindid, tgconstraint = tgconstraint, tgdeferrable = tgdeferrable, tginitdeferred = tginitdeferred, tgnargs = tgnargs, tgargs = tgargs, tgqual = tgqual, tgoldtable = tgoldtable, tgnewtable = tgnewtable))
  def pgCatalogPgTsConfig(oid: PgTsConfigId, cfgname: String = "cfgname", cfgnamespace: /* oid */ Long = 1L, cfgowner: /* oid */ Long = 1L, cfgparser: /* oid */ Long = 1L)(implicit c: Connection): PgTsConfigRow = PgTsConfigRepoImpl.insert(new PgTsConfigRow(oid = oid, cfgname = cfgname, cfgnamespace = cfgnamespace, cfgowner = cfgowner, cfgparser = cfgparser))
  def pgCatalogPgTsConfigMap(mapcfg: /* oid */ Long = 1L, maptokentype: Int = 1, mapseqno: Int = 1, mapdict: /* oid */ Long = 1L)(implicit c: Connection): PgTsConfigMapRow = PgTsConfigMapRepoImpl.insert(new PgTsConfigMapRow(mapcfg = mapcfg, maptokentype = maptokentype, mapseqno = mapseqno, mapdict = mapdict))
  def pgCatalogPgTsDict(oid: PgTsDictId, dictname: String = "dictname", dictnamespace: /* oid */ Long = 1L, dictowner: /* oid */ Long = 1L, dicttemplate: /* oid */ Long = 1L, dictinitoption: Option[String] = None)(implicit c: Connection): PgTsDictRow = PgTsDictRepoImpl.insert(new PgTsDictRow(oid = oid, dictname = dictname, dictnamespace = dictnamespace, dictowner = dictowner, dicttemplate = dicttemplate, dictinitoption = dictinitoption))
  def pgCatalogPgTsParser(oid: PgTsParserId, prsstart: TypoRegproc, prstoken: TypoRegproc, prsend: TypoRegproc, prsheadline: TypoRegproc, prslextype: TypoRegproc, prsname: String = "prsname", prsnamespace: /* oid */ Long = 1L)(implicit c: Connection): PgTsParserRow = PgTsParserRepoImpl.insert(new PgTsParserRow(oid = oid, prsstart = prsstart, prstoken = prstoken, prsend = prsend, prsheadline = prsheadline, prslextype = prslextype, prsname = prsname, prsnamespace = prsnamespace))
  def pgCatalogPgTsTemplate(oid: PgTsTemplateId, tmplinit: TypoRegproc, tmpllexize: TypoRegproc, tmplname: String = "tmplname", tmplnamespace: /* oid */ Long = 1L)(implicit c: Connection): PgTsTemplateRow = PgTsTemplateRepoImpl.insert(new PgTsTemplateRow(oid = oid, tmplinit = tmplinit, tmpllexize = tmpllexize, tmplname = tmplname, tmplnamespace = tmplnamespace))
  def pgCatalogPgType(oid: PgTypeId, typsubscript: TypoRegproc, typinput: TypoRegproc, typoutput: TypoRegproc, typreceive: TypoRegproc, typsend: TypoRegproc, typmodin: TypoRegproc, typmodout: TypoRegproc, typanalyze: TypoRegproc, typname: String = "typname", typnamespace: /* oid */ Long = 1L, typowner: /* oid */ Long = 1L, typlen: Int = 1, typbyval: Boolean = false, typtype: String = "typtype", typcategory: String = "typcategory", typispreferred: Boolean = false, typisdefined: Boolean = false, typdelim: String = "typdelim", typrelid: /* oid */ Long = 1L, typelem: /* oid */ Long = 1L, typarray: /* oid */ Long = 1L, typalign: String = "typalign", typstorage: String = "typstorage", typnotnull: Boolean = false, typbasetype: /* oid */ Long = 1L, typtypmod: Int = 1, typndims: Int = 1, typcollation: /* oid */ Long = 1L, typdefaultbin: Option[TypoPgNodeTree] = None, typdefault: Option[String] = None, typacl: Option[Array[TypoAclItem]] = None)(implicit c: Connection): PgTypeRow = PgTypeRepoImpl.insert(new PgTypeRow(oid = oid, typsubscript = typsubscript, typinput = typinput, typoutput = typoutput, typreceive = typreceive, typsend = typsend, typmodin = typmodin, typmodout = typmodout, typanalyze = typanalyze, typname = typname, typnamespace = typnamespace, typowner = typowner, typlen = typlen, typbyval = typbyval, typtype = typtype, typcategory = typcategory, typispreferred = typispreferred, typisdefined = typisdefined, typdelim = typdelim, typrelid = typrelid, typelem = typelem, typarray = typarray, typalign = typalign, typstorage = typstorage, typnotnull = typnotnull, typbasetype = typbasetype, typtypmod = typtypmod, typndims = typndims, typcollation = typcollation, typdefaultbin = typdefaultbin, typdefault = typdefault, typacl = typacl))
  def pgCatalogPgUserMapping(oid: PgUserMappingId, umuser: /* oid */ Long = 1L, umserver: /* oid */ Long = 1L, umoptions: Option[Array[String]] = None)(implicit c: Connection): PgUserMappingRow = PgUserMappingRepoImpl.insert(new PgUserMappingRow(oid = oid, umuser = umuser, umserver = umserver, umoptions = umoptions))
  def productionBillofmaterials(componentid: ProductId, unitmeasurecode: UnitmeasureId, productassemblyid: Option[ProductId] = None, enddate: Option[TypoLocalDateTime] = None, bomlevel: Int = 1, billofmaterialsid: Defaulted[BillofmaterialsId] = Defaulted.UseDefault, startdate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault, perassemblyqty: Defaulted[BigDecimal] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): BillofmaterialsRow = BillofmaterialsRepoImpl.insert(new BillofmaterialsRowUnsaved(componentid = componentid, unitmeasurecode = unitmeasurecode, productassemblyid = productassemblyid, enddate = enddate, bomlevel = bomlevel, billofmaterialsid = billofmaterialsid, startdate = startdate, perassemblyqty = perassemblyqty, modifieddate = modifieddate))
  def productionCulture(cultureid: CultureId, name: Name, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): CultureRow = CultureRepoImpl.insert(new CultureRowUnsaved(cultureid = cultureid, name = name, modifieddate = modifieddate))
  def productionDocument(owner: BusinessentityId, title: /* max 50 chars */ String = "title", filename: /* max 400 chars */ String = "filename", fileextension: Option[/* max 8 chars */ String] = None, revision: /* bpchar */ String = "revision", status: Int = 1, documentsummary: Option[String] = None, document: Option[Array[Byte]] = None, folderflag: Defaulted[Flag] = Defaulted.UseDefault, changenumber: Defaulted[Int] = Defaulted.UseDefault, rowguid: Defaulted[UUID] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault, documentnode: Defaulted[DocumentId] = Defaulted.UseDefault)(implicit c: Connection): DocumentRow = DocumentRepoImpl.insert(new DocumentRowUnsaved(owner = owner, title = title, filename = filename, fileextension = fileextension, revision = revision, status = status, documentsummary = documentsummary, document = document, folderflag = folderflag, changenumber = changenumber, rowguid = rowguid, modifieddate = modifieddate, documentnode = documentnode))
  ...
  def productionProductinventory(productid: ProductId, locationid: LocationId, shelf: /* max 10 chars */ String = "shelf", bin: Int = 1, quantity: Defaulted[Int] = Defaulted.UseDefault, rowguid: Defaulted[UUID] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): ProductinventoryRow = ProductinventoryRepoImpl.insert(new ProductinventoryRowUnsaved(productid = productid, locationid = locationid, shelf = shelf, bin = bin, quantity = quantity, rowguid = rowguid, modifieddate = modifieddate))
  def productionProductlistpricehistory(productid: ProductId, listprice: BigDecimal, startdate: TypoLocalDateTime = TypoLocalDateTime.now, enddate: Option[TypoLocalDateTime] = None, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): ProductlistpricehistoryRow = ProductlistpricehistoryRepoImpl.insert(new ProductlistpricehistoryRowUnsaved(productid = productid, listprice = listprice, startdate = startdate, enddate = enddate, modifieddate = modifieddate))
  def productionProductmodel(name: Name, catalogdescription: Option[TypoXml] = None, instructions: Option[TypoXml] = None, productmodelid: Defaulted[ProductmodelId] = Defaulted.UseDefault, rowguid: Defaulted[UUID] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): ProductmodelRow = ProductmodelRepoImpl.insert(new ProductmodelRowUnsaved(name = name, catalogdescription = catalogdescription, instructions = instructions, productmodelid = productmodelid, rowguid = rowguid, modifieddate = modifieddate))
  ...
  def productionProductsubcategory(productcategoryid: ProductcategoryId, name: Name, productsubcategoryid: Defaulted[ProductsubcategoryId] = Defaulted.UseDefault, rowguid: Defaulted[UUID] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): ProductsubcategoryRow = ProductsubcategoryRepoImpl.insert(new ProductsubcategoryRowUnsaved(productcategoryid = productcategoryid, name = name, productsubcategoryid = productsubcategoryid, rowguid = rowguid, modifieddate = modifieddate))
  def productionScrapreason(name: Name, scrapreasonid: Defaulted[ScrapreasonId] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): ScrapreasonRow = ScrapreasonRepoImpl.insert(new ScrapreasonRowUnsaved(name = name, scrapreasonid = scrapreasonid, modifieddate = modifieddate))
  def productionTransactionhistory(productid: ProductId, actualcost: BigDecimal, referenceorderid: Int = 1, transactiontype: /* bpchar */ String = "transactiontype", quantity: Int = 1, transactionid: Defaulted[TransactionhistoryId] = Defaulted.UseDefault, referenceorderlineid: Defaulted[Int] = Defaulted.UseDefault, transactiondate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): TransactionhistoryRow = TransactionhistoryRepoImpl.insert(new TransactionhistoryRowUnsaved(productid = productid, actualcost = actualcost, referenceorderid = referenceorderid, transactiontype = transactiontype, quantity = quantity, transactionid = transactionid, referenceorderlineid = referenceorderlineid, transactiondate = transactiondate, modifieddate = modifieddate))
  ...
  def purchasingShipmethod(name: Name, shipmethodid: Defaulted[ShipmethodId] = Defaulted.UseDefault, shipbase: Defaulted[BigDecimal] = Defaulted.UseDefault, shiprate: Defaulted[BigDecimal] = Defaulted.UseDefault, rowguid: Defaulted[UUID] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): ShipmethodRow = ShipmethodRepoImpl.insert(new ShipmethodRowUnsaved(name = name, shipmethodid = shipmethodid, shipbase = shipbase, shiprate = shiprate, rowguid = rowguid, modifieddate = modifieddate))
  def purchasingVendor(businessentityid: BusinessentityId, accountnumber: AccountNumber, name: Name, creditrating: Int = 1, purchasingwebserviceurl: Option[/* max 1024 chars */ String] = None, preferredvendorstatus: Defaulted[Flag] = Defaulted.UseDefault, activeflag: Defaulted[Flag] = Defaulted.UseDefault, modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault)(implicit c: Connection): VendorRow = VendorRepoImpl.insert(new VendorRowUnsaved(businessentityid = businessentityid, accountnumber = accountnumber, name = name, creditrating = creditrating, purchasingwebserviceurl = purchasingwebserviceurl, preferredvendorstatus = preferredvendorstatus, activeflag = activeflag, modifieddate = modifieddate))
