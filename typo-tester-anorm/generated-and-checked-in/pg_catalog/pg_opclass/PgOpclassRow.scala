...
object PgOpclassRow {
  implicit lazy val reads: Reads[PgOpclassRow] = Reads[PgOpclassRow](json => JsResult.fromTry(
      Try(
        PgOpclassRow(
  ...
  implicit lazy val writes: OWrites[PgOpclassRow] = OWrites[PgOpclassRow](o =>
