...
object PgPolicyId {
  ...
  implicit val reads: Reads[PgPolicyId] = implicitly[Reads[/* oid */ Long]].map(PgPolicyId.apply)
  implicit val toStatement: ToStatement[PgPolicyId] = implicitly[ToStatement[/* oid */ Long]].contramap(_.value)
  implicit val writes: Writes[PgPolicyId] = implicitly[Writes[/* oid */ Long]].contramap(_.value)
}
