...
object PgShseclabelRow {
  implicit lazy val reads: Reads[PgShseclabelRow] = Reads[PgShseclabelRow](json => JsResult.fromTry(
      Try(
        PgShseclabelRow(
  ...
  implicit lazy val writes: OWrites[PgShseclabelRow] = OWrites[PgShseclabelRow](o =>
