...
object PgNamespaceId {
  ...
  implicit val reads: Reads[PgNamespaceId] = implicitly[Reads[/* oid */ Long]].map(PgNamespaceId.apply)
  implicit val toStatement: ToStatement[PgNamespaceId] = implicitly[ToStatement[/* oid */ Long]].contramap(_.value)
  implicit val writes: Writes[PgNamespaceId] = implicitly[Writes[/* oid */ Long]].contramap(_.value)
}
