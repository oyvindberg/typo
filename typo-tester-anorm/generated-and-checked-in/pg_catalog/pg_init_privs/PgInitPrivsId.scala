...
object PgInitPrivsId {
  ...
  implicit lazy val reads: Reads[PgInitPrivsId] = Reads[PgInitPrivsId](json => JsResult.fromTry(
      Try(
        PgInitPrivsId(
  ...
  implicit lazy val writes: OWrites[PgInitPrivsId] = OWrites[PgInitPrivsId](o =>
