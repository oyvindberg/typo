...
object PgStatSysIndexesViewRow {
  def rowParser(idx: Int): RowParser[PgStatSysIndexesViewRow] =
    RowParser[PgStatSysIndexesViewRow] { row =>
      Success(
  ...
  implicit val oFormat: OFormat[PgStatSysIndexesViewRow] = new OFormat[PgStatSysIndexesViewRow]{
    override def writes(o: PgStatSysIndexesViewRow): JsObject =
      Json.obj(
        "relid" -> o.relid,
    ...
    override def reads(json: JsValue): JsResult[PgStatSysIndexesViewRow] = {
      JsResult.fromTry(
        Try(
          PgStatSysIndexesViewRow(
