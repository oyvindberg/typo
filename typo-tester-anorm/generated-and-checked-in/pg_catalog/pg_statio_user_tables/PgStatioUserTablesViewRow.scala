...
object PgStatioUserTablesViewRow {
  def rowParser(idx: Int): RowParser[PgStatioUserTablesViewRow] =
    RowParser[PgStatioUserTablesViewRow] { row =>
      Success(
  ...
  implicit val oFormat: OFormat[PgStatioUserTablesViewRow] = new OFormat[PgStatioUserTablesViewRow]{
    override def writes(o: PgStatioUserTablesViewRow): JsObject =
      Json.obj(
        "relid" -> o.relid,
    ...
    override def reads(json: JsValue): JsResult[PgStatioUserTablesViewRow] = {
      JsResult.fromTry(
        Try(
          PgStatioUserTablesViewRow(
