...
object VvendorwithcontactsViewFieldValue {
  ...
  case class title(override val value: Option[String]) extends VvendorwithcontactsViewFieldValue("title", value)
  ...
  case class suffix(override val value: Option[String]) extends VvendorwithcontactsViewFieldValue("suffix", value)
  ...
  case class emailaddress(override val value: Option[String]) extends VvendorwithcontactsViewFieldValue("emailaddress", value)
