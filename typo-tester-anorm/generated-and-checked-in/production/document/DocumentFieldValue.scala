...
object DocumentFieldValue {
  case class title(override val value: /* max 50 chars */ String) extends DocumentFieldValue("title", value)
  ...
  case class filename(override val value: /* max 400 chars */ String) extends DocumentFieldValue("filename", value)
  case class fileextension(override val value: Option[/* max 8 chars */ String]) extends DocumentFieldValue("fileextension", value)
