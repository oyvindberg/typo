...
object TypoCircle {
  implicit val arrayColumn: Column[Array[TypoCircle]] = Column.nonNull[Array[TypoCircle]]((v1: Any, _) =>
    v1 match {
        case v: PgArray =>
         v.getArray match {
           case v: Array[?] =>
  ...
  implicit val arrayParameterMetaData: ParameterMetaData[Array[TypoCircle]] = new ParameterMetaData[Array[TypoCircle]] {
    override def sqlType: String = "_circle"
    override def jdbcType: Int = Types.ARRAY
  }
  implicit val arrayToStatement: ToStatement[Array[TypoCircle]] = ToStatement[Array[TypoCircle]]((s, index, v) => s.setArray(index, s.getConnection.createArrayOf("circle", v.map(v => new PGcircle(v.center.x, v.center.y, v.radius)))))
  implicit val column: Column[TypoCircle] = Column.nonNull[TypoCircle]((v1: Any, _) =>
    v1 match {
