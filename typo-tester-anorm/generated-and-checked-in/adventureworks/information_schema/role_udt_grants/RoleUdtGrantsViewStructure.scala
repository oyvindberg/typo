...
class RoleUdtGrantsViewStructure[Row](val prefix: Option[String], val extract: Row => RoleUdtGrantsViewRow, val merge: (Row, RoleUdtGrantsViewRow) => Row)
  ...
  override val udtCatalog = new OptField[/* nullability unknown */ String, Row](prefix, "udt_catalog", None, None)(x => extract(x).udtCatalog, (row, value) => merge(row, extract(row).copy(udtCatalog = value)))
  override val udtSchema = new OptField[/* nullability unknown */ String, Row](prefix, "udt_schema", None, None)(x => extract(x).udtSchema, (row, value) => merge(row, extract(row).copy(udtSchema = value)))
  override val udtName = new OptField[/* nullability unknown */ String, Row](prefix, "udt_name", None, None)(x => extract(x).udtName, (row, value) => merge(row, extract(row).copy(udtName = value)))
