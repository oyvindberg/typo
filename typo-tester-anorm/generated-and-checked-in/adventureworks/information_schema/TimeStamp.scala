...
object TimeStamp {
  ...
  implicit lazy val arrayToStatement: ToStatement[Array[TimeStamp]] = TypoOffsetDateTime.arrayToStatement.contramap(_.map(_.value))
  ...
  implicit lazy val column: Column[TimeStamp] = TypoOffsetDateTime.column.map(TimeStamp.apply)
  ...
  implicit lazy val parameterMetadata: ParameterMetaData[TimeStamp] = new ParameterMetaData[TimeStamp] {
    override def sqlType: String = TypoOffsetDateTime.parameterMetadata.sqlType
    override def jdbcType: Int = TypoOffsetDateTime.parameterMetadata.jdbcType
  }
  implicit lazy val reads: Reads[TimeStamp] = TypoOffsetDateTime.reads.map(TimeStamp.apply)
  implicit lazy val toStatement: ToStatement[TimeStamp] = TypoOffsetDateTime.toStatement.contramap(_.value)
