  ...
  def rowParser(idx: Int): RowParser[DomainsViewRow] = RowParser[DomainsViewRow] { row =>
    Success(
      DomainsViewRow(
        ...
        characterMaximumLength = row(idx + 4)(Column.columnToOption(Column.columnToInt)),
        characterOctetLength = row(idx + 5)(Column.columnToOption(Column.columnToInt)),
        characterSetCatalog = row(idx + 6)(Column.columnToOption(Column.columnToString)),
        characterSetSchema = row(idx + 7)(Column.columnToOption(Column.columnToString)),
        characterSetName = row(idx + 8)(Column.columnToOption(Column.columnToString)),
        collationCatalog = row(idx + 9)(Column.columnToOption(Column.columnToString)),
        collationSchema = row(idx + 10)(Column.columnToOption(Column.columnToString)),
        collationName = row(idx + 11)(Column.columnToOption(Column.columnToString)),
        numericPrecision = row(idx + 12)(Column.columnToOption(Column.columnToInt)),
        numericPrecisionRadix = row(idx + 13)(Column.columnToOption(Column.columnToInt)),
        numericScale = row(idx + 14)(Column.columnToOption(Column.columnToInt)),
        datetimePrecision = row(idx + 15)(Column.columnToOption(Column.columnToInt)),
        intervalType = row(idx + 16)(Column.columnToOption(Column.columnToString)),
        intervalPrecision = row(idx + 17)(Column.columnToOption(Column.columnToInt)),
        domainDefault = row(idx + 18)(Column.columnToOption(Column.columnToString)),
        udtCatalog = row(idx + 19)(Column.columnToOption(Column.columnToString)),
        udtSchema = row(idx + 20)(Column.columnToOption(Column.columnToString)),
        udtName = row(idx + 21)(Column.columnToOption(Column.columnToString)),
        scopeCatalog = row(idx + 22)(Column.columnToOption(Column.columnToString)),
        scopeSchema = row(idx + 23)(Column.columnToOption(Column.columnToString)),
        scopeName = row(idx + 24)(Column.columnToOption(Column.columnToString)),
        maximumCardinality = row(idx + 25)(Column.columnToOption(Column.columnToInt)),
        dtdIdentifier = row(idx + 26)(Column.columnToOption(Column.columnToString))
      )
    )
  }
