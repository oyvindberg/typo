...
object AttributesViewRow {
  implicit lazy val reads: Reads[AttributesViewRow] = Reads[AttributesViewRow](json => JsResult.fromTry(
      Try(
        AttributesViewRow(
          ...
          attributeName = json.\("attribute_name").toOption.map(_.as(Reads.StringReads)),
          ordinalPosition = json.\("ordinal_position").toOption.map(_.as(Reads.IntReads)),
          attributeDefault = json.\("attribute_default").toOption.map(_.as(Reads.StringReads)),
          ...
          attributeUdtCatalog = json.\("attribute_udt_catalog").toOption.map(_.as(Reads.StringReads)),
          attributeUdtSchema = json.\("attribute_udt_schema").toOption.map(_.as(Reads.StringReads)),
          attributeUdtName = json.\("attribute_udt_name").toOption.map(_.as(Reads.StringReads)),
          ...
          isDerivedReferenceAttribute = json.\("is_derived_reference_attribute").toOption.map(_.as(Reads.StringReads))
        )
      )
    ),
  )
  def rowParser(idx: Int): RowParser[AttributesViewRow] = RowParser[AttributesViewRow] { row =>
    Success(
      AttributesViewRow(
        ...
        attributeName = row(idx + 3)(Column.columnToOption(Column.columnToString)),
        ordinalPosition = row(idx + 4)(Column.columnToOption(Column.columnToInt)),
        attributeDefault = row(idx + 5)(Column.columnToOption(Column.columnToString)),
        ...
        characterSetCatalog = row(idx + 10)(Column.columnToOption(Column.columnToString)),
        characterSetSchema = row(idx + 11)(Column.columnToOption(Column.columnToString)),
        characterSetName = row(idx + 12)(Column.columnToOption(Column.columnToString)),
        collationCatalog = row(idx + 13)(Column.columnToOption(Column.columnToString)),
        collationSchema = row(idx + 14)(Column.columnToOption(Column.columnToString)),
        collationName = row(idx + 15)(Column.columnToOption(Column.columnToString)),
        numericPrecision = row(idx + 16)(Column.columnToOption(Column.columnToInt)),
        numericPrecisionRadix = row(idx + 17)(Column.columnToOption(Column.columnToInt)),
        numericScale = row(idx + 18)(Column.columnToOption(Column.columnToInt)),
        datetimePrecision = row(idx + 19)(Column.columnToOption(Column.columnToInt)),
        intervalType = row(idx + 20)(Column.columnToOption(Column.columnToString)),
        intervalPrecision = row(idx + 21)(Column.columnToOption(Column.columnToInt)),
        attributeUdtCatalog = row(idx + 22)(Column.columnToOption(Column.columnToString)),
        attributeUdtSchema = row(idx + 23)(Column.columnToOption(Column.columnToString)),
        attributeUdtName = row(idx + 24)(Column.columnToOption(Column.columnToString)),
        scopeCatalog = row(idx + 25)(Column.columnToOption(Column.columnToString)),
        scopeSchema = row(idx + 26)(Column.columnToOption(Column.columnToString)),
        scopeName = row(idx + 27)(Column.columnToOption(Column.columnToString)),
        maximumCardinality = row(idx + 28)(Column.columnToOption(Column.columnToInt)),
        dtdIdentifier = row(idx + 29)(Column.columnToOption(Column.columnToString)),
        isDerivedReferenceAttribute = row(idx + 30)(Column.columnToOption(Column.columnToString))
      )
    )
  }
  implicit lazy val writes: OWrites[AttributesViewRow] = OWrites[AttributesViewRow](o =>
    new JsObject(ListMap[String, JsValue](
      ...
      "attribute_name" -> Writes.OptionWrites(Writes.StringWrites).writes(o.attributeName),
      "ordinal_position" -> Writes.OptionWrites(Writes.IntWrites).writes(o.ordinalPosition),
      "attribute_default" -> Writes.OptionWrites(Writes.StringWrites).writes(o.attributeDefault),
      ...
      "attribute_udt_catalog" -> Writes.OptionWrites(Writes.StringWrites).writes(o.attributeUdtCatalog),
      "attribute_udt_schema" -> Writes.OptionWrites(Writes.StringWrites).writes(o.attributeUdtSchema),
      "attribute_udt_name" -> Writes.OptionWrites(Writes.StringWrites).writes(o.attributeUdtName),
      ...
      "is_derived_reference_attribute" -> Writes.OptionWrites(Writes.StringWrites).writes(o.isDerivedReferenceAttribute)
    ))
  )
}
