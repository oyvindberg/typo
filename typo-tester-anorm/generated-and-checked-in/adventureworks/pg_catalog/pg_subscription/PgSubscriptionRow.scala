...
object PgSubscriptionRow {
  implicit lazy val reads: Reads[PgSubscriptionRow] = Reads[PgSubscriptionRow](json => JsResult.fromTry(
      Try(
        PgSubscriptionRow(
  ...
  implicit lazy val writes: OWrites[PgSubscriptionRow] = OWrites[PgSubscriptionRow](o =>
