...
class PgStatSysTablesViewStructure[Row](val prefix: Option[String], val extract: Row => PgStatSysTablesViewRow, val merge: (Row, PgStatSysTablesViewRow) => Row)
  ...
  override def copy[NewRow](prefix: Option[String], extract: NewRow => PgStatSysTablesViewRow, merge: (NewRow, PgStatSysTablesViewRow) => NewRow): PgStatSysTablesViewStructure[NewRow] =
    new PgStatSysTablesViewStructure(prefix, extract, merge)
}
