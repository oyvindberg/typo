  ...
  override def update(row: PgConstraintRow)(implicit c: Connection): Boolean = {
    ...
    SQL"""update pg_catalog.pg_constraint
          set "conname" = ${ParameterValue(row.conname, null, ToStatement.stringToStatement)}::name,
              ...
              "conkey" = ${ParameterValue(row.conkey, null, ToStatement.optionToStatement(TypoShort.arrayToStatement, adventureworks.arrayParameterMetaData(TypoShort.parameterMetadata)))}::_int2,
              "confkey" = ${ParameterValue(row.confkey, null, ToStatement.optionToStatement(TypoShort.arrayToStatement, adventureworks.arrayParameterMetaData(TypoShort.parameterMetadata)))}::_int2,
  ...
  override def upsert(unsaved: PgConstraintRow)(implicit c: Connection): PgConstraintRow = {
    SQL"""insert into pg_catalog.pg_constraint("oid", "conname", "connamespace", "contype", "condeferrable", "condeferred", "convalidated", "conrelid", "contypid", "conindid", "conparentid", "confrelid", "confupdtype", "confdeltype", "confmatchtype", "conislocal", "coninhcount", "connoinherit", "conkey", "confkey", "conpfeqop", "conppeqop", "conffeqop", "conexclop", "conbin")
          values (
            ...
            ${ParameterValue(unsaved.conkey, null, ToStatement.optionToStatement(TypoShort.arrayToStatement, adventureworks.arrayParameterMetaData(TypoShort.parameterMetadata)))}::_int2,
            ${ParameterValue(unsaved.confkey, null, ToStatement.optionToStatement(TypoShort.arrayToStatement, adventureworks.arrayParameterMetaData(TypoShort.parameterMetadata)))}::_int2,
