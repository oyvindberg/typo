...
object PgLocksViewRow {
  implicit lazy val reads: Reads[PgLocksViewRow] = Reads[PgLocksViewRow](json => JsResult.fromTry(
      Try(
        PgLocksViewRow(
          ...
          tuple = json.\("tuple").toOption.map(_.as(TypoShort.reads)),
          ...
          objsubid = json.\("objsubid").toOption.map(_.as(TypoShort.reads)),
  ...
  def rowParser(idx: Int): RowParser[PgLocksViewRow] = RowParser[PgLocksViewRow] { row =>
    Success(
      PgLocksViewRow(
        ...
        tuple = row(idx + 4)(Column.columnToOption(TypoShort.column)),
        ...
        objsubid = row(idx + 9)(Column.columnToOption(TypoShort.column)),
  ...
  implicit lazy val writes: OWrites[PgLocksViewRow] = OWrites[PgLocksViewRow](o =>
    new JsObject(ListMap[String, JsValue](
      ...
      "tuple" -> Writes.OptionWrites(TypoShort.writes).writes(o.tuple),
      ...
      "objsubid" -> Writes.OptionWrites(TypoShort.writes).writes(o.objsubid),
