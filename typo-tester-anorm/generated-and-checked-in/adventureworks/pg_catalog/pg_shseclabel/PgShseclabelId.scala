...
object PgShseclabelId {
  ...
  implicit lazy val reads: Reads[PgShseclabelId] = Reads[PgShseclabelId](json => JsResult.fromTry(
      Try(
        PgShseclabelId(
  ...
  implicit lazy val writes: OWrites[PgShseclabelId] = OWrites[PgShseclabelId](o =>
