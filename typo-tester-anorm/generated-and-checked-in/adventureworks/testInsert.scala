...
class TestInsert(random: Random, domainInsert: TestDomainInsert) {
  ...
  def humanresourcesJobcandidate(businessentityid: Option[BusinessentityId] = None,
                                 ...
                                 modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault
                                )(implicit c: Connection): JobcandidateRow = (new JobcandidateRepoImpl).insert(new JobcandidateRowUnsaved(businessentityid = businessentityid, resume = resume, jobcandidateid = jobcandidateid, modifieddate = modifieddate))
  ...
  def personBusinessentitycontact(businessentityid: BusinessentityId,
                                  ...
                                  rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault,
                                  modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault
                                 )(implicit c: Connection): BusinessentitycontactRow = (new BusinessentitycontactRepoImpl).insert(new BusinessentitycontactRowUnsaved(businessentityid = businessentityid, personid = personid, contacttypeid = contacttypeid, rowguid = rowguid, modifieddate = modifieddate))
  def personContacttype(name: Name = domainInsert.publicName(random),
                        contacttypeid: Defaulted[ContacttypeId] = Defaulted.UseDefault,
                        modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault
                       )(implicit c: Connection): ContacttypeRow = (new ContacttypeRepoImpl).insert(new ContacttypeRowUnsaved(name = name, contacttypeid = contacttypeid, modifieddate = modifieddate))
  ...
  def personPersonphone(businessentityid: BusinessentityId,
                        ...
                        modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault
                       )(implicit c: Connection): PersonphoneRow = (new PersonphoneRepoImpl).insert(new PersonphoneRowUnsaved(businessentityid = businessentityid, phonenumbertypeid = phonenumbertypeid, phonenumber = phonenumber, modifieddate = modifieddate))
  def personPhonenumbertype(name: Name = domainInsert.publicName(random),
                            ...
                            modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault
                           )(implicit c: Connection): PhonenumbertypeRow = (new PhonenumbertypeRepoImpl).insert(new PhonenumbertypeRowUnsaved(name = name, phonenumbertypeid = phonenumbertypeid, modifieddate = modifieddate))
  ...
  def productionProductmodelillustration(productmodelid: ProductmodelId,
                                         ...
                                         modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault
                                        )(implicit c: Connection): ProductmodelillustrationRow = (new ProductmodelillustrationRepoImpl).insert(new ProductmodelillustrationRowUnsaved(productmodelid = productmodelid, illustrationid = illustrationid, modifieddate = modifieddate))
  def productionProductmodelproductdescriptionculture(productmodelid: ProductmodelId,
                                                      productdescriptionid: ProductdescriptionId,
                                                      cultureid: CultureId,
                                                      modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault
                                                     )(implicit c: Connection): ProductmodelproductdescriptioncultureRow = (new ProductmodelproductdescriptioncultureRepoImpl).insert(new ProductmodelproductdescriptioncultureRowUnsaved(productmodelid = productmodelid, productdescriptionid = productdescriptionid, cultureid = cultureid, modifieddate = modifieddate))
  ...
  def publicTitledperson(titleShort: TitleDomainId = TitleDomainId.All(random.nextInt(4)),
                         ...
                         name: String = random.alphanumeric.take(20).mkString
                        )(implicit c: Connection): TitledpersonRow = (new TitledpersonRepoImpl).insert(new TitledpersonRow(titleShort = titleShort, title = title, name = name))
  ...
  def salesCountryregioncurrency(countryregioncode: CountryregionId,
                                 ...
                                 modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault
                                )(implicit c: Connection): CountryregioncurrencyRow = (new CountryregioncurrencyRepoImpl).insert(new CountryregioncurrencyRowUnsaved(countryregioncode = countryregioncode, currencycode = currencycode, modifieddate = modifieddate))
  def salesCreditcard(cardtype: /* max 50 chars */ String = random.alphanumeric.take(20).mkString,
                      ...
                      modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault
                     )(implicit c: Connection): CreditcardRow = (new CreditcardRepoImpl).insert(new CreditcardRowUnsaved(cardtype = cardtype, cardnumber = cardnumber, expmonth = expmonth, expyear = expyear, creditcardid = creditcardid, modifieddate = modifieddate))
  def salesCurrency(currencycode: CurrencyId,
                    name: Name = domainInsert.publicName(random),
                    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault
                   )(implicit c: Connection): CurrencyRow = (new CurrencyRepoImpl).insert(new CurrencyRowUnsaved(currencycode = currencycode, name = name, modifieddate = modifieddate))
  def salesCurrencyrate(fromcurrencycode: CurrencyId,
                        ...
                        modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault
                       )(implicit c: Connection): CurrencyrateRow = (new CurrencyrateRepoImpl).insert(new CurrencyrateRowUnsaved(fromcurrencycode = fromcurrencycode, tocurrencycode = tocurrencycode, currencyratedate = currencyratedate, averagerate = averagerate, endofdayrate = endofdayrate, currencyrateid = currencyrateid, modifieddate = modifieddate))
  ...
  def salesSalestaxrate(stateprovinceid: StateprovinceId,
                        ...
                        rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault,
                        modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault
                       )(implicit c: Connection): SalestaxrateRow = (new SalestaxrateRepoImpl).insert(new SalestaxrateRowUnsaved(stateprovinceid = stateprovinceid, taxtype = taxtype, name = name, salestaxrateid = salestaxrateid, taxrate = taxrate, rowguid = rowguid, modifieddate = modifieddate))
  ...
  def salesStore(businessentityid: BusinessentityId,
                 ...
                 rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault,
                 modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault
                )(implicit c: Connection): StoreRow = (new StoreRepoImpl).insert(new StoreRowUnsaved(businessentityid = businessentityid, name = name, salespersonid = salespersonid, demographics = demographics, rowguid = rowguid, modifieddate = modifieddate))
}