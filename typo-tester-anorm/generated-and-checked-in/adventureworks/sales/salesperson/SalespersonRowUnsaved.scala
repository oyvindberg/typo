...
object SalespersonRowUnsaved {
  implicit lazy val reads: Reads[SalespersonRowUnsaved] = {
  ...
  implicit lazy val text: Text[SalespersonRowUnsaved] = {
  ...
  implicit lazy val writes: OWrites[SalespersonRowUnsaved] = {
