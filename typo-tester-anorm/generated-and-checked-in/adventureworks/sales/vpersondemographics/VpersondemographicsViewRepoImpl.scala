...
class VpersondemographicsViewRepoImpl extends VpersondemographicsViewRepo {
  def select: SelectBuilder[VpersondemographicsViewFields, VpersondemographicsViewRow] = SelectBuilderSql("sales.vpersondemographics", VpersondemographicsViewFields.structure, VpersondemographicsViewRow.rowParser)
