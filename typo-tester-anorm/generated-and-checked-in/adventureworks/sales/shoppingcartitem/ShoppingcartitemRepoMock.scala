...
class ShoppingcartitemRepoMock(val toRow: Function1[ShoppingcartitemRowUnsaved, ShoppingcartitemRow], val map: scala.collection.mutable.Map[ShoppingcartitemId, ShoppingcartitemRow] = scala.collection.mutable.Map.empty) extends ShoppingcartitemRepo {
  ...
  def deleteById(shoppingcartitemid: ShoppingcartitemId)(implicit c: Connection): Boolean = map.remove(shoppingcartitemid).isDefined
  def deleteByIds(shoppingcartitemids: Array[ShoppingcartitemId])(implicit c: Connection): Int = shoppingcartitemids.map(id => map.remove(id)).count(_.isDefined)
  ...
  def insert(unsaved: ShoppingcartitemRowUnsaved)(implicit c: Connection): ShoppingcartitemRow = insert(toRow(unsaved))
  ...
  def selectAll(implicit c: Connection): List[ShoppingcartitemRow] = map.values.toList
  def selectById(shoppingcartitemid: ShoppingcartitemId)(implicit c: Connection): Option[ShoppingcartitemRow] = map.get(shoppingcartitemid)
  def selectByIds(shoppingcartitemids: Array[ShoppingcartitemId])(implicit c: Connection): List[ShoppingcartitemRow] = shoppingcartitemids.flatMap(map.get).toList
