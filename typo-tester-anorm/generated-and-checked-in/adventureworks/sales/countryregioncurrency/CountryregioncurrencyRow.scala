...
object CountryregioncurrencyRow {
  ...
  implicit lazy val reads: Reads[CountryregioncurrencyRow] = {
    Reads[CountryregioncurrencyRow](json => JsResult.fromTry(
        Try(
  ...
  implicit lazy val writes: OWrites[CountryregioncurrencyRow] = {
    OWrites[CountryregioncurrencyRow](o =>
