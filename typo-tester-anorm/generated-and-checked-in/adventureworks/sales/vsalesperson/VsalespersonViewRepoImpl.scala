...
class VsalespersonViewRepoImpl extends VsalespersonViewRepo {
  def select: SelectBuilder[VsalespersonViewFields, VsalespersonViewRow] = SelectBuilderSql("sales.vsalesperson", VsalespersonViewFields.structure, VsalespersonViewRow.rowParser)
