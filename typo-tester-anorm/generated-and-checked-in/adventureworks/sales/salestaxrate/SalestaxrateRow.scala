...
object SalestaxrateRow {
  implicit lazy val reads: Reads[SalestaxrateRow] = {
    Reads[SalestaxrateRow](json => JsResult.fromTry(
        Try(
          SalestaxrateRow(
  ...
  implicit lazy val writes: OWrites[SalestaxrateRow] = {
    OWrites[SalestaxrateRow](o =>
