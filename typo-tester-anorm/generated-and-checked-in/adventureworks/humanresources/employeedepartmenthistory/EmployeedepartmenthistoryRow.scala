...
object EmployeedepartmenthistoryRow {
  ...
  implicit lazy val reads: Reads[EmployeedepartmenthistoryRow] = {
    Reads[EmployeedepartmenthistoryRow](json => JsResult.fromTry(
        Try(
  ...
  implicit lazy val writes: OWrites[EmployeedepartmenthistoryRow] = {
    OWrites[EmployeedepartmenthistoryRow](o =>
