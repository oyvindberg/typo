...
object ShipmethodRow {
  implicit lazy val reads: Reads[ShipmethodRow] = {
    Reads[ShipmethodRow](json => JsResult.fromTry(
        Try(
          ShipmethodRow(
  ...
  implicit lazy val writes: OWrites[ShipmethodRow] = {
    OWrites[ShipmethodRow](o =>
