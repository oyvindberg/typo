...
object ProductvendorRowUnsaved {
  implicit lazy val reads: Reads[ProductvendorRowUnsaved] = {
    Reads[ProductvendorRowUnsaved](json => JsResult.fromTry(
        Try(
  ...
  implicit lazy val writes: OWrites[ProductvendorRowUnsaved] = {
    OWrites[ProductvendorRowUnsaved](o =>
