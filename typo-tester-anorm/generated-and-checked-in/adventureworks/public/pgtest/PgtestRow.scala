  ...
  def rowParser(idx: Int): RowParser[PgtestRow] = RowParser[PgtestRow] { row =>
    Success(
      PgtestRow(
        ...
        vector = row(idx + 21)(TypoVector.column),
        boxes = row(idx + 22)(TypoBox.arrayColumn),
        circlees = row(idx + 23)(TypoCircle.arrayColumn),
        linees = row(idx + 24)(TypoLine.arrayColumn),
        lseges = row(idx + 25)(TypoLineSegment.arrayColumn),
        pathes = row(idx + 26)(TypoPath.arrayColumn),
        pointes = row(idx + 27)(TypoPoint.arrayColumn),
        polygones = row(idx + 28)(TypoPolygon.arrayColumn),
        intervales = row(idx + 29)(TypoInterval.arrayColumn),
        moneyes = row(idx + 30)(TypoMoney.arrayColumn),
        xmles = row(idx + 31)(TypoXml.arrayColumn),
        jsones = row(idx + 32)(TypoJson.arrayColumn),
        jsonbes = row(idx + 33)(TypoJsonb.arrayColumn),
