...
object PgtestRow {
  implicit lazy val reads: Reads[PgtestRow] = Reads[PgtestRow](json => JsResult.fromTry(
      Try(
        PgtestRow(
          ...
          bpchares = json.\("bpchares").as(Reads.ArrayReads[String](Reads.StringReads, implicitly)),
          chares = json.\("chares").as(Reads.ArrayReads[String](Reads.StringReads, implicitly)),
          circlees = json.\("circlees").as(Reads.ArrayReads[TypoCircle](TypoCircle.reads, implicitly)),
          datees = json.\("datees").as(Reads.ArrayReads[TypoLocalDate](TypoLocalDate.reads, implicitly)),
          float4es = json.\("float4es").as(Reads.ArrayReads[Float](Reads.FloatReads, implicitly)),
          float8es = json.\("float8es").as(Reads.ArrayReads[Double](Reads.DoubleReads, implicitly)),
          inetes = json.\("inetes").as(Reads.ArrayReads[TypoInet](TypoInet.reads, implicitly)),
          int2es = json.\("int2es").as(Reads.ArrayReads[TypoShort](TypoShort.reads, implicitly)),
          int2vectores = json.\("int2vectores").as(Reads.ArrayReads[TypoInt2Vector](TypoInt2Vector.reads, implicitly)),
          int4es = json.\("int4es").as(Reads.ArrayReads[Int](Reads.IntReads, implicitly)),
          int8es = json.\("int8es").as(Reads.ArrayReads[Long](Reads.LongReads, implicitly)),
          ...
          myenumes = json.\("myenumes").as(Reads.ArrayReads[Myenum](Myenum.reads, implicitly)),
          namees = json.\("namees").as(Reads.ArrayReads[String](Reads.StringReads, implicitly)),
          numerices = json.\("numerices").as(Reads.ArrayReads[BigDecimal](Reads.bigDecReads, implicitly)),
          ...
          textes = json.\("textes").as(Reads.ArrayReads[String](Reads.StringReads, implicitly)),
          timees = json.\("timees").as(Reads.ArrayReads[TypoLocalTime](TypoLocalTime.reads, implicitly)),
          timestampes = json.\("timestampes").as(Reads.ArrayReads[TypoLocalDateTime](TypoLocalDateTime.reads, implicitly)),
          timestampzes = json.\("timestampzes").as(Reads.ArrayReads[TypoInstant](TypoInstant.reads, implicitly)),
          timezes = json.\("timezes").as(Reads.ArrayReads[TypoOffsetTime](TypoOffsetTime.reads, implicitly)),
          uuides = json.\("uuides").as(Reads.ArrayReads[TypoUUID](TypoUUID.reads, implicitly)),
          varchares = json.\("varchares").as(Reads.ArrayReads[String](Reads.StringReads, implicitly)),
  ...
  implicit lazy val writes: OWrites[PgtestRow] = OWrites[PgtestRow](o =>
    new JsObject(ListMap[String, JsValue](
      ...
      "bpchares" -> Writes.arrayWrites[String](implicitly, Writes.StringWrites).writes(o.bpchares),
      "chares" -> Writes.arrayWrites[String](implicitly, Writes.StringWrites).writes(o.chares),
      "circlees" -> Writes.arrayWrites[TypoCircle](implicitly, TypoCircle.writes).writes(o.circlees),
      "datees" -> Writes.arrayWrites[TypoLocalDate](implicitly, TypoLocalDate.writes).writes(o.datees),
      "float4es" -> Writes.arrayWrites[Float](implicitly, Writes.FloatWrites).writes(o.float4es),
      "float8es" -> Writes.arrayWrites[Double](implicitly, Writes.DoubleWrites).writes(o.float8es),
      "inetes" -> Writes.arrayWrites[TypoInet](implicitly, TypoInet.writes).writes(o.inetes),
      "int2es" -> Writes.arrayWrites[TypoShort](implicitly, TypoShort.writes).writes(o.int2es),
      "int2vectores" -> Writes.arrayWrites[TypoInt2Vector](implicitly, TypoInt2Vector.writes).writes(o.int2vectores),
      "int4es" -> Writes.arrayWrites[Int](implicitly, Writes.IntWrites).writes(o.int4es),
      "int8es" -> Writes.arrayWrites[Long](implicitly, Writes.LongWrites).writes(o.int8es),
      ...
      "myenumes" -> Writes.arrayWrites[Myenum](implicitly, Myenum.writes).writes(o.myenumes),
      "namees" -> Writes.arrayWrites[String](implicitly, Writes.StringWrites).writes(o.namees),
      "numerices" -> Writes.arrayWrites[BigDecimal](implicitly, Writes.BigDecimalWrites).writes(o.numerices),
      ...
      "textes" -> Writes.arrayWrites[String](implicitly, Writes.StringWrites).writes(o.textes),
      "timees" -> Writes.arrayWrites[TypoLocalTime](implicitly, TypoLocalTime.writes).writes(o.timees),
      "timestampes" -> Writes.arrayWrites[TypoLocalDateTime](implicitly, TypoLocalDateTime.writes).writes(o.timestampes),
      "timestampzes" -> Writes.arrayWrites[TypoInstant](implicitly, TypoInstant.writes).writes(o.timestampzes),
      "timezes" -> Writes.arrayWrites[TypoOffsetTime](implicitly, TypoOffsetTime.writes).writes(o.timezes),
      "uuides" -> Writes.arrayWrites[TypoUUID](implicitly, TypoUUID.writes).writes(o.uuides),
      "varchares" -> Writes.arrayWrites[String](implicitly, Writes.StringWrites).writes(o.varchares),
