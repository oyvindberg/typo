...
class SohViewStructure[Row](val prefix: Option[String], val extract: Row => SohViewRow, val merge: (Row, SohViewRow) => Row)
  ...
  override val purchaseordernumber = new Field[OrderNumber, Row](prefix, "purchaseordernumber", None, Some(""""public".OrderNumber"""))(x => extract(x).purchaseordernumber, (row, value) => merge(row, extract(row).copy(purchaseordernumber = value)))
