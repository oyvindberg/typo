...
object BusinessentityaddressRow {
  ...
  implicit lazy val reads: Reads[BusinessentityaddressRow] = {
    Reads[BusinessentityaddressRow](json => JsResult.fromTry(
        Try(
  ...
  implicit lazy val writes: OWrites[BusinessentityaddressRow] = {
    OWrites[BusinessentityaddressRow](o =>
