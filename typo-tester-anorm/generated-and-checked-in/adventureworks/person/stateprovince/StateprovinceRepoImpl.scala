...
class StateprovinceRepoImpl extends StateprovinceRepo {
  ...
  def deleteById(stateprovinceid: StateprovinceId)(implicit c: Connection): Boolean = SQL"""delete from person.stateprovince where "stateprovinceid" = ${ParameterValue(stateprovinceid, null, StateprovinceId.toStatement)}""".executeUpdate() > 0
  ...
  def insertStreaming(unsaved: Iterator[StateprovinceRow], batchSize: Int = 10000)(implicit c: Connection): Long = streamingInsert(s"""COPY person.stateprovince("stateprovinceid", "stateprovincecode", "countryregioncode", "isonlystateprovinceflag", "name", "territoryid", "rowguid", "modifieddate") FROM STDIN""", batchSize, unsaved)(StateprovinceRow.text, c)
  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[StateprovinceRowUnsaved], batchSize: Int = 10000)(implicit c: Connection): Long = streamingInsert(s"""COPY person.stateprovince("stateprovincecode", "countryregioncode", "name", "territoryid", "stateprovinceid", "isonlystateprovinceflag", "rowguid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(StateprovinceRowUnsaved.text, c)
  def select: SelectBuilder[StateprovinceFields, StateprovinceRow] = SelectBuilderSql("person.stateprovince", StateprovinceFields.structure, StateprovinceRow.rowParser)
  ...
  def update: UpdateBuilder[StateprovinceFields, StateprovinceRow] = UpdateBuilder("person.stateprovince", StateprovinceFields.structure, StateprovinceRow.rowParser)
