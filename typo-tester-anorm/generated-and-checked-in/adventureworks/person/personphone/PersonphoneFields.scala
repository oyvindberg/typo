...
trait PersonphoneFields {
  ...
  def compositeIdIn(compositeIds: Array[PersonphoneId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[PersonphoneId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId], Required](ToParameterValue(null, BusinessentityId.arrayToStatement), adventureworks.arrayParameterMetaData(BusinessentityId.parameterMetadata)), implicitly), TuplePart[PersonphoneId](phonenumber)(_.phonenumber)(using as[Array[Phone], Required](ToParameterValue(null, Phone.arrayToStatement), adventureworks.arrayParameterMetaData(Phone.parameterMetadata)), implicitly), TuplePart[PersonphoneId](phonenumbertypeid)(_.phonenumbertypeid)(using as[Array[PhonenumbertypeId], Required](ToParameterValue(null, PhonenumbertypeId.arrayToStatement), adventureworks.arrayParameterMetaData(PhonenumbertypeId.parameterMetadata)), implicitly))
