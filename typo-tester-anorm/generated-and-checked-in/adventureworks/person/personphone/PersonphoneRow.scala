...
object PersonphoneRow {
  ...
  implicit lazy val reads: Reads[PersonphoneRow] = {
    Reads[PersonphoneRow](json => JsResult.fromTry(
        Try(
          PersonphoneRow(
  ...
  implicit lazy val writes: OWrites[PersonphoneRow] = {
    OWrites[PersonphoneRow](o =>
