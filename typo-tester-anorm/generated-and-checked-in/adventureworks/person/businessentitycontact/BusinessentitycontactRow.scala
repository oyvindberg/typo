...
object BusinessentitycontactRow {
  ...
  implicit lazy val reads: Reads[BusinessentitycontactRow] = {
    Reads[BusinessentitycontactRow](json => JsResult.fromTry(
        Try(
  ...
  implicit lazy val writes: OWrites[BusinessentitycontactRow] = {
    OWrites[BusinessentitycontactRow](o =>
