...
class CountryregionRepoImpl extends CountryregionRepo {
  ...
  def deleteById(countryregioncode: CountryregionId)(implicit c: Connection): Boolean = SQL"""delete from person.countryregion where "countryregioncode" = ${ParameterValue(countryregioncode, null, CountryregionId.toStatement)}""".executeUpdate() > 0
  ...
  def insertStreaming(unsaved: Iterator[CountryregionRow], batchSize: Int = 10000)(implicit c: Connection): Long = streamingInsert(s"""COPY person.countryregion("countryregioncode", "name", "modifieddate") FROM STDIN""", batchSize, unsaved)(CountryregionRow.text, c)
  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[CountryregionRowUnsaved], batchSize: Int = 10000)(implicit c: Connection): Long = streamingInsert(s"""COPY person.countryregion("countryregioncode", "name", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(CountryregionRowUnsaved.text, c)
  def select: SelectBuilder[CountryregionFields, CountryregionRow] = SelectBuilderSql("person.countryregion", CountryregionFields.structure, CountryregionRow.rowParser)
  ...
  def update: UpdateBuilder[CountryregionFields, CountryregionRow] = UpdateBuilder("person.countryregion", CountryregionFields.structure, CountryregionRow.rowParser)
