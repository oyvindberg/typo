...
object EmailaddressRow {
  ...
  implicit lazy val reads: Reads[EmailaddressRow] = {
    Reads[EmailaddressRow](json => JsResult.fromTry(
        Try(
          EmailaddressRow(
  ...
  implicit lazy val writes: OWrites[EmailaddressRow] = {
    OWrites[EmailaddressRow](o =>
