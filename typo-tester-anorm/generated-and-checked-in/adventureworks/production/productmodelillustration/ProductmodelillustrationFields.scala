...
trait ProductmodelillustrationFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductmodelillustrationId]): SqlExpr[Boolean, Required] =
    new CompositeIn(compositeIds)(TuplePart[ProductmodelillustrationId](productmodelid)(_.productmodelid)(using as[Array[ProductmodelId], Required](ToParameterValue(null, ProductmodelId.arrayToStatement), adventureworks.arrayParameterMetaData(ProductmodelId.parameterMetadata)), implicitly), TuplePart[ProductmodelillustrationId](illustrationid)(_.illustrationid)(using as[Array[IllustrationId], Required](ToParameterValue(null, IllustrationId.arrayToStatement), adventureworks.arrayParameterMetaData(IllustrationId.parameterMetadata)), implicitly))
