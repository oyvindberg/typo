...
object ProductdescriptionRow {
  implicit lazy val reads: Reads[ProductdescriptionRow] = {
    Reads[ProductdescriptionRow](json => JsResult.fromTry(
        Try(
  ...
  implicit lazy val writes: OWrites[ProductdescriptionRow] = {
    OWrites[ProductdescriptionRow](o =>
