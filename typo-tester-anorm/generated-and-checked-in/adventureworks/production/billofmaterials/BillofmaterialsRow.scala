...
object BillofmaterialsRow {
  implicit lazy val reads: Reads[BillofmaterialsRow] = {
    Reads[BillofmaterialsRow](json => JsResult.fromTry(
        Try(
          BillofmaterialsRow(
  ...
  implicit lazy val writes: OWrites[BillofmaterialsRow] = {
    OWrites[BillofmaterialsRow](o =>
