...
object ScrapreasonRow {
  implicit lazy val reads: Reads[ScrapreasonRow] = {
    Reads[ScrapreasonRow](json => JsResult.fromTry(
        Try(
          ScrapreasonRow(
  ...
  implicit lazy val writes: OWrites[ScrapreasonRow] = {
    OWrites[ScrapreasonRow](o =>
