...
class ProductmodelRepoImpl extends ProductmodelRepo {
  ...
  def deleteById(productmodelid: ProductmodelId)(implicit c: Connection): Boolean = SQL"""delete from production.productmodel where "productmodelid" = ${ParameterValue(productmodelid, null, ProductmodelId.toStatement)}""".executeUpdate() > 0
  ...
  def insertStreaming(unsaved: Iterator[ProductmodelRow], batchSize: Int = 10000)(implicit c: Connection): Long = streamingInsert(s"""COPY production.productmodel("productmodelid", "name", "catalogdescription", "instructions", "rowguid", "modifieddate") FROM STDIN""", batchSize, unsaved)(ProductmodelRow.text, c)
  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[ProductmodelRowUnsaved], batchSize: Int = 10000)(implicit c: Connection): Long = streamingInsert(s"""COPY production.productmodel("name", "catalogdescription", "instructions", "productmodelid", "rowguid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(ProductmodelRowUnsaved.text, c)
  def select: SelectBuilder[ProductmodelFields, ProductmodelRow] = SelectBuilderSql("production.productmodel", ProductmodelFields.structure, ProductmodelRow.rowParser)
  ...
  def update: UpdateBuilder[ProductmodelFields, ProductmodelRow] = UpdateBuilder("production.productmodel", ProductmodelFields.structure, ProductmodelRow.rowParser)
