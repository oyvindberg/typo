...
class CultureRepoImpl extends CultureRepo {
  ...
  def deleteById(cultureid: CultureId)(implicit c: Connection): Boolean = SQL"""delete from production.culture where "cultureid" = ${ParameterValue(cultureid, null, CultureId.toStatement)}""".executeUpdate() > 0
  ...
  def insertStreaming(unsaved: Iterator[CultureRow], batchSize: Int = 10000)(implicit c: Connection): Long = streamingInsert(s"""COPY production.culture("cultureid", "name", "modifieddate") FROM STDIN""", batchSize, unsaved)(CultureRow.text, c)
  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[CultureRowUnsaved], batchSize: Int = 10000)(implicit c: Connection): Long = streamingInsert(s"""COPY production.culture("cultureid", "name", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(CultureRowUnsaved.text, c)
  def select: SelectBuilder[CultureFields, CultureRow] = SelectBuilderSql("production.culture", CultureFields.structure, CultureRow.rowParser)
  ...
  def update: UpdateBuilder[CultureFields, CultureRow] = UpdateBuilder("production.culture", CultureFields.structure, CultureRow.rowParser)
