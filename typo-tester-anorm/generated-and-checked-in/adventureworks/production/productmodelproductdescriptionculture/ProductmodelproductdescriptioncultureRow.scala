...
object ProductmodelproductdescriptioncultureRow {
  ...
  implicit lazy val reads: Reads[ProductmodelproductdescriptioncultureRow] = {
    Reads[ProductmodelproductdescriptioncultureRow](json => JsResult.fromTry(
        Try(
  ...
  implicit lazy val writes: OWrites[ProductmodelproductdescriptioncultureRow] = {
    OWrites[ProductmodelproductdescriptioncultureRow](o =>
