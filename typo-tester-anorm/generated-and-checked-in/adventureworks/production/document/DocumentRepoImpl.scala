...
class DocumentRepoImpl extends DocumentRepo {
  ...
  def deleteById(documentnode: DocumentId)(implicit c: Connection): Boolean = SQL"""delete from production.document where "documentnode" = ${ParameterValue(documentnode, null, DocumentId.toStatement)}""".executeUpdate() > 0
  ...
  def insertStreaming(unsaved: Iterator[DocumentRow], batchSize: Int = 10000)(implicit c: Connection): Long = streamingInsert(s"""COPY production.document("title", "owner", "folderflag", "filename", "fileextension", "revision", "changenumber", "status", "documentsummary", "document", "rowguid", "modifieddate", "documentnode") FROM STDIN""", batchSize, unsaved)(DocumentRow.text, c)
  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[DocumentRowUnsaved], batchSize: Int = 10000)(implicit c: Connection): Long = streamingInsert(s"""COPY production.document("title", "owner", "filename", "fileextension", "revision", "status", "documentsummary", "document", "folderflag", "changenumber", "rowguid", "modifieddate", "documentnode") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(DocumentRowUnsaved.text, c)
  def select: SelectBuilder[DocumentFields, DocumentRow] = SelectBuilderSql("production.document", DocumentFields.structure, DocumentRow.rowParser)
  ...
  def update: UpdateBuilder[DocumentFields, DocumentRow] = UpdateBuilder("production.document", DocumentFields.structure, DocumentRow.rowParser)
