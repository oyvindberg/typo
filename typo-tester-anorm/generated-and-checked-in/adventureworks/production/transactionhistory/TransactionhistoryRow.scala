...
object TransactionhistoryRow {
  implicit lazy val reads: Reads[TransactionhistoryRow] = {
    Reads[TransactionhistoryRow](json => JsResult.fromTry(
        Try(
  ...
  implicit lazy val writes: OWrites[TransactionhistoryRow] = {
    OWrites[TransactionhistoryRow](o =>
