...
class ProductreviewRepoImpl extends ProductreviewRepo {
  ...
  def insertStreaming(unsaved: Iterator[ProductreviewRow], batchSize: Int = 10000)(implicit c: Connection): Long = streamingInsert(s"""COPY production.productreview("productreviewid", "productid", "reviewername", "reviewdate", "emailaddress", "rating", "comments", "modifieddate") FROM STDIN""", batchSize, unsaved)(ProductreviewRow.text, c)
  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[ProductreviewRowUnsaved], batchSize: Int = 10000)(implicit c: Connection): Long = streamingInsert(s"""COPY production.productreview("productid", "reviewername", "emailaddress", "rating", "comments", "productreviewid", "reviewdate", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(ProductreviewRowUnsaved.text, c)
  def select: SelectBuilder[ProductreviewFields, ProductreviewRow] = SelectBuilderSql("production.productreview", ProductreviewFields.structure, ProductreviewRow.rowParser)
  ...
  def update: UpdateBuilder[ProductreviewFields, ProductreviewRow] = UpdateBuilder("production.productreview", ProductreviewFields.structure, ProductreviewRow.rowParser)
  ...
  def upsertStreaming(unsaved: Iterator[ProductreviewRow], batchSize: Int = 10000)(implicit c: Connection): Int = {
