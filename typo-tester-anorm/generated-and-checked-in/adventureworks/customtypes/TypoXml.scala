...
object TypoXml {
  implicit lazy val arrayColumn: Column[Array[TypoXml]] = {
  ...
  implicit lazy val arrayToStatement: ToStatement[Array[TypoXml]] = {
  ...
  implicit lazy val parameterMetadata: ParameterMetaData[TypoXml] = {
  ...
  implicit lazy val text: Text[TypoXml] = {
    new Text[TypoXml] {
