...
object TypoLineSegment {
  implicit lazy val arrayColumn: Column[Array[TypoLineSegment]] = {
  ...
  implicit lazy val column: Column[TypoLineSegment] = {
  ...
  implicit lazy val parameterMetadata: ParameterMetaData[TypoLineSegment] = {
    new ParameterMetaData[TypoLineSegment] {
      override def sqlType: String = "lseg"
      override def jdbcType: Int = Types.OTHER
    }
  }
  implicit lazy val reads: Reads[TypoLineSegment] = {
  ...
  implicit lazy val writes: OWrites[TypoLineSegment] = {
