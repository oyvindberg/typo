...
object TypoJson {
  implicit lazy val arrayColumn: Column[Array[TypoJson]] = {
    Column.nonNull[Array[TypoJson]]((v1: Any, _) =>
      v1 match {
          case v: PgArray =>
           v.getArray match {
             case v: Array[?] =>
  ...
  implicit lazy val arrayToStatement: ToStatement[Array[TypoJson]] = {
    ToStatement[Array[TypoJson]]((s, index, v) => s.setArray(index, s.getConnection.createArrayOf("json", v.map(v => {
  ...
  implicit lazy val parameterMetadata: ParameterMetaData[TypoJson] = {
    new ParameterMetaData[TypoJson] {
  ...
  implicit lazy val toStatement: ToStatement[TypoJson] = {
    ToStatement[TypoJson]((s, index, v) => s.setObject(index, {
                                                                val obj = new PGobject
                                                                obj.setType("json")
                                                                obj.setValue(v.value)
                                                                obj
