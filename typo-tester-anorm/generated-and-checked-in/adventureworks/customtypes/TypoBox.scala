...
object TypoBox {
  implicit lazy val arrayColumn: Column[Array[TypoBox]] = {
    Column.nonNull[Array[TypoBox]]((v1: Any, _) =>
      v1 match {
          case v: PgArray =>
           v.getArray match {
             case v: Array[?] =>
  ...
  implicit lazy val column: Column[TypoBox] = {
    Column.nonNull[TypoBox]((v1: Any, _) =>
      v1 match {
  ...
  implicit lazy val parameterMetadata: ParameterMetaData[TypoBox] = {
    new ParameterMetaData[TypoBox] {
      override def sqlType: String = "box"
      override def jdbcType: Int = Types.OTHER
    }
  }
  implicit lazy val reads: Reads[TypoBox] = {
    Reads[TypoBox](json => JsResult.fromTry(
        Try(
          TypoBox(
  ...
  implicit lazy val writes: OWrites[TypoBox] = {
    OWrites[TypoBox](o =>
