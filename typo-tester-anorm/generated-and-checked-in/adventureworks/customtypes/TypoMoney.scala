...
object TypoMoney {
  implicit lazy val arrayColumn: Column[Array[TypoMoney]] = {
    Column.nonNull[Array[TypoMoney]]((v1: Any, _) =>
      v1 match {
          case v: PgArray =>
           v.getArray match {
             case v: Array[?] =>
  ...
  implicit lazy val parameterMetadata: ParameterMetaData[TypoMoney] = {
    new ParameterMetaData[TypoMoney] {
      override def sqlType: String = "money"
      override def jdbcType: Int = Types.OTHER
    }
  }
  implicit lazy val reads: Reads[TypoMoney] = Reads.bigDecReads.map(TypoMoney.apply)
  implicit lazy val text: Text[TypoMoney] = {
    new Text[TypoMoney] {
