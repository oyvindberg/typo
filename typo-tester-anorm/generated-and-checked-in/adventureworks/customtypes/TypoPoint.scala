...
object TypoPoint {
  implicit lazy val arrayColumn: Column[Array[TypoPoint]] = {
  ...
  implicit lazy val column: Column[TypoPoint] = {
  ...
  implicit lazy val parameterMetadata: ParameterMetaData[TypoPoint] = {
    new ParameterMetaData[TypoPoint] {
      override def sqlType: String = "point"
      override def jdbcType: Int = Types.OTHER
    }
  }
  implicit lazy val reads: Reads[TypoPoint] = {
  ...
  implicit lazy val writes: OWrites[TypoPoint] = {
    OWrites[TypoPoint](o =>
