...
trait ProductRepo {
  ...
  def deleteById(id: ProductId)(implicit c: Connection): Boolean
  def deleteByIds(ids: Array[ProductId])(implicit c: Connection): Int
  ...
  def selectById(id: ProductId)(implicit c: Connection): Option[ProductRow]
  def selectByIds(ids: Array[ProductId])(implicit c: Connection): List[ProductRow]
  def selectByIdsTracked(ids: Array[ProductId])(implicit c: Connection): Map[ProductId, ProductRow]
