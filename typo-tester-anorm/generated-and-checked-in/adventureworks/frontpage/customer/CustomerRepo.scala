...
trait CustomerRepo {
  ...
  def deleteById(id: CustomerId)(implicit c: Connection): Boolean
  def deleteByIds(ids: Array[CustomerId])(implicit c: Connection): Int
  ...
  def selectById(id: CustomerId)(implicit c: Connection): Option[CustomerRow]
  def selectByIds(ids: Array[CustomerId])(implicit c: Connection): List[CustomerRow]
  def selectByIdsTracked(ids: Array[CustomerId])(implicit c: Connection): Map[CustomerId, CustomerRow]
