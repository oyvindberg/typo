...
trait LocationRepo {
  ...
  def deleteById(id: LocationId)(implicit c: Connection): Boolean
  def deleteByIds(ids: Array[LocationId])(implicit c: Connection): Int
  ...
  def selectById(id: LocationId)(implicit c: Connection): Option[LocationRow]
  def selectByIds(ids: Array[LocationId])(implicit c: Connection): List[LocationRow]
  def selectByIdsTracked(ids: Array[LocationId])(implicit c: Connection): Map[LocationId, LocationRow]
