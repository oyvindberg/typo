...
object CreditcardId {
  ...
  implicit lazy val arrayToStatement: ToStatement[Array[CreditcardId]] = adventureworks.IntArrayToStatement.contramap(_.map(_.value))
  implicit lazy val bijection: Bijection[CreditcardId, Int] = Bijection[CreditcardId, Int](_.value)(CreditcardId.apply)
  implicit lazy val column: Column[CreditcardId] = Column.columnToInt.map(CreditcardId.apply)
  ...
  implicit lazy val toStatement: ToStatement[CreditcardId] = ToStatement.intToStatement.contramap(_.value)
