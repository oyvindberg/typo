...
object VstorewithcontactsViewFieldValue {
  ...
  case class title(override val value: Option[/* max 8 chars */ String]) extends VstorewithcontactsViewFieldValue("title", value)
  ...
  case class suffix(override val value: Option[/* max 10 chars */ String]) extends VstorewithcontactsViewFieldValue("suffix", value)
  ...
  case class emailaddress(override val value: Option[/* max 50 chars */ String]) extends VstorewithcontactsViewFieldValue("emailaddress", value)
