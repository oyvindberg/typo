...
object RoutineTableUsageViewRow {
  def rowParser(idx: Int): RowParser[RoutineTableUsageViewRow] =
    RowParser[RoutineTableUsageViewRow] { row =>
      Success(
  ...
  implicit val oFormat: OFormat[RoutineTableUsageViewRow] = new OFormat[RoutineTableUsageViewRow]{
    override def writes(o: RoutineTableUsageViewRow): JsObject =
      Json.obj(
    ...
    override def reads(json: JsValue): JsResult[RoutineTableUsageViewRow] = {
      JsResult.fromTry(
        Try(
          RoutineTableUsageViewRow(
