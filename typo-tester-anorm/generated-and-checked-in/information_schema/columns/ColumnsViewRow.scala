...
object ColumnsViewRow {
  ...
  implicit val writes: OWrites[ColumnsViewRow] = OWrites[ColumnsViewRow](o =>
    new JsObject(ListMap[String, JsValue](
      ...
      "column_default" -> Json.toJson(o.columnDefault),
      ...
      "is_self_referencing" -> Json.toJson(o.isSelfReferencing),
      "is_identity" -> Json.toJson(o.isIdentity),
      "identity_generation" -> Json.toJson(o.identityGeneration),
      "identity_start" -> Json.toJson(o.identityStart),
      "identity_increment" -> Json.toJson(o.identityIncrement),
      "identity_maximum" -> Json.toJson(o.identityMaximum),
      "identity_minimum" -> Json.toJson(o.identityMinimum),
      "identity_cycle" -> Json.toJson(o.identityCycle),
      "is_generated" -> Json.toJson(o.isGenerated),
      "generation_expression" -> Json.toJson(o.generationExpression),
