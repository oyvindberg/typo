...
object RoleUsageGrantsViewRow {
  def rowParser(idx: Int): RowParser[RoleUsageGrantsViewRow] =
    RowParser[RoleUsageGrantsViewRow] { row =>
      Success(
  ...
  implicit val oFormat: OFormat[RoleUsageGrantsViewRow] = new OFormat[RoleUsageGrantsViewRow]{
    override def writes(o: RoleUsageGrantsViewRow): JsObject =
      Json.obj(
        "grantor" -> o.grantor,
        "grantee" -> o.grantee,
    ...
    override def reads(json: JsValue): JsResult[RoleUsageGrantsViewRow] = {
      JsResult.fromTry(
        Try(
          RoleUsageGrantsViewRow(
