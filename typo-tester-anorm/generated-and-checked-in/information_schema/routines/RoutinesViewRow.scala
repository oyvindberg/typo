...
object RoutinesViewRow {
  ...
  implicit val writes: OWrites[RoutinesViewRow] = OWrites[RoutinesViewRow](o =>
    new JsObject(ListMap[String, JsValue](
      ...
      "routine_type" -> Json.toJson(o.routineType),
      "module_catalog" -> Json.toJson(o.moduleCatalog),
      "module_schema" -> Json.toJson(o.moduleSchema),
      "module_name" -> Json.toJson(o.moduleName),
      ...
      "type_udt_catalog" -> Json.toJson(o.typeUdtCatalog),
      "type_udt_schema" -> Json.toJson(o.typeUdtSchema),
      "type_udt_name" -> Json.toJson(o.typeUdtName),
      ...
      "routine_body" -> Json.toJson(o.routineBody),
      "routine_definition" -> Json.toJson(o.routineDefinition),
      "external_name" -> Json.toJson(o.externalName),
      "external_language" -> Json.toJson(o.externalLanguage),
      "parameter_style" -> Json.toJson(o.parameterStyle),
      "is_deterministic" -> Json.toJson(o.isDeterministic),
      "sql_data_access" -> Json.toJson(o.sqlDataAccess),
      "is_null_call" -> Json.toJson(o.isNullCall),
      "sql_path" -> Json.toJson(o.sqlPath),
      "schema_level_routine" -> Json.toJson(o.schemaLevelRoutine),
      "max_dynamic_result_sets" -> Json.toJson(o.maxDynamicResultSets),
      "is_user_defined_cast" -> Json.toJson(o.isUserDefinedCast),
      "is_implicitly_invocable" -> Json.toJson(o.isImplicitlyInvocable),
      "security_type" -> Json.toJson(o.securityType),
      "to_sql_specific_catalog" -> Json.toJson(o.toSqlSpecificCatalog),
      "to_sql_specific_schema" -> Json.toJson(o.toSqlSpecificSchema),
      "to_sql_specific_name" -> Json.toJson(o.toSqlSpecificName),
      "as_locator" -> Json.toJson(o.asLocator),
      "created" -> Json.toJson(o.created),
      "last_altered" -> Json.toJson(o.lastAltered),
      "new_savepoint_level" -> Json.toJson(o.newSavepointLevel),
      "is_udt_dependent" -> Json.toJson(o.isUdtDependent),
      "result_cast_from_data_type" -> Json.toJson(o.resultCastFromDataType),
      "result_cast_as_locator" -> Json.toJson(o.resultCastAsLocator),
      "result_cast_char_max_length" -> Json.toJson(o.resultCastCharMaxLength),
      "result_cast_char_octet_length" -> Json.toJson(o.resultCastCharOctetLength),
      "result_cast_char_set_catalog" -> Json.toJson(o.resultCastCharSetCatalog),
      "result_cast_char_set_schema" -> Json.toJson(o.resultCastCharSetSchema),
      "result_cast_char_set_name" -> Json.toJson(o.resultCastCharSetName),
      "result_cast_collation_catalog" -> Json.toJson(o.resultCastCollationCatalog),
      "result_cast_collation_schema" -> Json.toJson(o.resultCastCollationSchema),
      "result_cast_collation_name" -> Json.toJson(o.resultCastCollationName),
      "result_cast_numeric_precision" -> Json.toJson(o.resultCastNumericPrecision),
      "result_cast_numeric_precision_radix" -> Json.toJson(o.resultCastNumericPrecisionRadix),
      "result_cast_numeric_scale" -> Json.toJson(o.resultCastNumericScale),
      "result_cast_datetime_precision" -> Json.toJson(o.resultCastDatetimePrecision),
      "result_cast_interval_type" -> Json.toJson(o.resultCastIntervalType),
      "result_cast_interval_precision" -> Json.toJson(o.resultCastIntervalPrecision),
      "result_cast_type_udt_catalog" -> Json.toJson(o.resultCastTypeUdtCatalog),
      "result_cast_type_udt_schema" -> Json.toJson(o.resultCastTypeUdtSchema),
      "result_cast_type_udt_name" -> Json.toJson(o.resultCastTypeUdtName),
      "result_cast_scope_catalog" -> Json.toJson(o.resultCastScopeCatalog),
      "result_cast_scope_schema" -> Json.toJson(o.resultCastScopeSchema),
      "result_cast_scope_name" -> Json.toJson(o.resultCastScopeName),
      "result_cast_maximum_cardinality" -> Json.toJson(o.resultCastMaximumCardinality),
      "result_cast_dtd_identifier" -> Json.toJson(o.resultCastDtdIdentifier)
    ))
  )
}
