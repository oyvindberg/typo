...
object EmployeeFieldValue {
  ...
  case class salariedflag(override val value: Flag) extends EmployeeFieldValue("salariedflag", value)
  ...
  case class currentflag(override val value: Flag) extends EmployeeFieldValue("currentflag", value)
