...
object VstorewithaddressesFieldValue {
  ...
  case class name(override val value: Option[Name]) extends VstorewithaddressesFieldValue("name", value)
  case class addresstype(override val value: Option[Name]) extends VstorewithaddressesFieldValue("addresstype", value)
  ...
  case class stateprovincename(override val value: Option[Name]) extends VstorewithaddressesFieldValue("stateprovincename", value)
  case class postalcode(override val value: Option[String]) extends VstorewithaddressesFieldValue("postalcode", value)
  case class countryregionname(override val value: Option[Name]) extends VstorewithaddressesFieldValue("countryregionname", value)
}
