...
object PersonDetailRow {
  implicit val oFormat: OFormat[PersonDetailRow] = new OFormat[PersonDetailRow]{
    override def writes(o: PersonDetailRow): JsObject =
      Json.obj(
    ...
    override def reads(json: JsValue): JsResult[PersonDetailRow] = {
      JsResult.fromTry(
        Try(
          PersonDetailRow(
