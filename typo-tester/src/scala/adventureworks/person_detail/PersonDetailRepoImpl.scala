...
object PersonDetailRepoImpl extends PersonDetailRepo {
  override def apply(businessentityid: /* nullability unknown */ Option[Int])(implicit c: Connection): List[PersonDetailRow] = {
    val sql =
  ...
  val rowParser: RowParser[PersonDetailRow] =
    RowParser[PersonDetailRow] { row =>
      Success(
        PersonDetailRow(
