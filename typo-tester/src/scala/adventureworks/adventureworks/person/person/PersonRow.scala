...
case class PersonRow(
  ...
  persontype: String /* {"table_catalog":"Adventureworks","table_schema":"person","table_name":"person","column_name":"persontype","ordinal_position":2,"is_nullable":"NO","data_type":"character","character_maximum_length":2,"character_octet_length":8,"udt_catalog":"Adventureworks","udt_schema":"pg_catalog","udt_name":"bpchar","dtd_identifier":"2","is_self_referencing":"NO","is_identity":"NO","identity_cycle":"NO","is_generated":"NEVER","is_updatable":"YES"} */,
  ...
  def rowParser(prefix: String): RowParser[PersonRow] = { row =>
    Success(
      PersonRow(
        ...
        persontype = row[String](prefix + "persontype"),
