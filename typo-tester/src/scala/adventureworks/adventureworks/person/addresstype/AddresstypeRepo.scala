...
trait AddresstypeRepo {
  ...
  def insert(unsaved: AddresstypeRowUnsaved)(implicit c: Connection): AddresstypeId
  ...
  def update(addresstypeid: AddresstypeId, row: AddresstypeRow)(implicit c: Connection): Boolean
