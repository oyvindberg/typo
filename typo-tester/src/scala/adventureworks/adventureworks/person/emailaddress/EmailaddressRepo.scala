...
trait EmailaddressRepo {
  ...
  def insert(compositeId: EmailaddressId, unsaved: EmailaddressRowUnsaved)(implicit c: Connection): Boolean
  ...
  def update(compositeId: EmailaddressId, row: EmailaddressRow)(implicit c: Connection): Boolean
