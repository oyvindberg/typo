...
object VFieldValue {
  ...
  case class accountnumber(override val value: Option[String]) extends VFieldValue("accountnumber", value)
  case class name(override val value: Option[String]) extends VFieldValue("name", value)
  case class creditrating(override val value: Option[Int]) extends VFieldValue("creditrating", value)
  case class preferredvendorstatus(override val value: Boolean) extends VFieldValue("preferredvendorstatus", value)
  case class activeflag(override val value: Boolean) extends VFieldValue("activeflag", value)
