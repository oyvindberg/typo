...
case class SalestaxrateRow(
  /** Primary key for SalesTaxRate records.
      debug: {"table_catalog":"Adventureworks","table_schema":"sales","table_name":"salestaxrate","column_name":"salestaxrateid","ordinal_position":1,"column_default":"nextval('sales.salestaxrate_salestaxrateid_seq'::regclass)","is_nullable":"NO","data_type":"integer","numeric_precision":32,"numeric_precision_radix":2,"numeric_scale":0,"udt_catalog":"Adventureworks","udt_schema":"pg_catalog","udt_name":"int4","dtd_identifier":"1","is_self_referencing":"NO","is_identity":"NO","identity_cycle":"NO","is_generated":"NEVER","is_updatable":"YES"} */
