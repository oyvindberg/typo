...
trait SalesreasonRepo {
  ...
  def insert(unsaved: SalesreasonRowUnsaved)(implicit c: Connection): SalesreasonId
  ...
  def update(salesreasonid: SalesreasonId, row: SalesreasonRow)(implicit c: Connection): Boolean
