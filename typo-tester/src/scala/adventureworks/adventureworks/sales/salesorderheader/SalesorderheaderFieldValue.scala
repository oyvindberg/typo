...
object SalesorderheaderFieldValue {
  ...
  case class onlineorderflag(override val value: Boolean) extends SalesorderheaderFieldValue("onlineorderflag", value)
  case class purchaseordernumber(override val value: Option[String]) extends SalesorderheaderFieldValue("purchaseordernumber", value)
  case class accountnumber(override val value: Option[String]) extends SalesorderheaderFieldValue("accountnumber", value)
