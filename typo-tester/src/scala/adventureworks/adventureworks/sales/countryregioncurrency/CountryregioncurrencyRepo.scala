...
trait CountryregioncurrencyRepo {
  ...
  def insert(compositeId: CountryregioncurrencyId, unsaved: CountryregioncurrencyRowUnsaved)(implicit c: Connection): Boolean
  ...
  def update(compositeId: CountryregioncurrencyId, row: CountryregioncurrencyRow)(implicit c: Connection): Boolean
