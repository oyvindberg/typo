...
object VsalespersonFieldValue {
  ...
  case class firstname(override val value: Option[Name]) extends VsalespersonFieldValue("firstname", value)
  case class middlename(override val value: Option[Name]) extends VsalespersonFieldValue("middlename", value)
  case class lastname(override val value: Option[Name]) extends VsalespersonFieldValue("lastname", value)
  ...
  case class phonenumber(override val value: Option[Phone]) extends VsalespersonFieldValue("phonenumber", value)
  case class phonenumbertype(override val value: Option[Name]) extends VsalespersonFieldValue("phonenumbertype", value)
  ...
  case class stateprovincename(override val value: Option[Name]) extends VsalespersonFieldValue("stateprovincename", value)
  case class postalcode(override val value: Option[String]) extends VsalespersonFieldValue("postalcode", value)
  case class countryregionname(override val value: Option[Name]) extends VsalespersonFieldValue("countryregionname", value)
  case class territoryname(override val value: Option[Name]) extends VsalespersonFieldValue("territoryname", value)
