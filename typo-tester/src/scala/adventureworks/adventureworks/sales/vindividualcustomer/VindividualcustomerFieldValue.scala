...
object VindividualcustomerFieldValue {
  ...
  case class firstname(override val value: Option[String]) extends VindividualcustomerFieldValue("firstname", value)
  case class middlename(override val value: Option[String]) extends VindividualcustomerFieldValue("middlename", value)
  case class lastname(override val value: Option[String]) extends VindividualcustomerFieldValue("lastname", value)
  case class suffix(override val value: Option[String]) extends VindividualcustomerFieldValue("suffix", value)
  case class phonenumber(override val value: Option[String]) extends VindividualcustomerFieldValue("phonenumber", value)
  case class phonenumbertype(override val value: Option[String]) extends VindividualcustomerFieldValue("phonenumbertype", value)
  ...
  case class addresstype(override val value: Option[String]) extends VindividualcustomerFieldValue("addresstype", value)
