...
trait ProductreviewRepo {
  ...
  def insert(unsaved: ProductreviewRowUnsaved)(implicit c: Connection): ProductreviewId
  ...
  def update(productreviewid: ProductreviewId, row: ProductreviewRow)(implicit c: Connection): Boolean
