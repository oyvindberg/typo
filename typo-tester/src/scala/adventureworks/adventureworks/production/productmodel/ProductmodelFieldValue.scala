...
object ProductmodelFieldValue {
  ...
  case class catalogdescription(override val value: Option[String]) extends ProductmodelFieldValue("catalogdescription", value)
  case class instructions(override val value: Option[String]) extends ProductmodelFieldValue("instructions", value)
