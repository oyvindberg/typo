...
case class ProductsubcategoryRow(
  /** Primary key for ProductSubcategory records.
      debug: {"table_catalog":"Adventureworks","table_schema":"production","table_name":"productsubcategory","column_name":"productsubcategoryid","ordinal_position":1,"column_default":"nextval('production.productsubcategory_productsubcategoryid_seq'::regclass)","is_nullable":"NO","data_type":"integer","numeric_precision":32,"numeric_precision_radix":2,"numeric_scale":0,"udt_catalog":"Adventureworks","udt_schema":"pg_catalog","udt_name":"int4","dtd_identifier":"1","is_self_referencing":"NO","is_identity":"NO","identity_cycle":"NO","is_generated":"NEVER","is_updatable":"YES"} */
