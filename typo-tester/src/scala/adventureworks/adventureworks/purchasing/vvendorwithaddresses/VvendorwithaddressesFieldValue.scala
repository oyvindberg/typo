...
object VvendorwithaddressesFieldValue {
  ...
  case class name(override val value: Option[NameDomain]) extends VvendorwithaddressesFieldValue("name", value)
  case class addresstype(override val value: Option[NameDomain]) extends VvendorwithaddressesFieldValue("addresstype", value)
  ...
  case class stateprovincename(override val value: Option[NameDomain]) extends VvendorwithaddressesFieldValue("stateprovincename", value)
  case class postalcode(override val value: Option[String]) extends VvendorwithaddressesFieldValue("postalcode", value)
  case class countryregionname(override val value: Option[NameDomain]) extends VvendorwithaddressesFieldValue("countryregionname", value)
}
