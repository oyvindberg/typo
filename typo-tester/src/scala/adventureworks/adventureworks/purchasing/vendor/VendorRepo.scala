...
trait VendorRepo {
  ...
  def selectByIds(businessentityids: List[BusinessentityId])(implicit c: Connection): List[VendorRow]
  def update(businessentityid: BusinessentityId, row: VendorRow)(implicit c: Connection): Boolean
